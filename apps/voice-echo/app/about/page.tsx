              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                  ...
                  <p className="text-lg text-gray-700 mb-6">
                    We started by building better radio promotion tools, but quickly realized 
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="p-6 text-center hover:shadow-lg transition-all bg-gradient-to-br from-blue-50 to-blue-100">
                ...
                <p className="text-sm text-gray-600">Advanced AI models analyze contact data and provide intelligent insights</p>
              </Card>
