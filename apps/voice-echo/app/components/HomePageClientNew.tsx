        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h1 className="text-5xl sm:text-6xl lg:text-8xl font-black text-gray-900 mb-10 leading-tight">
              Audio{" "}
              <span className="bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">Intel</span>:
              <br />
            ...
            <p className="text-2xl sm:text-3xl text-gray-700 mb-16 max-w-5xl mx-auto leading-relaxed font-bold">
              Transform basic email lists into music industry intelligence with AI-powered contact enrichment. Get
              playlist curators, radio DJs, and music bloggers with submission guidelines, contact preferences, and
                ...
                <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-16 items-center">
                  ...
                  <div className="text-center">
                    ...
                    <Card className="p-10 bg-white rounded-2xl shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] border-4 border-black hover:translate-y-[-4px] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] transition-all duration-200">
                      <div className="text-gray-900 font-mono text-2xl font-bold">john@bbc.co.uk</div>
                    </Card>
                  </div>
                    ...
                    <Card className="p-10 bg-white rounded-2xl shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] border-4 border-black text-left hover:translate-y-[-4px] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] transition-all duration-200">
                      <div className="space-y-5">
                        <div className="flex items-center gap-4">
                          ...
                          <span className="font-black text-xl">BBC Radio 1 | National Public Service</span>
                        </div>
                        <div className="flex items-center gap-4">
                          <Target className="w-6 h-6 text-red-500" />
                          <span className="font-bold text-lg">UK National Coverage | High Reach</span>
                        </div>
                        <div className="flex items-center gap-4">
                          <Mail className="w-6 h-6 text-orange-500" />
                          <span className="font-bold text-lg">Email: Weekday mornings preferred</span>
                        </div>
                        <div className="flex items-center gap-4">
                          <Users className="w-6 h-6 text-purple-500" />
                          <span className="font-bold text-lg">Focus: New UK artists, breaking acts</span>
                        </div>
                        <div className="flex items-center gap-4">
                          <Zap className="w-6 h-6 text-yellow-500" />
                          <span className="font-bold text-lg">Tip: Include streaming numbers + press quote</span>
                        </div>
                        <div className="flex items-center gap-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <Card className="p-10 text-center rounded-2xl shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] border-4 border-black bg-white hover:translate-y-[-6px] hover:shadow-[18px_18px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 group">
              ...
              <div className="text-base font-bold text-gray-600">BBC, commercial, and independent stations mapped</div>
            </Card>
            ...
            <Card className="p-10 text-center rounded-2xl shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] border-4 border-black bg-white hover:translate-y-[-6px] hover:shadow-[18px_18px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 group">
              ...
              <div className="text-base font-bold text-gray-600">Verified contact intelligence you can trust</div>
            </Card>
            ...
            <Card className="p-10 text-center rounded-2xl shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] border-4 border-black bg-white hover:translate-y-[-6px] hover:shadow-[18px_18px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 group">
              ...
              <div className="text-base font-bold text-gray-600">Average time saved per week on contact research</div>
            </Card>
          </div>
        </div>
      </section>
          ...
          <div className="text-center mb-24">
            ...
            <Card className="max-w-6xl mx-auto p-16 rounded-2xl shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] border-4 border-black bg-gradient-to-br from-gray-50 to-white hover:translate-y-[-4px] hover:shadow-[20px_20px_0px_0px_rgba(0,0,0,1)] transition-all duration-200">
              <p className="text-3xl font-black text-gray-800 leading-relaxed">
                Music PR professionals waste 15+ hours per week on contact research that AI can do in minutes.
                Meanwhile, your competition is already pitching while you're still googling.
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-4xl w-full bg-white rounded-2xl shadow-[20px_20px_0px_0px_rgba(0,0,0,1)] border-4 border-black p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-700">Upload your email list and see the magic happen</p>
            </div>
          ...
          <Card className="p-10 rounded-2xl shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] border-4 border-black bg-white">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-center md:text-right">
                ...
                <p className="text-base font-bold text-gray-500">© 2024 Audio Intel. All rights reserved.</p>
              </div>
            </div>
          </Card>
        </div>
