      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/voice-training" className="text-sm font-bold text-gray-700 hover:text-purple-600 transition-colors">
              Voice Training
            </Link>
            <Link href="/content-generation" className="text-sm font-bold text-gray-700 hover:text-purple-600 transition-colors">
              Content Generation
            </Link>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 font-bold">Get instant access to 50,000+ verified playlist curators with AI-powered pitch generation</p>
              </div>
            </div>
            <Link 
      ...
      <section className="container px-4 py-24 mx-auto text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed font-bold">
            Stop posting generic AI content. Voice Echo learns your unique voice and creates platform-perfect posts for X, Instagram, Threads & TikTok that sound exactly like you.
          </p>
            ...
            <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-16 items-center">
              ...
              <div className="text-center">
                ...
                <div className="bg-gray-50 rounded-2xl p-10 border-4 border-gray-300 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                  <div className="text-gray-900 font-mono text-2xl font-black">"Just dropped my new track!"</div>
                </div>
              </div>
                ...
                <div className="bg-white rounded-2xl p-10 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] text-left">
                  <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-bold text-lg">"🔥 Just dropped my new track! Been working on this for months and finally ready to share it with you all. Link in bio 👆 #NewMusic #UKArtist"</span>
                    </div>
                    <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-bold text-lg">"Behind the scenes of my new track 🎵 This one's been brewing for months and I'm so excited to finally share it with you all! Link in bio for the full story 👆"</span>
                    </div>
                    <div className="flex items-center gap-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-10 text-center rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all group">
              ...
              <div className="text-base font-bold text-gray-600">X, Instagram, Threads & TikTok optimized</div>
            </div>
            ...
            <div className="bg-white p-10 text-center rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all group">
              ...
              <div className="text-base font-bold text-gray-600">Authentic voice preservation you can trust</div>
            </div>
            ...
            <div className="bg-white p-10 text-center rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all group">
              ...
              <div className="text-base font-bold text-gray-600">Average time saved per week on content creation</div>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-700">
                      Most AI tools generate robotic, soulless content that sounds nothing like you and fails to connect
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-gray-700">
                      Each platform has different formats, character limits, and audience expectations - creating content
                      that works across X, Instagram, Threads & TikTok is exhausting.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-gray-900 mb-4">Time-Consuming Process</h3>
                    <p className="text-xl font-bold text-gray-700">
                      Hours spent crafting different versions for each platform, trying to maintain your authentic voice
                      while optimizing for engagement and reach.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white p-12 rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-gray-700 mb-8">
                  Most musicians waste countless hours on content creation that could be automated while preserving
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="bg-gray-50 p-10 text-center rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all group">
              ...
              <p className="text-lg font-bold text-gray-700">
                Upload 10-15 of your best social media posts and our AI learns your authentic voice, tone, style, and
                personality to create content that sounds exactly like you.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-10 text-center rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all group">
              ...
              <p className="text-lg font-bold text-gray-700">
                95% voice match while optimizing for each platform's unique requirements - X character limits, Instagram
                visual-first approach, Threads conversational tone, TikTok viral format.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-10 text-center rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all group">
              ...
              <p className="text-lg font-bold text-gray-700">
                Generate authentic content for X, Instagram, Threads & TikTok simultaneously - each version optimized
                for the platform's audience and format requirements.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-2xl font-bold text-gray-700 max-w-4xl mx-auto">
              While other AI tools generate generic content, Voice Echo learns your authentic voice from your best posts. 
              We preserve your personality while optimizing for engagement across every platform.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-700">
                      Analyzes your writing style, tone, humor, and personality from your best social media posts.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-700">
                      Adapts your voice for each platform's unique requirements - character limits, hashtags, tone, and format.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-700">
                      Generates content that sounds exactly like you while optimizing for engagement and reach.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-700">
                      Built for the reality of managing multiple social platforms, not just one generic output.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              <h3 className="text-2xl font-black text-gray-900 mb-6 text-center">Example: Voice Learning</h3>
              <div className="space-y-6">
                <div>
                  ...
                  <div className="bg-gray-100 p-4 rounded-lg font-mono text-sm">
                    ...
                    <div>"Studio session today was 🔥 Can't wait to share what we're cooking up"</div>
                ...
                <div>
                  ...
                  <div className="bg-green-100 p-4 rounded-lg font-mono text-sm">
                    <div>✅ X: "🔥 Just dropped my new track! Been working on this for months and finally ready to share it with you all. Link in bio 👆 #NewMusic #UKArtist"</div>
                    <div>✅ Instagram: "Behind the scenes of my new track 🎵 This one's been brewing for months and I'm so excited to finally share it with you all! Link in bio for the full story 👆"</div>
                    <div>✅ Threads: "Just dropped my new track! Been working on this for months and finally ready to share it with you all. Link in bio 👆"</div>
                    <div>✅ TikTok: "New track just dropped! 🔥 Been working on this for months 🎵 Link in bio 👆"</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="pricing" className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-2xl font-bold text-gray-700 max-w-4xl mx-auto">
              Choose the plan that fits your content creation needs. All plans include our core voice learning features.
            </p>
          </div>
            ...
            <div className="bg-white p-10 rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all">
              ...
              <ul className="space-y-5 mb-10">
                ...
                <li className="flex items-center gap-4">
                  ...
                  <span className="font-black text-lg">4 platform support (X, Instagram, Threads, TikTok)</span>
                </li>
                <li className="flex items-center gap-4">
                  <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                    <Check className="w-5 h-5 text-white" />
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 font-bold">Try Playlist Pulse - our sister tool for AI-powered playlist curator discovery and pitch generation</p>
                </div>
              </div>
              <Link 
                href="https://pulse.totalaudiopromo.com" 
