...
const defaultHero: HeroVariant = {
  headlines: {
    ...
    secondary: 'Connect with verified UK playlist curators and grow your streaming numbers with targeted submissions that work.'
  },
  cta: {
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                      ...
                      <div className="text-sm text-gray-400">47K followers • Electronic • Reviewed in 24h</div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                      ...
                      <div className="text-sm text-gray-400">23K followers • Indie Rock • +2.3K streams</div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                      ...
                      <div className="text-sm text-gray-400">89K followers • Hip Hop • Response due tomorrow</div>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-4 flex items-center justify-center gap-2">
                ...
                <div className="text-left">
                  <div className="text-white font-semibold">{heroContent.socialProof[0].author}</div>
