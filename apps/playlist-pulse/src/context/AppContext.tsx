...
const sampleCurators: Curator[] = [
  {
    ...
    followers: "125K",
    compatibility: 94,
    pitch: 'Hi Alex! Your indie pop playlist "Dreamy Afternoons" perfectly captures the ethereal sound I create. My latest track combines dreamy vocals with indie sensibilities that would resonate with your 125K followers who love discovering fresh indie gems.',
    social: {
  ...
  },
  {
    ...
    followers: "89K",
    compatibility: 87,
    pitch: 'Hey Sarah! I\'ve been following your "Electronic Pulse" playlist and love how you showcase emerging electronic artists. My new track features the kind of innovative production and melodic hooks that your audience craves.',
    social: {
  ...
  },
  {
    ...
    followers: "203K",
    compatibility: 91,
    pitch: 'What\'s good Marcus! Your "Urban Flow" playlist is fire and I know my track would fit perfectly. The production quality and lyrical content align with the high standards you maintain for your 203K followers.',
    social: {
  ...
  },
  {
    ...
    followers: "156K",
    compatibility: 89,
    pitch: 'Hi Emma! Your "Rock Revival" playlist showcases exactly the kind of alternative sound I create. My latest track has the raw energy and authentic feel that your community of 156K rock enthusiasts would absolutely love.',
    social: {
  ...
  },
  {
    ...
    followers: "78K",
    compatibility: 85,
    pitch: 'Hey David! Your "Chill Study Beats" playlist is my go-to for focus music. My new lo-fi track has those perfect study vibes with subtle jazz influences that would complement your carefully curated collection.',
    social: {
  ...
  },
  {
    ...
    followers: "134K",
    compatibility: 92,
    pitch: 'Hi Lisa! Your "Soulful Nights" playlist captures the essence of modern R&B beautifully. My track combines classic soul elements with contemporary production that would resonate perfectly with your sophisticated audience.',
    social: {
...
function appReducer(state: AppState, action: AppAction): AppState {
  switch (action.type) {
    ...
    case 'SET_SHOW_RESULTS':
      return { ...state, showResults: action.payload, currentStep: action.payload ? 'results' : state.currentStep }
    case 'SET_CURATORS':
