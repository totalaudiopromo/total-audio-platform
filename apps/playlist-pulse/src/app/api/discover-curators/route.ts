...
interface Curator {
  ...
  name: string;
  playlistName: string;
  platform: 'spotify' | 'apple-music' | 'youtube' | 'soundcloud' | 'reddit' | 'instagram' | 'discord' | 'forums' | 'music-sites';
  genre: string;
  followers: string;
  email?: string;
  description: string;
...
function determinePlatform(content: string): 'spotify' | 'apple-music' | 'youtube' | 'soundcloud' | 'reddit' | 'instagram' | 'discord' | 'forums' | 'music-sites' {
...
function getFallbackCurators(genre: string, platforms: string[]): Curator[] {
  const allCurators: Curator[] = [
    ...
    },
    {
      ...
      genre: "Alternative",
      followers: "156K",
      description: "Essential alternative tracks and emerging artists. Focus on unique soundscapes and innovative songwriting.",
    ...
    },
    {
      ...
      genre: "Synthwave",
      followers: "67K",
      description: "Retro-futuristic synthwave and electronic music. Neon lights and cyberpunk vibes with modern production.",
      submissionProcess: "YouTube message or email with YouTube Music link. Include visual aesthetic details.",
      responseRate: "95%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Acoustic",
      followers: "34K",
      description: "Raw acoustic performances and intimate singer-songwriter tracks. Pure, unplugged sound with emotional depth.",
      submissionProcess: "Instagram DM with track link and brief artist story. Prefers live acoustic recordings.",
      responseRate: "90%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Lo-Fi/Chill",
      followers: "78K",
      description: "Relaxing beats and ambient sounds. Perfect for studying, working, or just chilling out.",
      submissionProcess: "SoundCloud message or email with track link. Include mood and energy level.",
      responseRate: "87%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Rock",
      followers: "145K",
      description: "Reviving the spirit of rock music with modern twists. From classic rock to alternative rock.",
      submissionProcess: "Email submissions with track link and artist background. Prefers high-energy tracks.",
      responseRate: "82%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Pop",
      followers: "234K",
      description: "Discovering the next big pop hits. Fresh, catchy, and innovative pop music from emerging artists.",
      submissionProcess: "Email submissions with streaming links. Looking for radio-ready pop tracks.",
      responseRate: "76%",
      contactInfo: {
    ...
    },
    {
      ...
      submissionProcess: "Email submissions with high-quality jazz recordings. Prefers instrumental tracks.",
      responseRate: "89%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "R&B",
      followers: "167K",
      description: "Smooth R&B and soul music. From classic soul to contemporary R&B with emotional depth.",
      submissionProcess: "Email submissions with high-quality R&B tracks. Looking for soulful vocals and production.",
      responseRate: "83%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Country",
      followers: "98K",
      description: "Authentic country music from traditional to modern country. Stories that resonate with real life.",
      submissionProcess: "Email submissions with country tracks. Prefers storytelling and authentic lyrics.",
      responseRate: "91%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Reggae",
      followers: "73K",
      description: "Authentic reggae music with positive vibes and conscious lyrics. From roots to dancehall.",
      submissionProcess: "Email submissions with reggae tracks. Looking for positive messages and authentic sound.",
      responseRate: "88%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Blues",
      followers: "45K",
      description: "Reviving the blues tradition with modern interpretations. From Delta blues to contemporary blues.",
      submissionProcess: "Email submissions with blues tracks. Prefers authentic blues sound and storytelling.",
      responseRate: "94%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Folk",
      followers: "52K",
      description: "Traditional and contemporary folk music. Stories passed down through generations.",
      submissionProcess: "Email submissions with folk tracks. Looking for storytelling and traditional instruments.",
      responseRate: "89%",
      contactInfo: {
    ...
    // Apple Music Curators
    {
      ...
      genre: "Indie Rock",
      followers: "189K",
      description: "Curating the best indie rock for Apple Music. Looking for unique sounds and authentic artists.",
      submissionProcess: "Apple Music Connect submissions preferred. Include artist bio and track description.",
      responseRate: "82%",
      contactInfo: {
    ...
    },
    {
      ...
      submissionProcess: "Apple Music Connect submissions. Include track link and genre classification.",
      responseRate: "88%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Hip Hop",
      followers: "267K",
      description: "Premium hip-hop curation for Apple Music. Supporting underground and emerging artists.",
      submissionProcess: "Apple Music Connect submissions. Include track link and artist background.",
      responseRate: "75%",
      contactInfo: {
    ...
    // YouTube Music Curators
    {
      ...
      genre: "Indie Rock",
      followers: "156K",
      description: "Indie rock curation for YouTube Music. Looking for unique sounds and visual content.",
    ...
    },
    {
      ...
      genre: "Electronic",
      followers: "112K",
      description: "Electronic music curation for YouTube Music. From ambient to dance music with visual elements.",
      submissionProcess: "YouTube message with track link. Include visual content and genre classification.",
      responseRate: "90%",
      contactInfo: {
    ...
    // SoundCloud Curators
    {
      ...
      genre: "Indie Rock",
      followers: "89K",
      description: "Indie rock curation on SoundCloud. Supporting independent artists and unique sounds.",
      submissionProcess: "SoundCloud message with track link. Include artist bio and track description.",
      responseRate: "92%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Electronic",
      followers: "67K",
      description: "Electronic music curation on SoundCloud. From ambient to experimental electronic.",
      submissionProcess: "SoundCloud message with track link. Include genre classification and track description.",
      responseRate: "94%",
      contactInfo: {
    ...
    // Instagram Curators
    {
      ...
      genre: "Indie Rock",
      followers: "234K",
      description: "Indie rock curation on Instagram. Sharing the best indie discoveries with visual content.",
      submissionProcess: "Instagram DM with track link and artist story. Include visual content if possible.",
      responseRate: "78%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Electronic",
      followers: "189K",
      description: "Electronic music curation on Instagram. Sharing electronic discoveries with visual content.",
      submissionProcess: "Instagram DM with track link. Include visual content and genre classification.",
      responseRate: "82%",
      contactInfo: {
    ...
    // Reddit Curators
    {
      ...
      submissionProcess: "Reddit message with track link. Include artist bio and why it fits the community.",
      responseRate: "95%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Electronic",
      followers: "38K",
      description: "Electronic music curation on Reddit. Community-driven electronic music discovery.",
      submissionProcess: "Reddit message with track link. Include genre classification and track description.",
      responseRate: "93%",
      contactInfo: {
    ...
    // Discord Curators
    {
      ...
      submissionProcess: "Discord message with track link. Include artist bio and community engagement.",
      responseRate: "97%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Electronic",
      followers: "19K",
      description: "Electronic music curation on Discord. Community-driven electronic music discovery.",
      submissionProcess: "Discord message with track link. Include genre classification and community engagement.",
      responseRate: "96%",
      contactInfo: {
    ...
    // Music Sites Curators
    {
      ...
      genre: "Indie Rock",
      followers: "67K",
      description: "Indie rock curation on music blogs. Supporting independent artists and unique sounds.",
      submissionProcess: "Email submissions with track link and artist bio. Include press kit if available.",
      responseRate: "80%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Electronic",
      followers: "54K",
      description: "Electronic music curation on music blogs. From ambient to experimental electronic.",
      submissionProcess: "Email submissions with track link. Include genre classification and press kit.",
      responseRate: "85%",
      contactInfo: {
    ...
    // Forums Curators
    {
      ...
      genre: "Indie Rock",
      followers: "34K",
      description: "Indie rock curation on music forums. Community-driven music discovery and discussion.",
      submissionProcess: "Forum message with track link. Include artist bio and community engagement.",
      responseRate: "98%",
      contactInfo: {
    ...
    },
    {
      ...
      genre: "Electronic",
      followers: "28K",
      description: "Electronic music curation on music forums. Community-driven electronic music discovery.",
      submissionProcess: "Forum message with track link. Include genre classification and community engagement.",
      responseRate: "97%",
      contactInfo: {
  ...
  const filteredCurators = allCurators.filter(curator => {
    ...
    const genreMatch = curatorGenreLower.includes(genreLower) ||
                      curatorTagsLower.some(tag => tag.includes(genreLower)) ||
                      // Add related genre mappings
                      (genreLower.includes('indie') && (curatorGenreLower.includes('alternative') || curatorTagsLower.some(tag => tag.includes('indie')))) ||
                      (genreLower.includes('rock') && (curatorGenreLower.includes('alternative') || curatorGenreLower.includes('indie'))) ||
                      (genreLower.includes('electronic') && (curatorGenreLower.includes('synthwave') || curatorTagsLower.some(tag => tag.includes('electronic')))) ||
    ...
    const platformMatch = platforms.includes('all') || 
                         platforms.includes(curator.platform);
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!platforms.includes('all')) {
      filteredCurators = filteredCurators.filter(curator => 
        platforms.includes(curator.platform)
      );
    }

    // Sort by match score and limit results
    filteredCurators = filteredCurators
    ...
    return NextResponse.json(
      { error: 'Failed to discover curators' },
      { status: 500 }
    );
  }
} 