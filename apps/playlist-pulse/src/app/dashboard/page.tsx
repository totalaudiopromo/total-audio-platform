...
import { ArrowLeft, Upload, Users, BarChart, Settings, LogOut, Music, Target, Zap } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] border-4 border-black mb-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-bold mb-6">Ready to get your music heard by the right people?</p>
              <Link
                href="/upload"
          ...
          <div className="bg-white rounded-2xl p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] border-4 border-black">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-bold">Upload your first track to see your activity here</p>
            </div>
          </div>
        </div>
      </div>
