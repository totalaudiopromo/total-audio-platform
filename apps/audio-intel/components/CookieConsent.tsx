      ...
      <div className="mx-auto max-w-5xl px-3 sm:px-4 pb-3 sm:pb-4">
        <div className="bg-white rounded-lg border-3 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-3 sm:p-4">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center border-2 border-black">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="px-4 py-1.5 bg-blue-600 text-white rounded-lg font-black text-xs hover:bg-blue-700 transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 active:scale-95 border-2 border-black"
                >
                  Accept All
                </button>
                <button
