/**
 * Audio Intel Sign In Form
 * Neobrutalist design with Total Audio Promo logo and Google OAuth
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        <div className="rounded-2xl border-4 border-black bg-white p-8 md:p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] animate-slide-up">
          ...
          {/* Success Message */}
          {message && (
            <div className="mb-4 p-3 bg-green-50 border-2 border-green-500 rounded-xl text-green-700 text-sm font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
              {message}
            </div>
          )}
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3.5 border-2 border-black rounded-xl font-bold focus:outline-none focus:ring-4 focus:ring-blue-500/40 focus:border-blue-600 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-xl border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-0.5 hover:-translate-y-0.5 active:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-0.5 active:translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
                  <Loader2 className="w-5 h-5 animate-spin" />
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-xl border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Send Magic Link
            </button>
          </form>
