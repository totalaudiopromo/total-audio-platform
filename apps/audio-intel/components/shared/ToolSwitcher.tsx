...
export interface ToolSwitcherProps {
  ...
  currentTool: string;
  /** Accent color for active tool highlight (e.g., 'purple', 'blue', 'amber') */
...
export function ToolSwitcher({ currentTool, accentColor = 'purple' }: ToolSwitcherProps) {
            ...
            <div className="p-4">
              ...
              <div className="mt-4 border-t-2 border-gray-200 pt-4">
                <a
                  ...
                  className={`block text-center text-xs font-semibold text-gray-600 transition ${styles.hover}`}
                >
                  View all tools →
                </a>
              </div>
