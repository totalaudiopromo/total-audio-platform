    ...
    <Card className="border-4 border-black rounded-xl p-4 sm:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1">
          ...
          {videoFile && (
            <div className="mb-6">
              <div className="bg-white bg-opacity-50 border-4 border-black rounded-xl p-4">
        ...
        <div className="hidden lg:block w-[300px]">
          <Card className="border-4 border-black rounded-xl overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            <div className="bg-gradient-to-br from-blue-500 to-blue-500 p-4 text-white">
              <h3 className="text-xl font-bold">Video Controls</h3>
            </div>
            <div className="p-4 bg-white">
              <Tabs defaultValue="edit">
                <TabsList className="bg-white bg-opacity-50 border-2 border-black rounded-xl p-1 mb-4 w-full">
                  <TabsTrigger
                    value="edit"
