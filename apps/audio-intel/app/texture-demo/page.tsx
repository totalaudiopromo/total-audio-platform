...
import { TextureButton, TextureGradientButton, TextureButtonGroup } from '@/components/ui/texture-button';
import { 
  TextureSection, 
  TextureHeroSection, 
          ...
          <TextureGrid cols={3} gap="lg">
            <TextureFeatureCard index={0}>
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600">Get deep insights into your audience and campaign performance</p>
              </div>
            </TextureFeatureCard>
            ...
            <TextureFeatureCard index={1}>
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600">Set up and run campaigns automatically with smart optimization</p>
              </div>
            </TextureFeatureCard>
            ...
            <TextureFeatureCard index={2}>
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600">Connect all your social media and streaming platforms</p>
              </div>
            </TextureFeatureCard>
            ...
            <TextureFeatureCard index={3}>
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600">Track your campaigns and audience engagement in real-time</p>
              </div>
            </TextureFeatureCard>
            ...
            <TextureFeatureCard index={5}>
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600">Get help from music industry experts when you need it</p>
              </div>
            </TextureFeatureCard>
          </TextureGrid>
        </TextureContainer>
          ...
          <div className="space-y-8">
            ...
            <div className="text-center space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-8 justify-center">
                <TextureButtonGroup>
                  <TextureButton variant="outline" texture="grain">Previous</TextureButton>
                  <TextureButton variant="primary" texture="grain">Next</TextureButton>
                </TextureButtonGroup>
                
                <TextureButtonGroup vertical>
                  <TextureButton variant="outline" texture="paper">Option 1</TextureButton>
                  <TextureButton variant="outline" texture="paper">Option 2</TextureButton>
                  <TextureButton variant="outline" texture="paper">Option 3</TextureButton>
                </TextureButtonGroup>
              </div>
            </div>
          </div>
        ...
        <TextureContainer maxWidth="xl">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Transform your music promotion with Audio Intel's comprehensive texture system and AI-powered tools.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <TextureGradientButton 
                size="lg" 
