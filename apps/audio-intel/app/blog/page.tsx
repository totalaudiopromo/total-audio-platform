...
const blogPosts = [
  {
    ...
    excerpt: "Full walk-through of rebuilding a BBC Radio 6 Music pitching list with Audio Intel, cutting research time from an entire weekend to a two minute enrichment run.",
  ...
  },
  {
    ...
    excerpt: "How Audio Intel transformed BBC Radio 1 contact research from a weekend-long nightmare into a 2-minute automated workflow.",
    author: "Chris Schofield",
    date: "2025-09-15",
    readTime: "10 min read",
    category: "Case Study",
  ...
  },
  {
    ...
    excerpt: "Build comprehensive BBC Radio 1Xtra contact lists in minutes. Get DJ profiles, submission guidelines, and pitch-ready intelligence for urban music promotion.",
    author: "Chris Schofield",
    date: "2025-10-13",
    readTime: "9 min read",
  ...
  },
  {
    ...
    excerpt: "Enrich BBC Radio 2 contacts with detailed presenter profiles, show genres, submission windows, and pitch strategies for mainstream radio.",
    author: "Chris Schofield",
    date: "2025-10-13",
    readTime: "8 min read",
    category: "Radio Contacts",
  ...
  },
  {
    ...
    excerpt: "Build targeted Kerrang Radio contact databases with Audio Intel. Get presenter profiles, submission guidelines, and rock music pitch strategies.",
    author: "Chris Schofield",
    date: "2025-10-13",
    readTime: "8 min read",
    category: "Radio Contacts",
  ...
  },
  {
    ...
    excerpt: "Enrich Absolute Radio contacts across all stations (80s, 90s, 00s, Classic Rock). Get presenter profiles and submission strategies.",
    author: "Chris Schofield",
    date: "2025-10-13",
    readTime: "8 min read",
    category: "Radio Contacts",
  ...
  },
  {
    ...
    excerpt: "Build Spotify editorial playlist contact databases with Audio Intel. Get curator profiles, submission guidelines, and playlist pitch strategies.",
    author: "Chris Schofield",
    date: "2025-10-13",
    readTime: "9 min read",
  ...
  },
  {
    ...
    excerpt: "Enrich Apple Music editorial contacts with detailed curator profiles, submission guidelines, and playlist pitch strategies for platform success.",
    author: "Chris Schofield",
    date: "2025-10-13",
    readTime: "8 min read",
    category: "Playlist Contacts",
  ...
  },
  {
    ...
    excerpt: "Everything you need to know about music contact enrichment. Learn how to transform basic email lists into comprehensive, pitch-ready contact databases.",
    author: "Chris Schofield",
    date: "2025-08-30",
    readTime: "8 min read",
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherPosts.map((post) => (
              <article key={post.slug} className="bg-white rounded-xl border-2 border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all overflow-hidden">
                <div className="p-6">
