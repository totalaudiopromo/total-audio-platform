        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We're on a mission to democratize access to music industry intelligence, 
              making powerful contact research and enrichment tools available to independent 
              artists and small agencies.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-xl text-gray-700 mb-6">
                    The music industry has always been about connections, but the tools to build 
                    those connections have been expensive, complex, and out of reach for most artists.
                  </p>
                  <p className="text-lg text-gray-600 mb-8">
                    Audio Intel changes that. We believe every artist deserves access to the same 
                    intelligence tools that major labels use, but at a price and complexity level 
          ...
          <div className="mb-16">
            <Card className="p-12">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-700">
                  Audio Intel is built by the team behind Total Audio Promo, 
                  a company with deep roots in the music industry
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                  ...
                  <p className="text-lg text-gray-700 mb-4">
                    Total Audio Promo was founded by music industry veterans who saw the same 
                    problems affecting independent artists year after year: lack of access to 
                    quality contacts, expensive tools, and complex processes.
                  </p>
                  <p className="text-lg text-gray-700 mb-6">
                    We started by building better radio promotion tools, but quickly realised 
                    that the real problem was bigger - artists needed better intelligence about 
                    who to contact and how to reach them effectively.
                  </p>
                  <div className="flex gap-4">
                    <Button variant="outline" className="border-2 border-gray-300 hover:bg-gray-50 font-bold">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      <CheckCircle className="w-6 h-6 text-green-500" />
                      <span className="font-bold text-gray-900">AI & Machine Learning Specialists</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle className="w-6 h-6 text-green-500" />
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="p-6 text-center hover:shadow-lg transition-all bg-gradient-to-br from-blue-50 to-blue-100">
                ...
                <p className="text-sm text-gray-600">Advanced AI models analyse contact data and provide intelligent insights</p>
              </Card>
              ...
              <Card className="p-6 text-center hover:shadow-lg transition-all bg-gradient-to-br from-orange-50 to-orange-100">
                ...
                <p className="text-sm text-gray-600">Bank-level security and data protection for your contacts</p>
              </Card>
            </div>
          </div>
          ...
          <div className="mb-16">
            <Card className="p-12 text-center bg-gradient-to-r from-blue-500 to-purple-600 text-white">
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join thousands of artists who are already using Audio Intel to build 
                better connections and grow their careers in the music industry.
              </p>
              <div className="flex gap-4 justify-center">
                ...
                <Button variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-blue-600 font-bold text-lg px-8 py-4">
