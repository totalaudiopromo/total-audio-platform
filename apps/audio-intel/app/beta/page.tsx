      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-50 flex items-center justify-center p-4">
        <Card className="beta-success-card max-w-2xl w-full text-center p-8 border-4 border-green-500 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
          ...
          <p className="beta-success-description text-xl font-bold text-gray-700 mb-6">
            You're in! Check your email for your free beta access details. Try everything for free,
            then get 50% off your first year when you're ready to upgrade.
          </p>
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-10">
      ...
      <section className="glass-panel px-6 py-16 sm:px-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="beta-hero-description text-2xl text-blue-600 mb-4 max-w-3xl mx-auto leading-relaxed font-bold">
            AI-powered contact research tool that turns email addresses into detailed music industry
            profiles
          </p>
          ...
          <div className="beta-hero-cta bg-gradient-to-r from-green-500 to-blue-500 p-8 rounded-2xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] mb-12">
            <h3 className="text-3xl font-black text-white mb-4">Try Free → Then £9.99/month</h3>
            <p className="text-xl font-bold text-white/90 mb-6">
              Test everything free during beta, then £9.99/month for your first year (50% off).
      ...
      <section className="glass-panel px-6 py-12 sm:px-10">
        <h2 className="text-3xl font-bold text-center mb-8 sm:text-4xl">What You'll Be Testing</h2>
        ...
        <div>
          ...
          <div className="mt-8 p-6 bg-blue-50 rounded-xl border-2 border-blue-200">
            <p className="text-lg font-bold text-blue-800 text-center">
              <strong>Perfect for:</strong> Radio promoters, playlist curators, music bloggers,
              label managers, and independent artists who spend hours researching industry contacts
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="beta-benefits-grid grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="glass-panel border-yellow-500">
              <div className="beta-benefit-icon-container flex items-center gap-4 mb-6">
                ...
                />
                <div>
                  <h3 className="beta-benefit-title text-2xl font-black text-gray-900">
                    50% Off First Year
                  </h3>
              ...
              <p className="beta-benefit-description text-lg font-bold text-gray-700">
                Try everything free during beta. When you're ready to upgrade to Professional, get
                50% off your first year (just £9.99/month for 12 months, then £19.99/month).
              </p>
            </div>
            ...
            <div className="glass-panel border-blue-500">
              ...
              <p className="beta-benefit-description text-lg font-bold text-gray-700">
                Get direct access to me (the founder) for feature requests, feedback, and industry
                insights. Shape the product's future.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="glass-panel border-green-500">
              ...
              <p className="beta-benefit-description text-lg font-bold text-gray-700">
                Get new features weeks before public release. Help test and refine tools before they
                go live to everyone else.
              </p>
            </div>
            ...
            <div className="glass-panel border-blue-500">
              <div className="beta-benefit-icon-container flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="beta-benefit-title text-2xl font-black text-gray-900">
                    Beta Founder Recognition
                  </h3>
                  <Badge className="bg-blue-500 text-white font-black">LEGACY</Badge>
                </div>
              </div>
              <p className="beta-benefit-description text-lg font-bold text-gray-700">
                Get permanent "Founding Beta User" badge in your account and recognition as someone
                who helped build Audio Intel.
              </p>
            </div>
          </div>
        </div>
              ...
              <form onSubmit={handleBetaSignup} className="space-y-6">
                <div className="beta-form-grid grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="beta-form-field">
                    <Label
                      htmlFor="firstName"
                      className="beta-form-label text-lg font-black text-gray-900"
                    >
                      First Name *
                    </Label>
                    <Input
                ...
                <div className="beta-newsletter-field bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <Label
                        htmlFor="newsletter"
                        className="text-sm font-black text-yellow-900 cursor-pointer"
                      >
                        Weekly Newsletter: The Unsigned Advantage
                      </Label>
                      <p className="text-xs font-bold text-yellow-800 mt-1">
                        Get insider tips for indie artists juggling day jobs and £50 budgets.
                        Unsubscribe anytime.
                      </p>
                    </div>
                  </div>
                ...
                <div className="beta-benefits-list bg-blue-50 border-2 border-blue-200 rounded-xl p-6">
                  ...
                  <ul className="space-y-2 text-sm font-bold text-blue-800">
                    ...
                    <li>
                      ✅ 50% discount on first year when you upgrade (£9.99/month for 12 months)
                    </li>
                ...
                <p className="text-sm text-gray-600 text-center">
                  By signing up, you agree to our terms and will receive marketing emails. You can
                  unsubscribe at any time.{' '}
                  <strong>No credit card required - completely free beta access.</strong>
                </p>
              </form>
            </CardContent>
          </Card>
      ...
      <section className="glass-panel px-6 py-10 sm:px-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg font-bold text-gray-700 mb-8">
            ...
            researching contacts for radio campaigns, I automated the process with AI. Now I'm
            sharing it with fellow music industry professionals."
          </p>
          <div className="beta-founder-info flex items-center justify-center gap-4">
            ...
            <div className="beta-founder-details text-left">
              ...
              <div className="beta-founder-title font-bold text-gray-600">
      ...
      <section className="glass-panel border-red-500 bg-gradient-to-r from-red-50 to-orange-50 px-6 py-10 sm:px-10">
        <div className="max-w-2xl mx-auto text-center">
          <h3 className="text-3xl font-bold text-gray-900 mb-4">⏰ Limited Beta Spots Available</h3>
          <p className="text-lg text-gray-700">
            We're accepting a limited number of free beta users to ensure quality support. The 50%
            lifetime discount is only available for beta testers who decide to upgrade.
          </p>
        </div>
      </section>
    </div>
