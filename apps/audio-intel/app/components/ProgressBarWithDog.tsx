          ...
          >
            ...
            <div className="absolute right-2 top-1/2 transform -translate-y-1/2">
              <div className="flex space-x-1">
                  ...
                  <div className="w-1 h-1 bg-white bg-opacity-40 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                <div className="w-1 h-1 bg-white bg-opacity-20 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }}></div>
              </div>
            </div>
          </div>
        </div>
