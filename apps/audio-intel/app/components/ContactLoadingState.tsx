    ...
    <div className={containerClass}>
      ...
      {isActionState ? (
        <div>
          ...
          <p className="text-gray-600 max-w-sm text-center">{message}</p>
        </div>
      ) : (
        <p className="status-message max-w-sm text-center">{message}</p>
      )}
      ...
      {state === 'processing' && (
        <div className="text-xs text-gray-400 text-center mt-2 max-w-sm">
          <p>
            Using Total Audio Promo AI to enrich your contacts with music industry intelligence...
          </p>
        </div>
      )}
    </div>
