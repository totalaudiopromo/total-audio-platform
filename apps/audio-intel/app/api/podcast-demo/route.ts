...
export async function GET(request: NextRequest) {
  try {
    ...
    const mediumRelevanceEpisodes = demoEpisodes.filter(
    ...
    console.log(
      `✅ Generated demo with ${highRelevanceEpisodes.length} high-relevance episodes, ${mediumRelevanceEpisodes.length} medium-relevance`
    );
    ...
    return NextResponse.json({
      ...
      podcast: {
        ...
        description:
          'Curated selection of podcast episodes with AI and technology insights relevant to the music industry',
