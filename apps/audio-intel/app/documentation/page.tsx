      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Upload any CSV, TXT, or Excel file with names and emails. Our intelligent
                          parser handles messy data automatically.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Our AI analyses each contact and adds music industry intelligence, contact
                          preferences, and research insights.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Download enriched contacts in multiple formats or integrate directly with
                          your CRM and marketing tools.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <TabsContent value="contact-enrichment" className="space-y-8">
            <Card className="p-8 border-2 border-black">
              <div className="text-center mb-8">
                <h2 className="text-4xl font-black text-gray-900 mb-4">Contact Enrichment Guide</h2>
                <p className="text-xl font-bold text-gray-700">
