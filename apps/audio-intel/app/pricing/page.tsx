...
function PricingContent() {
  ...
  const [showEmailForm, setShowEmailForm] = useState<{ tier: string; billing: string } | null>(
    null
  );
  ...
  const trialDays = {
    professional:
      Number(process.env.NEXT_PUBLIC_TRIAL_DAYS_PROFESSIONAL) ||
      Number(process.env.NEXT_PUBLIC_TRIAL_DAYS) ||
      14,
    agency:
      Number(process.env.NEXT_PUBLIC_TRIAL_DAYS_AGENCY) ||
      Number(process.env.NEXT_PUBLIC_TRIAL_DAYS) ||
      14,
  } as const;
      ...
      <section id="pricing" className="glass-panel px-6 py-12 sm:px-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Test it free, then choose what works for you. All plans include contact enrichment,
            email validation, and CSV export.
          </p>
        </div>

        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {/* Free Beta */}
          <div className="glass-panel border-green-500 bg-gradient-to-br from-green-50 to-white p-10 relative flex flex-col h-full">
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-600">
                    Add AI-generated context to your existing contacts
                  </span>
                </div>
              </li>
              <li className="flex items-start gap-4">
          ...
          {/* Professional */}
          <div className="glass-panel border-blue-500 bg-gradient-to-br from-blue-50 to-white p-10 relative flex flex-col h-full">
            ...
            <div className="text-center mb-10 mt-6">
              ...
              <h4 className="text-xl font-bold text-blue-600 mb-4">
                For artists and promoters running campaigns
              </h4>
              <div className="text-6xl font-black text-gray-900 mb-2">
                £19<span className="text-2xl text-gray-600">/mo</span>
              </div>
              <p className="text-sm font-bold text-green-600 mb-2">
                Beta founders: £9.99/mo first year
              </p>
            ...
            <ul className="space-y-5 mb-10 flex-1">
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-600">
                    60-second processing vs 2-3 minute wait
                  </span>
                </div>
              </li>
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-600">
                    PDF reports, Excel files, email delivery
                  </span>
                </div>
              </li>
              <li className="flex items-start gap-4">
          ...
          <div className="glass-panel flex flex-col h-full">
            <div className="text-center mb-10">
              ...
              <p className="text-sm font-bold text-green-600 mb-2">
                Beta founders: £39.50/mo first year
              </p>
              <p className="text-sm text-gray-600">14-day free trial included</p>
            </div>
            ...
            <ul className="space-y-5 mb-10 flex-1">
              <li className="flex items-start gap-4">
                ...
                <div>
                  <span className="font-black text-lg block">Everything in Professional</span>
                  <span className="text-sm text-gray-600">Plus agency-specific features</span>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex-shrink-0 mt-1">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-2xl border-4 border-green-500 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              ...
              <p className="text-lg font-bold text-gray-700 text-center">
                90% data accuracy guaranteed - wrong intel doesn't count towards your monthly limit.
                We only charge for contacts that actually help your campaigns.
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] p-8 max-w-md w-full">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-black text-gray-900">
                Start Your{' '}
                {showEmailForm?.tier === 'professional' ? trialDays.professional : trialDays.agency}
                -Day Free Trial
              </h3>
              <Button variant="outline" size="sm" onClick={closeEmailForm} className="p-2">
                <X className="w-4 h-4" />
              </Button>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl border-4 border-blue-500 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              ...
              <p className="text-lg font-bold text-gray-700">
                Yes. Professional and Agency plans include a free trial. You won't be charged until
            ...
            <div className="bg-white p-8 rounded-2xl border-4 border-green-500 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              ...
              <p className="text-lg font-bold text-gray-700">
                All prices are in £GBP. VAT may apply depending on your location.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl border-4 border-blue-500 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              <h3 className="text-2xl font-black text-gray-900 mb-3">Can I cancel any time?</h3>
              <p className="text-lg font-bold text-gray-700">
                Yes. There are no contracts. Cancel any time from your account or by emailing
                support.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl border-4 border-yellow-500 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              <h3 className="text-2xl font-black text-gray-900 mb-3">
                What does the 90% data accuracy guarantee mean?
              </h3>
              <p className="text-lg font-bold text-gray-700">
                We only count accurate enrichments towards your monthly limit. If something is
