#  FREE BETA EMAIL SEQUENCE - TRY FREE → LIFETIME DISCOUNT

##  SPECIAL SEQUENCE FOR FREE BETA USERS

**Target Audience**: Friends, colleagues, and beta testers trying Audio Intel for free
**Trigger**: Free beta signup with `free_trial` and `lifetime_discount_eligible` tags
**Goal**: Demonstrate value during free trial, then convert to lifetime customers at 50% discount
**Duration**: 14 days

---

## ** EMAIL 1 (Day 0) - Welcome Free Beta User**

**Subject:** ` You're In! Free Beta Access + 50% Lifetime Discount When You're Ready`
...
Thanks for agreeing to test Audio Intel during the beta phase. As someone I know personally, your honest feedback means everything to me.

 YOUR FREE BETA ACCESS:
• Complete access to all Audio Intel features
• No payment required during beta testing
• No credit card needed
• Test with real campaigns and contact lists
• Direct access to me for questions/feedback

 WHEN YOU'RE READY - 50% LIFETIME DISCOUNT:
• If you love it (and I think you will), you can lock in £9.99/month FOREVER
• That's 50% off the retail price (£19.99/month)
• Only available to beta testers like you
• No pressure - test everything first

 GET STARTED RIGHT NOW:
1. Go to: intel.totalaudiopromo.com/upload
2. Upload any contact list (CSV, Excel, whatever you have)
3. Watch the AI research and enrich your contacts
4. See how it saves you hours per campaign

 BUILT BY A WORKING PROMOTER:
I created this because I was spending 15+ hours per week researching radio contacts manually. Now it takes 15 minutes. I'm sharing it with people I trust first.
...
## ** EMAIL 2 (Day 2) - Features That Save 15+ Hours Per Week**
...
## ** EMAIL 3 (Day 5) - How Other Beta Users Are Seeing Success**
...
## ** EMAIL 4 (Day 7) - Halfway Through Beta - Your Discount Is Safe**
...
## ** EMAIL 5 (Day 10) - Advanced Features for Power Users**
...
## ** EMAIL 6 (Day 12) - Limited Time for Lifetime Discount**
...
Click here to secure £9.99/month forever: [Upgrade Link]
...
P.S. Once we launch publicly, this discount disappears forever. New users will pay £19.99/month while you pay £9.99.
 ...
 Lock In Discount: [Upgrade Link]
 Continue Testing Free: intel.totalaudiopromo.com/upload
```

---

## ** EMAIL 7 (Day 14) - Final Day of Beta Access**
...
[Upgrade to Lifetime Pricing - £9.99/month]
...
P.S. At midnight tonight, the lifetime discount disappears. New users will pay £19.99/month while lifetime members pay £9.99. Your choice.
 ...
 Final Chance - Lock In Lifetime Pricing: [Upgrade Link]
```
...
1. **Sequence Name**: "Free Beta → Lifetime Discount"
2. **Trigger Tag**: `free_trial` + `lifetime_discount_eligible`
3. **Email Schedule**: Days 0, 2, 5, 7, 10, 12, 14
4. **Automation**: Auto-subscribe on beta signup

### **Tags to Use:**
- `free_trial` - All free beta users
- `lifetime_discount_eligible` - Beta testers eligible for 50% discount
- `beta_user` - All beta participants
- `converted_lifetime` - Users who upgrade to paid

### **Success Metrics to Track:**
- Email open rates (target: 50%+)
- Click-through rates (target: 15%+)
- Conversion rate to paid (target: 25%+)
- Trial-to-paid time (track average days)

This sequence respects that these are friends/colleagues testing for free, while still demonstrating value and offering the lifetime discount when they're ready.