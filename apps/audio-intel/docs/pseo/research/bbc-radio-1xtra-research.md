...
BBC Radio 1Xtra is the UK's primary national radio station for urban music, broadcasting grime, hip-hop, Afrobeats, R&B, dancehall, and related genres. The station reaches 786,000 weekly listeners (RAJAR March 2024) and serves as a crucial platform for UK urban music artists to gain national exposure.

**Key Submission Route**: BBC Introducing Uploader (official submission platform for all BBC stations)
...
- **Features**: "The Gargle Game and Tea Tuesday", "The Look What Game and New Music Friday"
...
- **Background**: With BBC 1Xtra since 2017, known for championing UK rap and discovering new talent
- **Artist Fit**: Rap and grime artists, especially UK-focused
...
- **Background**: Grime pioneer, former Roll Deep member, BBC 1Xtra presenter since early days
- **Artist Fit**: UK grime artists, multi-genre urban music
...
- **Artist Fit**: Afrobeats artists, African diaspora music
...
- **Background**: London-born DJ, started DJing at age 12, replaced DJ Ace in January 2024 after Ace's 21-year tenure
...
- **Features**: "Referemi", "Film Friday with Ada Enechi"
- **Artist Fit**: Broad urban appeal, accessible hip-hop and Afrobeats
...
- **Features**: "Postcode Playlist", "Feel-good Friday"
- **Artist Fit**: General urban music, Birmingham/Midlands artists
...
- **Artist Fit**: Dancehall artists, reggae, Caribbean diaspora music
- **Notable**: Long-running specialist show, also features "Basslines and Blessings" Sunday reggae programming
...
- **Rampage**: Showcases dancehall, funky house, R&B
- **Source**: Multiple sources including [RadioToday](https://radiotoday.co.uk/2023/02/new-afternoon-and-drive-show-for-bbc-radio-1xtra-as-reece-parkinson-exits/)
...
## Official Submission Process: BBC Introducing Uploader
...
4. **Path to 1Xtra**
   - Regional BBC Introducing presenter champions your track
   - Track forwarded to 1Xtra music team based on genre fit
   - Weekly playlist meetings feature Introducing artists
   - If successful, featured on relevant 1Xtra show
...
**From BBC Introducing Presenters:**

1. **Radio-Ready First**: Submit your most accessible, radio-ready single with your first monthly upload
2. **Demonstrate Breadth**: Use second upload to show creative range
3. **Tell Your Story**: Release Notes section is invaluable for connecting listener to music
4. **Be Original**: BBC Introducing champions music that pushes boundaries, not copies trends
5. **Quality Over Quantity**: Only submit when track is genuinely ready for national radio
6. **Patience Required**: All uploads listened to within 6 months - great music will be heard

**Source**: [ICMP BBC Introducing Guide](https://www.icmp.ac.uk/blog/inside-bbc-music-introducing/), [PRS for Music Radio Guide 2025](https://www.prsformusic.com/m-magazine/how-to/how-to-get-played-on-the-radio-in-2025)
...
**Sources**: [ICMP BBC Introducing Guide](https://www.icmp.ac.uk/blog/inside-bbc-music-introducing/), [The Unsigned Guide BBC Introducing Advice](https://www.theunsignedguide.com/blog/718-bbc-introducing-share-advice-on-getting-radio-airplay-for-your-music)

---

## Recent Changes & Updates (2024-2025)

### Major Presenter Changes

**January 2024**: Chuckie replaced DJ Ace on BBC 1Xtra R&B Show after Ace's 21-year tenure
**March 2023**: Kenny Allstar took over Rap Show from Tiffany Calver
**April 2023**: Schedule overhaul - Remi Burgz to drivetime, Kaylee joins afternoon show, Joelah Noble to Saturday afternoons

**Source**: [RadioToday Multiple Articles 2023-2024](https://radiotoday.co.uk/)

### October 2025 Black History Month Programming

- Craig David guest co-hosting with Nadia Jae on breakfast show
- Lethal Bizzle and Tinie Tempah joining station for special programming
- Trevor Nelson's Black History Mixtape of empowerment and protest anthems
- Eddie Kadi joined by Victony on Official UK Afrobeats Chart Show
- Rampage showcasing dancehall, funky house, R&B with special guests

**Source**: [RadioToday October 2025](https://www.radiotoday.uk/2025/10/craig-david-lethal-bizzle-and-tinie-tempah-join-1xtra-for-black-history-month/)

### Station Statistics (2024)

- **Weekly Audience**: 786,000 listeners (RAJAR March 2024)
- **Listening Share**: 0.3% of UK radio market
- **Genre Coverage**: Hip-hop, rap, grime, drill, jungle, UK garage, dubstep, drum & bass, UK funky, house, R&B, soul, dancehall, soca, reggae, Afrobeats, amapiano

**Source**: [Wikipedia BBC Radio 1Xtra](https://en.wikipedia.org/wiki/BBC_Radio_1Xtra)
...
- **Schedule**: bbc.co.uk/schedules/p00fzl8v
- **BBC Sounds App**: Listen live, catch up on shows, browse playlists
- **Social Media**: @bbc1xtra (Instagram, Twitter/X) - for general engagement, not submissions

### Presenter Social Media (For Research, Not Submissions)

- Kenny Allstar: @kennyallstar
- DJ Target: @djtarget
- Eddie Kadi: Research show features and recent playlist additions
- Nadia Jae: @nadiajae

**Note**: Following presenters can help understand their music taste and recent plays, but do not DM tracks or demos. Use BBC Introducing Uploader.

---

## Strategic Advice for UK Urban Artists

### Optimising Your 1Xtra Submission

1. **Research First**: Listen to the shows that match your genre for 2-3 weeks
2. **Understand the Sound**: Note what's getting played - production quality, song structure, themes
3. **Perfect Your Track**: Ensure it genuinely matches the quality and style of current 1Xtra playlist
4. **Clean Version**: Create professional radio edit, not just muted swear words
5. **Complete Profile**: Write compelling artist story that connects your music to your journey
6. **Strategic Timing**: Submit when you have full release campaign ready (not months before release)
7. **Follow Up**: If played on regional Introducing, thank presenter on social media (professionally)
8. **Build Relationships**: Attend BBC Introducing LIVE events, showcase opportunities
...
**Date**: October 4, 2025
**Approach**: Web search using verified music industry publications, official BBC sources, and presenter information
**Limitations**: BBC website blocks automated access, requiring reliance on third-party schedule aggregators and industry publications
**Verification**: Cross-referenced multiple sources for all presenter information and submission guidelines
**Confidence Level**: High for submission process and key presenters, Medium for exact current timeslots (October 2025)

---

## Next Steps for Artists

1. **Listen & Research**: Spend 2-3 weeks listening to target show(s) via BBC Sounds
2. **Prepare Track**: Create professional, radio-ready clean version of best single
3. **Register**: Set up BBC Introducing Uploader profile with complete information
4. **Submit Strategically**: Upload when track genuinely ready, with compelling Release Notes
5. **Be Patient**: Wait for 6-month guaranteed review period
6. **Build Presence**: Continue developing artist profile, social media, streaming presence
7. **Network**: Attend BBC Introducing LIVE events and showcase opportunities
8. **Follow Up Professionally**: If played, thank presenter on social media appropriately

---

**Document Status**: Research complete with verification from multiple sources. Some specific October 2025 timeslots need direct BBC schedule verification, but submission process and key presenter information verified and current.

**For Audio Intel PSEO**: This research provides comprehensive, verified contact intelligence for BBC Radio 1Xtra suitable for programmatic SEO contact enrichment articles targeting UK urban music artists.
