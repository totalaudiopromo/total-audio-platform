...
export class NewsletterResearchEngine {
  ...
  private generateIndustryInsight(theme: any): string {
    const insights: Record<string, string> = {
      'The Hidden Cost of Manual Research':
        '94% of research time is wasted on outdated information',
      'Building Your Music Industry Network':
        'Strategic relationships are worth 10x more than cold outreach',
      'AI Tools That Actually Work':
        'AI is democratising enterprise-level tools for independent artists',
  ...
  private generateSuccessStory(theme: any): string {
    const stories: Record<string, string> = {
      'The Hidden Cost of Manual Research':
        'Sarah reduced her research time from 25 hours to 2 minutes',
      'Building Your Music Industry Network':
        'Tom built a network of 50+ industry contacts in 3 months',
      'AI Tools That Actually Work':
        'Lisa increased her response rates by 300% using AI-powered outreach',
  ...
  private generateQuickTip(theme: any): string {
    const tips: Record<string, string> = {
      'The Hidden Cost of Manual Research':
        'Use AI tools to automate contact research and focus on relationship building',
      'Building Your Music Industry Network':
        'Start conversations by sharing valuable insights, not asking for favours',
      'AI Tools That Actually Work':
        'Test AI tools with small campaigns before committing to full implementation',
  ...
  private generateCommunityQuestion(theme: any): string {
    const questions: Record<string, string> = {
      ...
      'Building Your Music Industry Network':
        'How do you approach building relationships in the music industry?',
      'AI Tools That Actually Work':
        'Which AI tools have made the biggest difference to your music career?',
      'The £50 Budget Challenge': 'How do you maximise impact with a limited promotion budget?',
    };

    return (
      questions[theme.theme as string] || "What's your biggest challenge as an independent artist?"
    );
  }
}
