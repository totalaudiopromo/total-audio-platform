...
export const DEMO_CONTACTS: EnrichedContact[] = [
  ...
  },
  {
    ...
    contactIntelligence:
      'Music Editor at Complex Magazine covering emerging UK rap and grime scene. Strong social media presence (45K Twitter followers) and frequently shares new discoveries. Excellent contact for urban music genres. Prefers direct email approach with context about artist story and background.',
  ...
  },
  {
    ...
    contactIntelligence:
      'Radio Host and Music Director at KEXP, internationally recognized for discovering new talent. Program: "New and Emerging Artists" broadcasts globally. Very supportive of independent musicians and provides detailed feedback. Submit high-quality demos with artist story.',
  ...
  },
  {
    ...
    contactIntelligence:
      'Freelance Music Journalist covering indie, alternative, and electronic music for various UK publications including NME, The Guardian, and Mixmag. Strong network in London music scene. Responds well to exclusive premieres and interview opportunities.',
...
export const PDF_SAMPLES_INFO = {
  contacts: {
    ...
    description:
      'Comprehensive contact enrichment with industry insights, confidence scoring, and actionable intelligence.',
    features: [
  ...
  analytics: {
    ...
    description:
      'Complete analytics overview with performance metrics, platform breakdowns, and trend analysis.',
    features: [
  ...
  aiAgent: {
    ...
    description:
      'Intelligent industry analysis with strategic recommendations and actionable next steps.',
    features: [
