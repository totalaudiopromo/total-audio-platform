...
const DISPOSABLE_DOMAINS = new Set([
  ...
  'tempr.email', 'tmpeml.com', 'tmpmail.org', 'temp-mail.org',
  'mailmetrash.com', 'trashmail.com', 'spamgourmet.com', 'mailnull.com',
  'mailcatch.com', 'mailinator2.com', 'mailinator3.com', 'mailinator4.com',
...
const FREE_EMAIL_DOMAINS = new Set([
  ...
  'outlook.co.uk', 'outlook.fr', 'outlook.it', 'outlook.es', 'outlook.de',
  'yahoo.co.uk', 'yahoo.fr', 'yahoo.it', 'yahoo.es', 'yahoo.de',
  'gmail.co.uk', 'gmail.fr', 'gmail.it', 'gmail.es', 'gmail.de'
]);

// Role-based email patterns
const ROLE_BASED_PATTERNS = [
  /^admin@/i, /^info@/i, /^contact@/i, /^hello@/i, /^hi@/i,
  /^sales@/i, /^marketing@/i, /^support@/i, /^help@/i, /^service@/i,
  /^team@/i, /^staff@/i, /^office@/i, /^reception@/i, /^frontdesk@/i,
  /^general@/i, /^enquiries@/i, /^inquiries@/i, /^questions@/i,
  /^feedback@/i, /^suggestions@/i, /^complaints@/i, /^billing@/i,
  /^accounts@/i, /^finance@/i, /^hr@/i, /^recruitment@/i, /^jobs@/i,
  /^careers@/i, /^press@/i, /^media@/i, /^pr@/i, /^publicity@/i,
  /^editorial@/i, /^editor@/i, /^news@/i, /^blog@/i, /^webmaster@/i,
  /^postmaster@/i, /^abuse@/i, /^spam@/i, /^security@/i, /^legal@/i
];

// Spam trap patterns
const SPAM_TRAP_PATTERNS = [
  /^test@/i, /^demo@/i, /^example@/i, /^sample@/i, /^fake@/i,
  /^invalid@/i, /^noreply@/i, /^no-reply@/i, /^donotreply@/i,
  /^do-not-reply@/i, /^nobody@/i, /^null@/i, /^void@/i, /^empty@/i,
  /^spam@/i, /^junk@/i, /^trash@/i, /^garbage@/i, /^bounce@/i,
  /^bounces@/i, /^feedback@/i, /^complaints@/i, /^abuse@/i,
  /^postmaster@/i, /^mailer-daemon@/i, /^daemon@/i, /^root@/i,
  /^webmaster@/i, /^hostmaster@/i, /^administrator@/i, /^admin@/i,
  /^info@/i, /^contact@/i, /^sales@/i, /^marketing@/i, /^support@/i,
  /^help@/i, /^service@/i, /^team@/i, /^staff@/i, /^office@/i
];
