...
**Goal**: Gather genuine feedback during free testing period, offer lifetime discount post-beta as appreciation
**Duration**: 14 days (4 emails)
**Tone**: Professional music industry appropriate, minimal emojis, authentic voice
...
- **Trigger Tags**: `beta_user` + `free_trial`
- **Email Schedule**: Days 0, 3, 7, 14
- **Automation Type**: Email sequence (not broadcast)
...
- `{{ subscriber.first_name }}` - Personalisation
- `{{ subscriber.email }}` - Contact verification
- Fallback: "Hi there" if first_name is empty

### **CTA Links to Test:**
- `intel.totalaudiopromo.com/upload` - Main testing platform
- `intel.totalaudiopromo.com/pricing` - Pricing page (Email 4 only)

### **Technical Checklist:**
- [ ] All emails render correctly on mobile
- [ ] Unsubscribe links functional in all emails
- [ ] Merge tags populate correctly
- [ ] Links track click-through rates
- [ ] Automation timing set to exact days (0, 3, 7, 14)
- [ ] Sequence stops if user adds `converted_lifetime` tag
- [ ] Reply-to address set to personal email for feedback

### **Success Metrics:**
- Open rates: Target 45%+ (industry contacts)
- Response rate: Target 20%+ (seeking feedback)
- Conversion to paid: Track post-beta (not during)
- Feedback collection: Qualitative responses for product development
...
- Used real examples from sadact's music promotion experience
- Referenced actual tools being replaced (Groover, SubmitHub, etc.)
- Brighton electronic music scene context

### **2. Proper Free Beta Structure:**
- No payment requests during testing period
- Focus entirely on feedback collection
- Lifetime discount offered post-beta as appreciation
- No sales pressure or urgency tactics

### **3. Professional Tone:**
- Maximum 1 emoji per email (CTA arrows only)
- Music industry appropriate language
- UK spelling throughout
- Respectful approach for personal network

### **4. Reduced Volume:**
- Cut from 7 emails to 4
- Strategic timing: Welcome, Guide, Check-in, Conclusion
- Each email serves specific feedback or testing purpose

### **5. Technical Accuracy:**
- All links point to correct URLs
- Proper merge tag formatting
- Mobile-optimised content length
- Unsubscribe compliance

**Ready for immediate Kit.com deployment with verified technical configuration.**