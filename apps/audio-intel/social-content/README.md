# Total Audio Promo Social Content

Simple, clean directory for your social media content generation.
...
```
"Write a LinkedIn post about contact research pain points for Audio Intel"
```

That's it! No technical complexity, no automation setup, just simple content generation.

## Platforms Supported

- LinkedIn (primary)
- Blue Sky (secondary)
- X/Twitter (when you add it)
- Threads (when you add it)
