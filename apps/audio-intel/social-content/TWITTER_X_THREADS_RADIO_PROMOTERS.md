# Twitter/X Threads - Radio Promoter Focus (Brighton Producer Authentic Voice)

**Target Audience**: Radio promoters + indie artists
**Voice**: Chris Schofield authentic - Brighton producer (sadact), direct, conversational
**Platform**: Twitter/X
**Format**: 5-7 tweet threads with line breaks for readability
...
## Thread 2: The Contact Intelligence Reality

I tested Audio Intel on radio contacts for my latest campaign.
...
## Thread 3: The Brighton Producer Story

Right, so I've been coding Audio Intel at 2am whilst the girlfriend and kids sleep.
...
## Thread 4: The Submission Window Problem
...
## Thread 6: The Response Rate Breakthrough
...
**Total**: 6 Twitter/X threads optimised for radio promoter engagement
**Voice**: Authentic Chris Schofield - Brighton producer, direct, real experience
**Format**: 5-7 tweets per thread with clear line breaks
**CTAs**: "Comment BETA" format for Twitter engagement
