# Bluesky & Threads Content - Radio Promoter Focus

**Target Audience**: Radio promoters, indie artists, music industry professionals
**Voice**: Chris Schofield authentic UK music industry
**Format**: Platform-optimised for Bluesky (300 chars) and Threads (500 chars)
...
If research takes 15+ hours, you've missed it.

Audio Intel: 2 minutes
Result: Actually catch opportunities
...
Time you could spend making music, building fans, growing your brand.
...
- **Thursday**: Bluesky (BBC Test) + Threads (BBC Success)
...
- **Thursday**: Threads (Pricing Problem) + LinkedIn (Real Cost Bad Data)
...
- **Thursday**: Threads (Brighton Story) + LinkedIn (Spreadsheet Chaos)
...
- **Thursday**: Bluesky (Real ROI) + Threads (ROI Calculation)
- **Friday**: Twitter/X Thread (Response Rates) + LinkedIn + Threads (Industry Truth)
...
- **Hashtags**: Minimal (platform culture)
- **CTA**: Direct link to intel.totalaudiopromo.com
...
- **CTA**: "Comment BETA" or direct link
...
- **Track**: Monitor which platform drives best conversions
- **Optimise**: Double down on highest-performing content

---

**Total**: 20 posts (10 Bluesky + 10 Threads)
**Voice**: Chris Schofield authentic UK music industry
**Format**: Platform-optimised character limits
**Focus**: Radio promoter pain points, solutions, results
**UTM Tracking**: All URLs include campaign tracking
