 ...
 * Source: apps/audio-intel/components/ExportButtons.tsx
 * Issues found: SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING
 */

const { test, expect } = require('@playwright/test');
const { validateAllTouchTargets, validateTouchTargetSize } = require('@total-audio/testing');

test.describe('ExportButtons - Touch Targets', () => {
