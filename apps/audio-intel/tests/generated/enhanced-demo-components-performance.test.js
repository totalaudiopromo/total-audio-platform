 ...
 * Component: enhanced-demo-components
 * Source: apps/audio-intel/components/ui/enhanced-demo-components.tsx
 */

const { test, expect } = require('@playwright/test');
const { validatePerformance, measureCLS, measureLCP } = require('@total-audio/testing');

test.describe('enhanced-demo-components - Performance', () => {
