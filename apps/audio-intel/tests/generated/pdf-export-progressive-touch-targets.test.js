 ...
 * Component: pdf-export-progressive
 * Source: apps/audio-intel/components/ui/pdf-export-progressive.tsx
 * Issues found: SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING, SMALL_SPACING
 */

const { test, expect } = require('@playwright/test');
const { validateAllTouchTargets, validateTouchTargetSize } = require('@total-audio/testing');

test.describe('pdf-export-progressive - Touch Targets', () => {
