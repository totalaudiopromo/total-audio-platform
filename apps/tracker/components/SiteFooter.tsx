      ...
      <div className="glass-panel px-6 py-8 sm:px-10">
        <div className="flex flex-col gap-8 sm:flex-row sm:justify-between">
          ...
          <div className="flex-1">
            <p className="text-sm font-bold uppercase tracking-[0.34em] text-gray-900">Tracker</p>
            <p className="mt-2 max-w-xs text-sm text-gray-600">
              AI-powered campaign tracking for music promoters. Built by Total Audio Promo.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-12">
            <div>
              ...
              <ul className="mt-3 space-y-2">
                <li>
                  <Link href="/pricing" className="text-sm text-gray-600 transition hover:text-purple-600">
                    Pricing
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard" className="text-sm text-gray-600 transition hover:text-purple-600">
                    Dashboard
                  </Link>
                </li>
              </ul>
