    ...
    <aside className="fixed inset-y-0 left-0 w-64 border-r border-slate-200/50 dark:border-slate-800 bg-white dark:bg-slate-900 p-6">
      <div className="mb-8">
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-10 h-10 bg-gradient-to-br from-amber-600 to-amber-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
            <PlayIcon className="w-6 h-6 text-white" />
          </div>
          <span className="text-xl font-black bg-gradient-to-r from-amber-600 to-amber-600 bg-clip-text text-transparent">
            Tracker
          </span>
        </Link>
      </div>
      ...
      <div className="absolute bottom-6 left-6 right-6">
        <div className="bg-gradient-to-br from-blue-50 to-amber-50 dark:from-amber-900/20 dark:to-amber-900/20 rounded-xl p-4 border border-blue-200 dark:border-amber-800">
          ...
          <Link
            href="/billing"
            className="block text-center px-4 py-2 bg-gradient-to-r from-amber-600 to-amber-600 text-white rounded-lg text-sm font-semibold hover:from-amber-700 hover:to-amber-700 transition-all"
          >
            Upgrade Now
          </Link>
        </div>
