    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          type="email"
          id="email"
          className="w-full px-4 py-3 border-2 border-black rounded-xl font-bold focus:outline-none focus:ring-4 focus:ring-teal-500 focus:border-teal-600 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
      ...
      <div className="flex items-center justify-end mb-4">
        <a
          href="/reset-password"
          className="text-sm text-teal-600 hover:text-teal-700 font-black underline transition-colors"
        >
          Forgot password?
        </a>
      </div>
      ...
      <Button
        type="submit"
        className="w-full bg-teal-600 hover:bg-teal-700 text-white font-black py-3 rounded-xl border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 active:scale-95 transition-all"
        disabled={isLoading}
      >
