            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  id="email"
                  className="w-full pl-10 pr-4 py-3.5 border-2 border-black rounded-xl font-bold focus:outline-none focus:ring-4 focus:ring-teal-500/40 focus:border-teal-600 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
