      ...
      <div className="bg-white rounded-2xl border-4 border-black shadow-brutal p-6">
        ...
        <div className="text-center py-6">
          ...
          <Link
            ...
            className="inline-block bg-purple-600 hover:bg-purple-700 text-white font-bold px-4 py-2 rounded-xl border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all"
          >
    ...
    <div className="bg-white rounded-2xl border-4 border-black shadow-brutal p-6">
      ...
      <div className="space-y-2">
        {connections.map((connection) => (
          <div
            key={connection.id}
            className="flex items-center justify-between p-3 rounded-xl border-2 border-gray-200 hover:border-purple-300 transition-colors"
          >
      ...
      <Link
        href="/dashboard/integrations"
        className="block text-center mt-4 pt-4 border-t-2 border-gray-200 text-sm font-bold text-purple-600 hover:text-purple-700 transition-colors"
      >
        Manage Integrations →
      </Link>
    </div>
