...
export function InsightCard({ insight, className = '' }: InsightCardProps) {
  ...
  const confidence =
    typeof insight === 'object' ? insight.confidence : undefined;

  return (
    <div
      className={`bg-white rounded-xl border-4 border-black p-5 shadow-brutal hover:shadow-brutal-lg hover:-translate-x-1 hover:-translate-y-1 transition-all ${className}`}
    >
