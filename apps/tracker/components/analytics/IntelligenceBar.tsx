    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
          ...
          <div>
            <p className="text-sm font-medium text-gray-900">Strong Timing Performance</p>
            <p className="text-xs text-gray-500">Your 6-week advance pitching outperforms industry average</p>
          </div>
        </div>
      </div>
    </div>
