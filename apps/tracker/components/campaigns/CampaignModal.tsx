  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl border-4 border-black shadow-brutal-xl max-w-3xl w-full my-8">
        {/* Header */}
        <div className="bg-purple-600 px-6 md:px-8 py-6 border-b-4 border-black rounded-t-xl">
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border-4 border-black rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-purple-500 font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border-4 border-black rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-purple-500 font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] bg-white"
              >
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 border-4 border-black rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-purple-500 font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] resize-none"
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-3 pt-6 border-t-4 border-gray-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-6 py-3.5 bg-purple-600 text-white rounded-xl font-black hover:bg-purple-700 transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed text-base"
            >
