            ...
            >
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="px-2 py-1 bg-blue-100 text-amber-700 rounded-lg text-xs font-semibold uppercase">
                    {campaign.platform}
                  </span>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-4 py-2 text-sm font-semibold text-amber-600 hover:bg-blue-50 rounded-lg transition-colors"
                >
                  Edit
                </button>
                <button
