...
const INTEGRATION_META: Record<
  IntegrationSummary['integration_type'],
...
export function CampaignCardWithIntel({
  campaign,
  integrations = [],
}: CampaignCardWithIntelProps) {
  ...
  const isPerformingWell =
    campaign.success_rate > 25 || campaign.performance_score > 60;
        ...
        {hasResults ? (
            ...
            {campaign.performance_score > 0 && (
              ...
              >
                ...
                <div className="flex items-center gap-2 text-xs font-bold">
                  <span
                    className={
                      isPerformingWell ? 'text-green-700' : 'text-orange-700'
                    }
                  >
                    {campaign.percentile_rank > 0
                      ? `Top ${100 - campaign.percentile_rank}% performance`
            ...
            {hasInsights && (
              <div className="bg-teal-50 rounded-xl p-6 border-4 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h4 className="text-lg font-black text-gray-900 uppercase tracking-wider">
                    Campaign Insights
                  </h4>
                </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 text-center border-2 border-dashed border-gray-300">
            ...
            <p className="text-sm font-black text-gray-900 mb-1">
              Add Results to Unlock Intelligence
            </p>
