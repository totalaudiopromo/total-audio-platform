...
export function OnboardingChecklist({
  ...
  return (
    <div className="mb-8 bg-gradient-to-br from-teal-50 to-blue-50 rounded-2xl border-4 border-teal-500 shadow-brutal relative overflow-hidden">
      {/* Dismiss button */}
      <button
        onClick={() => setIsDismissed(true)}
        className="absolute top-4 right-4 p-2 rounded-lg bg-white border-2 border-teal-300 hover:bg-teal-50 transition-all z-10"
      ...
      <div className="px-6 py-6 sm:px-8 sm:py-8">
        ...
        <div className="flex items-start gap-4 mb-6 pr-10">
          <div className="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-teal-600 to-teal-600 rounded-2xl flex items-center justify-center border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="mb-6">
          ...
          <div className="h-3 bg-white rounded-full border-2 border-black overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-teal-600 to-teal-600 transition-all duration-500 ease-out"
                ...
                <div className="flex-1">
                  ...
                  {!item.completed && (
                    <Link
                      ...
                      className="inline-block px-5 py-2 bg-teal-600 text-white rounded-lg font-bold text-sm hover:bg-teal-700 transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 active:scale-95"
                    >
                      {item.action.label} →
                    </Link>
                  )}
