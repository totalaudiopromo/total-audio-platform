  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Total Audio Promo Brand System - Tool Colors
        // Base: Clean B&W foundation, color activates per tool
        'audio-intel': {
          DEFAULT: '#2563eb', // Electric Blue (from live site)
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
          300: '#93c5fd',
        ...
        'release-radar': {
          DEFAULT: '#14b8a6', // Teal/Cyan (Tracker primary - from live site)
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
          300: '#5eead4',
