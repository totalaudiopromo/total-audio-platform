        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 font-bold">
              To exercise these rights, email us at <a href="mailto:privacy@totalaudiopromo.com" className="text-purple-600 underline">privacy@totalaudiopromo.com</a> or
          ...
          <section className="mb-10">
            ...
            <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200">
              ...
              <p className="text-gray-700">Email: <a href="mailto:privacy@totalaudiopromo.com" className="text-purple-600 underline">privacy@totalaudiopromo.com</a></p>
          ...
          <section className="mb-10">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border-2 border-blue-200 mt-4">
              ...
              <p className="text-gray-700">Website: <a href="https://ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-purple-600 underline">ico.org.uk</a></p>
