...
export const metadata: Metadata = {
  ...
  description:
    'Privacy policy and GDPR compliance for Tracker campaign tracking software. UK-based data handling and user rights.',
  alternates: {
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">
              Total Audio Promo ("we", "our", or "us") operates Tracker, a
              campaign tracking platform for music professionals. This Privacy
          ...
          <section className="mb-10">
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                <strong>Campaign Data:</strong> Campaign names, contact lists,
                response tracking data, notes
              </li>
              <li>
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                ...
                and preferences (see Cookie Policy below)
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              <li>
                ...
                improve Tracker's features
              </li>
              <li>
                <strong>AI Intelligence:</strong> To generate campaign insights
                and benchmarks (anonymised data only)
              </li>
              <li>
                <strong>Communication:</strong> To send service updates, support
                responses, and optional newsletters
              </li>
              <li>
                <strong>Security:</strong> To protect against fraud,
                unauthorised access, and technical issues
              </li>
              <li>
          ...
          <section className="mb-10">
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                <strong>Consent:</strong> Marketing communications (you can opt
                out anytime)
              </li>
              <li>
                <strong>Legal Obligation:</strong> Compliance with UK law and
                regulations
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              <li>
                ...
                (payments), Vercel (hosting), Anthropic (AI processing) - all
                GDPR compliant
              </li>
              <li>
              ...
              <li>
                ...
                acquisition (you'll be notified)
              </li>
            </ul>
            <p className="text-gray-700">
              <strong>International Transfers:</strong> Some service providers
              may process data outside the UK. We ensure adequate safeguards are
          ...
          <section className="mb-10">
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                <strong>Right to Withdraw Consent:</strong> For marketing
                communications
              </li>
            </ul>
            <p className="text-gray-700 font-bold">
              ...
              or use the data deletion option in your dashboard settings.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                <strong>Backups:</strong> Backup data deleted within 90 days
              </li>
              <li>
                <strong>Legal Requirements:</strong> Some data may be retained
                longer for legal/accounting purposes (e.g., payment records for
                7 years)
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                <strong>Analytics Cookies:</strong> Google Tag Manager for usage
            ...
            <p className="text-gray-700">
              ...
              disabling essential cookies may prevent you from using Tracker.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700">
              Tracker is not intended for users under 16 years of age. We do not
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700">
              ...
              notification. The "Last updated" date at the top indicates when
              changes were made.
            </p>
          </section>
