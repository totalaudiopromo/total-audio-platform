...
export const metadata: Metadata = {
  ...
  description:
    'Terms of service for Tracker campaign tracking software. User rights, responsibilities, and service terms.',
  alternates: {
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">
              By accessing or using Tracker ("the Service"), operated by Total
              Audio Promo ("we", "our", or "us"), you agree to be bound by these
              Terms of Service. If you do not agree to these terms, please do
              not use the Service.
            </p>
            <p className="text-gray-700 leading-relaxed">
              These Terms constitute a legally binding agreement between you and
              Total Audio Promo, governed by the laws of England and Wales.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="mb-3 text-gray-700">
              Tracker is a campaign tracking platform that provides:
            </p>
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                Integration with third-party services (Google Sheets, Gmail,
                etc.)
              </li>
              <li>Export and reporting functionality</li>
            </ul>
            <p className="text-gray-700">
              The Service is currently in beta. Features may change, and we make
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700">
              ...
              <a
                href="mailto:security@totalaudiopromo.com"
                className="text-teal-600 underline"
              >
                security@totalaudiopromo.com
              </a>
              .
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <h3 className="mb-3 text-xl font-bold">
              4.2 Paid Plans (Professional and Agency)
            </h3>
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
            ...
            <p className="mb-4 text-gray-700">
              ...
              credit card information. By providing payment information, you
              authorise us to charge your payment method for all fees incurred.
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700">
              You retain all rights to the campaign data and content you upload
              to Tracker ("Your Data"). You grant us a licence to use Your Data
              solely to provide and improve the Service.
            </p>

            <h3 className="mb-3 text-xl font-bold">6.2 AI Processing</h3>
            <p className="mb-4 text-gray-700">
              By using AI-powered features, you consent to Your Data being
              processed by our AI service providers (e.g., Anthropic). Campaign
              insights are generated from anonymised, aggregated data.
            </p>
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                You must have the right to upload and share any contact
                information
              </li>
              <li>
                You must comply with GDPR and data protection laws when using
                our Service
              </li>
            </ul>
            ...
            <p className="mb-4 text-gray-700">
              You can export Your Data at any time in CSV or PDF format. Upon
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700">
              ...
              trademarks, is owned by Total Audio Promo and protected by UK and
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700">
              Tracker integrates with third-party services (Google Sheets,
              Gmail, Airtable, Mailchimp, etc.). Your use of these integrations
              is subject to the respective third-party terms of service.
            </p>
            <p className="text-gray-700">
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700">
              ...
              guarantee uninterrupted, error-free, or secure operation.
            </p>
            ...
            <p className="mb-4 text-gray-700">
              To the maximum extent permitted by UK law, Total Audio Promo shall
            ...
            <h3 className="mb-3 text-xl font-bold">
              9.3 AI-Generated Insights
            </h3>
            <p className="mb-4 text-gray-700">
              AI-generated campaign insights are provided for informational
              purposes only. We do not guarantee the accuracy or completeness of
              AI-generated content. You are responsible for verifying all
              insights before making business decisions.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700">
              ...
              these Terms, engage in fraudulent activity, or for any other
              reason at our sole discretion. We will provide notice when
              possible.
            </p>
            ...
            <ul className="mb-4 list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                ...
                (except within 14-day refund period)
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700">
              ...
              material changes via email or dashboard notification at least 30
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700">
              Before initiating legal proceedings, you agree to first attempt to
              resolve the dispute by contacting us at{' '}
              <a
                href="mailto:legal@totalaudiopromo.com"
                className="text-teal-600 underline"
              >
