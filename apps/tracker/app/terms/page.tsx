        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="mb-4 text-gray-700">
              ...
              unauthorised use at <a href="mailto:security@totalaudiopromo.com" className="text-teal-600 underline">security@totalaudiopromo.com</a>.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700">
              ...
              us at <a href="mailto:legal@totalaudiopromo.com" className="text-teal-600 underline">legal@totalaudiopromo.com</a>.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200">
              ...
              <p className="text-gray-700">Email: <a href="mailto:legal@totalaudiopromo.com" className="text-teal-600 underline">legal@totalaudiopromo.com</a></p>
              <p className="text-gray-700">Support: <a href="mailto:info@totalaudiopromo.com" className="text-teal-600 underline">info@totalaudiopromo.com</a></p>
