      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-8">
        ...
        <div className="bg-white rounded-2xl border-4 border-black shadow-brutal p-8">
          ...
          <div className="mt-8 p-6 bg-blue-50 border-2 border-blue-300 rounded-xl">
            ...
            <p className="text-gray-700 font-medium">
              Email us at <a href="mailto:support@totalaudiopromo.com" className="text-blue-600 hover:underline font-bold">support@totalaudiopromo.com</a> or check our <Link href="/docs" className="text-blue-600 hover:underline font-bold">full documentation</Link>.
            </p>
          </div>
        </div>
      </div>
