      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-12">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                    ...
                    <span className="text-blue-600 font-black">16% average success</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                    <span className="font-bold">Alternative → Weekend Shows:</span>
                    <span className="text-blue-600 font-black">14% average success</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                    <span className="font-bold">Electronic → New Music Shows:</span>
                    <span className="text-blue-600 font-black">12% average success</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                    <span className="font-bold">Folk → BBC Introducing:</span>
                    <span className="text-blue-600 font-black">10% average success</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center p-3 bg-blue-50 rounded">
                    ...
                    <span className="text-blue-600 font-black">9% success</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-yellow-50 rounded">
          ...
          <section id="cta" className="space-y-6">
            ...
            <div className="bg-blue-50 border-4 border-blue-500 rounded-xl p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/signup"
                  className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-black text-base px-8 py-4 rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all"
                >
                  Start Tracking Free
                </Link>
                <Link
