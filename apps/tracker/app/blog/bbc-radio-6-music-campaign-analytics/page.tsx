...
export const metadata: Metadata = {
  title:
    'BBC Radio 6 Music Campaign Analytics: Track Alternative Radio Success (2025)',
  description:
  ...
  keywords:
    'bbc radio 6 music campaign tracking, alternative radio promotion, bbc 6 music success rate, indie radio campaign benchmarks, radio 6 music analytics',
  openGraph: {
    title:
      'BBC Radio 6 Music Campaign Analytics: Real Benchmarks for Alternative Radio',
    description:
      'See industry benchmarks, specialist show success rates, and exactly what works for BBC Radio 6 Music campaigns.',
  ...
  twitter: {
    ...
    description:
      'Real success rates and campaign intelligence for BBC Radio 6 Music. Built by promoters tracking alternative radio.',
  },
};
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        <header className="mb-12">
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 leading-tight">
            BBC Radio 6 Music Campaign Analytics: Stop Guessing Your Alternative
            Radio Success
          </h1>
          ...
          <div className="bg-blue-50 border-l-4 border-teal-500 p-6 rounded-lg">
            <p className="text-lg text-gray-800 font-medium leading-relaxed">
              After tracking over 150 BBC Radio 6 Music campaigns, here's what
              nobody tells you: your 10% specialist show success rate? That's
              actually above the 8% industry average for alternative music. But
              you're ignoring the daytime shows (2% success) when you should
              focus on evening specialists (14% success). Here's how to track
              Radio 6 campaigns properly.
            </p>
          </div>
        </header>
        ...
        <div className="space-y-12">
          ...
          <section id="campaign-reality" className="space-y-6">
            <h2 className="text-3xl font-black text-gray-900">
              The Reality of BBC Radio 6 Music Campaigns
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              Right, so you've just spent £300 on a Radio 6 Music campaign
              targeting alternative/indie artists. You got 4 specialist show
              plays out of 35 pitches sent. Is that good? Should you try BBC
              Radio 1 instead? Without proper campaign analytics and industry
              benchmarks, you're flying blind.
            </p>
          ...
          <section id="benchmarks" className="space-y-6">
            <h2 className="text-3xl font-black text-gray-900">
              BBC Radio 6 Music Campaign Benchmarks (2025 Data)
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              These are real success rates from Radio 6 Music campaigns we've
              tracked. Show type, genre fit, and timing massively impact your
              results.
            </p>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-red-50 rounded border border-red-200">
                    <span className="font-bold">
                      Daytime (Lauren Laverne, Mary Anne Hobbs):
                    </span>
                  ...
                  <div className="flex justify-between items-center p-3 bg-green-50 rounded border border-green-200">
                    <span className="font-bold">
                      Evening Specialists (Gideon Coe, Marc Riley):
                    </span>
                  ...
                  <div className="flex justify-between items-center p-3 bg-blue-50 rounded">
                    <span className="font-bold">
                      Weekend Shows (Jarvis Cocker, Iggy Pop):
                    </span>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                    <span className="font-bold">
                      Indie Rock → Evening Specialists:
                    </span>
                    <span className="text-teal-600 font-black">
                      16% average success
                    </span>
          ...
          <section id="why-manual-fails" className="space-y-6">
            <h2 className="text-3xl font-black text-gray-900">
              Where Manual Radio 6 Campaign Tracking Falls Apart
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              Most promoters track Radio 6 campaigns in spreadsheets. It takes
            ...
            <ul className="space-y-4 text-base text-gray-700 leading-relaxed pl-4">
              <li>
                ...
                You see "4 plays from 35 pitches" (11% success) but don't know
                if that's good. The Radio 6 specialist show average is 8%, so
              ...
              <li>
                ...
                Your indie tracks always get picked up by Gideon Coe but ignored
                by Lauren Laverne. That's a pattern worth £££ in budget
              ...
              <li>
                ...
                You're pitching daytime shows (2% success rate) when you should
                target evening specialists (14% success rate). One spreadsheet
                column labelled "Radio 6" hides the massive difference between
                show types.
              </li>
              <li>
                <strong className="text-gray-900">
              ...
              <li>
                ...
                You can't show a label why their 10% success rate is actually
                strong for Radio 6 specialist shows, or prove which targeting
          ...
          <section id="how-tracker-works" className="space-y-6">
            <h2 className="text-3xl font-black text-gray-900">
              How Campaign Intelligence Works for BBC Radio 6 Music
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              Tracker replaces your messy spreadsheet with AI-powered campaign
              intelligence. Here's exactly how it works for Radio 6 campaigns.
            </p>
            <ol className="list-decimal pl-6 space-y-4 text-base text-gray-700 leading-relaxed">
              <li>
                ...
                Add your Radio 6 pitching data (shows targeted, presenters
              ...
              <li>
                ...
                genre. Know immediately if your 10% specialist success is above
                the 8% average.
              </li>
              <li>
                <strong className="text-gray-900">
                ...
                Get actionable suggestions: "Target Gideon Coe 6-8 weeks out
                instead of Lauren Laverne 2 weeks out to improve from 6% to 12%
              ...
              <li>
                ...
                comparisons, and which Radio 6 shows deliver best ROI. Perfect
          ...
          <section id="common-mistakes" className="space-y-6">
            <h2 className="text-3xl font-black text-gray-900">
              5 BBC Radio 6 Music Campaign Tracking Mistakes
            </h2>

            <div className="space-y-6">
              <div className="bg-white border-l-4 border-red-500 p-6 rounded-r-xl shadow-sm">
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  Mistake #1: Treating All Radio 6 Shows as One Target
                </h3>
                <p className="text-base text-gray-700 leading-relaxed">
                  Daytime shows (Lauren Laverne, Mary Anne Hobbs) have 2%
                  success rates. Evening specialists (Gideon Coe, Marc Riley)
                  hit 14%. Tracking everything as "Radio 6" hides the fact
                  you're wasting 90% of your budget on daytime pitches that
                  never convert.
                </p>
              </div>
              ...
              <div className="bg-white border-l-4 border-red-500 p-6 rounded-r-xl shadow-sm">
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  Indie rock tracks to Gideon Coe hit 16% success. Same tracks
                  to Lauren Laverne? 1% success. Without tracking which shows
                  match your genre, you keep pitching the wrong targets and
                  wonder why nothing lands.
                </p>
              </div>
              ...
              <div className="bg-white border-l-4 border-red-500 p-6 rounded-r-xl shadow-sm">
                ...
                <p className="text-base text-gray-700 leading-relaxed">
                  ...
                  Campaigns 6-8 weeks out hit 12% success. That timing
                  difference could 4x your play count, but manual tracking won't
              ...
              <div className="bg-white border-l-4 border-red-500 p-6 rounded-r-xl shadow-sm">
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  Mistake #4: Ignoring Weekend Specialists
                </h3>
                <p className="text-base text-gray-700 leading-relaxed">
                  Weekday specialist pitches hit 14% success. Weekend
                  specialists (Jarvis Cocker, Iggy Pop) hit 12% but with
                  different demographics. Without tracking both weekday and
                  weekend performance, you miss opportunities to reach different
                  listener bases.
                </p>
              </div>
          ...
          <section id="faq" className="space-y-6">
            ...
            <div className="space-y-4">
              <details className="bg-white border-4 border-black rounded-xl p-6 group">
                ...
                <div className="mt-4 text-base text-gray-700 leading-relaxed space-y-3">
                  <p>
                    ...
                    shows have 2% success rates—basically zero for unsigned
                    artists. Evening specialists average 14% success. Weekend
                    shows hit 12%. BBC Introducing averages 8%.
                  </p>
                  <p>
                    If you're tracking "Radio 6" as one category, you're hiding
                    the fact that 80% of your budget might be wasted on daytime
                    shows that rarely pick up unsigned alternative music.
                    Tracker breaks this down by show type automatically.
                  </p>
                </div>
              </details>
              ...
              <details className="bg-white border-4 border-black rounded-xl p-6 group">
                <summary className="text-xl font-bold text-gray-900 cursor-pointer list-none flex justify-between items-center">
                  Should I target daytime or specialist shows on BBC Radio 6
                  Music?
                  <span className="text-2xl group-open:rotate-180 transition-transform">
                    ▼
                  </span>
                ...
                <div className="mt-4 text-base text-gray-700 leading-relaxed space-y-3">
                  <p>
                    ...
                    established, forget daytime. Evening specialists (Gideon
                    Coe, Marc Riley) and weekend shows (Jarvis Cocker, Iggy Pop)
                    are where unsigned alternative artists actually get plays.
                  </p>
                  <p>
                    Daytime shows play established artists and proven hits.
                    Specialist shows actively hunt for new alternative music.
                    Your 2% daytime success rate vs 14% specialist success rate
                    proves this—but most artists don't track the difference and
                    keep wasting budget on daytime.
                  </p>
                </div>
              </details>
              ...
              <details className="bg-white border-4 border-black rounded-xl p-6 group">
                ...
                <div className="mt-4 text-base text-gray-700 leading-relaxed space-y-3">
                  <p>
                    ...
                    (12% average success). Pitching 4-5 weeks out drops to 9%,
                    2-3 weeks hits 6%, and the week of release tanks to 3%
                    success.
                  </p>
                  <p>
                    Radio 6 specialist shows plan programming weeks in advance.
                    Earlier pitches get more listening time and consideration.
                    Last-minute pitches get ignored because producers have
                    already locked in their next month of plays.
                  </p>
                </div>
              </details>
              ...
              <details className="bg-white border-4 border-black rounded-xl p-6 group">
                ...
                <div className="mt-4 text-base text-gray-700 leading-relaxed space-y-3">
                  <p>
                    Indie rock and alternative → Gideon Coe, Marc Riley (16%
                    success). Electronic → Steve Lamacq new music shows (12%
                    success). Folk → BBC Introducing (10% success). Weekend
                    shows (Jarvis Cocker, Iggy Pop) work well for established
                    alternative sounds (12% success).
                  </p>
                  <p>
              ...
              <details className="bg-white border-4 border-black rounded-xl p-6 group">
                ...
                <div className="mt-4 text-base text-gray-700 leading-relaxed space-y-3">
                  <p>
                    ...
                    of your Radio 6 campaign data. The BBC doesn't provide
          ...
          <section id="related-guides" className="space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Tracking BBC Radio 6 Music campaigns? You might also benefit from
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Compare Radio 6 vs Radio 1 performance. See which platform
                  delivers better ROI for alternative music.
                </p>
              </Link>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Track the unsigned artist pathway from BBC Introducing to
                  Radio 6 specialist shows.
                </p>
              </Link>
            </div>
          </section>
          ...
          <section id="cta" className="space-y-6">
            <h2 className="text-3xl font-black text-gray-900">
              Track Your BBC Radio 6 Music Campaigns Properly
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              Stop guessing if your Radio 6 campaigns are working. Get instant
            ...
            <div className="bg-blue-50 border-4 border-teal-500 rounded-xl p-8">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Industry benchmark comparison (see your 10% vs 8% specialist
                    average instantly)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-teal-600 font-black text-xl">✓</span>
                  <span>
                    Timing optimization (pitch 6-8 weeks out for 12% success vs
                    3% last-minute)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-teal-600 font-black text-xl">✓</span>
                  <span>
                    Export-ready reports (prove Radio 6 campaign value to labels
                    with benchmark data)
                  </span>
                </li>
              </ul>
