    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-blue-50">
      <div className="max-w-4xl mx-auto p-4 sm:p-8">
        <Link
          ...
          className="inline-flex items-center gap-2 text-teal-600 font-bold hover:underline mb-6"
        >
        ...
        <div className="bg-white rounded-2xl border-4 border-black shadow-brutal p-6 sm:p-8">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 bg-teal-600 hover:bg-teal-700 text-white font-black px-6 py-3 rounded-xl border-2 border-black shadow-brutal hover:translate-y-0.5 transition-all"
            >
              Done
            </button>
            <button
