...
export default async function DashboardPage() {
  ...
  const totalSpent = enrichedCampaigns.reduce(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border-4 border-black shadow-brutal hover:shadow-brutal-lg hover:-translate-x-1 hover:-translate-y-1 transition-all">
              <p className="text-sm font-black text-gray-500 mb-2 uppercase tracking-wider">
                Total Campaigns
              </p>
            ...
            <div className="bg-[#14B8A6]/5 rounded-2xl p-6 border-4 border-[#14B8A6] shadow-brutal hover:shadow-brutal-lg hover:-translate-x-1 hover:-translate-y-1 transition-all">
              <p className="text-sm font-black text-[#14B8A6] mb-2 uppercase tracking-wider">
                Active Now
              </p>
              <p className="text-4xl font-black text-[#14B8A6] mb-1">
                {activeCampaigns}
              </p>
