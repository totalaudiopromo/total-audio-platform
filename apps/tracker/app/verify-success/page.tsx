  ...
  return (
    <div className="mx-auto w-full max-w-2xl">
      <div className="glass-panel px-8 py-12 text-center">
        ...
        <div className="mb-8 bg-gradient-to-br from-amber-50 to-blue-50 rounded-xl p-6 border-2 border-amber-200">
          <h3 className="font-bold text-gray-900 mb-3">What's next?</h3>
          <ul className="space-y-3 text-left text-sm text-gray-700">
            <li className="flex items-start gap-3">
              <div className="flex-shrink-0 w-6 h-6 bg-amber-600 rounded-md flex items-center justify-center border-2 border-black">
        ...
        <Link
          href="/dashboard"
          className="inline-block px-12 py-4 bg-amber-600 text-white rounded-xl font-bold hover:bg-amber-700 transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5"
        >
          Go to Dashboard →
        </Link>
      </div>
