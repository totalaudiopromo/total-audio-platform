      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-2xl p-8">
          ...
          <p className="text-lg text-gray-700 mb-6">
            We're building an interactive demo to show you exactly how Tracker's
            campaign intelligence works.
          </p>
          <p className="text-gray-600">
            In the meantime, you can start tracking your campaigns right now
            with our free tier.
          </p>
        </div>
      </main>
