    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/signup" className="bg-purple-600 text-white px-4 py-2 rounded-lg font-bold hover:bg-purple-700 transition-colors">
                Try Free
              </Link>
            </div>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <Link 
            href="/signup"
            className="inline-block bg-purple-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-purple-700 transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
          >
            Start Tracking Free
          </Link>
        </div>
