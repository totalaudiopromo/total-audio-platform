    ...
    <div className="postcraft-page space-y-8">
      ...
      >
        <div>
          <h2 style={{ fontWeight: 700, marginBottom: '0.25rem' }}>
            Prefer the streamlined Social Hub?
          </h2>
          <p style={{ color: 'var(--intel-gray-600)' }}>
            Create, schedule and analyse posts in one place.
          </p>
        </div>
        <a href="/social-media-hub" className="intel-button">
          Open Social Hub
        </a>
      </div>
      ...
      <div className="postcraft-section">
        ...
        <div className="postcraft-actions-grid">
          ...
          <button
            onClick={() =>
              handleQuickAction('generate_blog', {
                topic: {
                  title: 'contact enrichment automation',
                  keywords: ['music industry tools'],
                },
              })
            }
            disabled={loading}
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <span
              className={`px-3 py-1 rounded-full text-sm font-semibold ${
                content.success ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
              }`}
            >
