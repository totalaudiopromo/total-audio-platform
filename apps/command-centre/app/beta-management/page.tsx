...
export default function BetaManagementPage() {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'users' | 'analytics' | 'signup'>(
    'dashboard'
  );
  ...
  const [filterApp, setFilterApp] = useState<
    'all' | 'audio-intel' | 'playlist-pulse' | 'command-centre' | 'web'
  >('all');
...
Total Audio Promo`;
    ...
    window.open(
      `mailto:${user.email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`
    );
  };
      ...
      <div>
        {activeTab === 'users' ? (
              ...
              {filteredUsers.map(user => (
                <div key={user.id} className="postcraft-card">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="postcraft-label">{user.name || user.email.split('@')[0]}</h3>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="text-center">
                      <div className="text-xl font-black text-purple-600">{user.sessionCount}</div>
                  ...
                  <div className="flex justify-between items-center text-xs postcraft-text">
                    ...
                    <span className="flex items-center gap-1">
                      {(user as any).device?.type === 'desktop' ? (
                        <Monitor size={12} />
                      ) : (
                        <Smartphone size={12} />
                      )}
          ...
          <div className="postcraft-section">
            <div className="postcraft-card">
              <h2 className="postcraft-section-title mb-6">User Analytics & Insights</h2>
              ...
              {betaData?.analytics && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    {betaData.analytics.topFeatures.map(feature => (
                      <div key={feature.feature} className="mb-4">
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="font-bold text-blue-600">{feature.usage} users</span>
                        </div>
                  ...
                  <div>
                    ...
                    {Object.entries(
                      ((betaData.analytics as any).deviceBreakdown || {}) as Record<string, number>
                    ).map(([device, count]) => (
              ...
              <div className="postcraft-metrics-grid">
                <div className="postcraft-metric-card">
                  ...
                  <div className="postcraft-metric-value">
                    {betaData?.analytics?.engagementMetrics.avgSessionTime || 0}min
                  </div>
                ...
                <div className="postcraft-metric-card">
                  ...
                  <div className="postcraft-metric-value">
                    {betaData?.analytics?.engagementMetrics.avgContactsPerUser || 0}
                  </div>
                ...
                <div className="postcraft-metric-card">
                  ...
                  <div className="postcraft-metric-value">
                    {betaData?.analytics?.engagementMetrics.conversionRate || 0}%
                  </div>
          ...
          <div className="postcraft-section">
            ...
            {betaData && (
              <div className="postcraft-card mb-8">
                <h3 className="postcraft-section-title mb-6">Beta User Analytics</h3>
                ...
                {betaData.users && betaData.users.length > 0 && (
                  <div>
                    <h4 className="postcraft-label mb-4">Active Beta Users</h4>
                        ...
                        >
                          <div className="flex justify-between items-start mb-4">
                            <div className="flex-1">
                              ...
                              <p className="postcraft-text text-xs mb-2">{user.email}</p>
                              <div className="flex items-center gap-2">
                                <div
                                  className={`w-2 h-2 rounded-full ${
                                    user.status === 'active'
                          ...
                          <div className="grid grid-cols-2 gap-3 text-xs mb-4">
                            ...
                            <div>
                              ...
                              <div className="font-black text-blue-600">{user.sessionCount}</div>
                            </div>
                            <div>
            ...
            {isSubmitted ? (
              <div className="max-w-2xl mx-auto">
                <div className="postcraft-card text-center">
                  ...
                  <h2 className="postcraft-title mb-4">Beta User Added Successfully!</h2>

                  <p className="postcraft-text text-lg mb-8">
                    The new beta user has been added to Audio Intel. They will receive access
                    details shortly.
                  </p>
                  ...
                  <div className="flex gap-4 justify-center">
                    ...
                    <button onClick={() => setActiveTab('dashboard')} className="postcraft-button">
                      View Dashboard
                    </button>
                  </div>
                </div>
              ...
              <div className="max-w-3xl mx-auto">
                <div className="postcraft-card">
                  <div className="text-center mb-8">
                    ...
                    <h2 className="postcraft-title mb-2">Add New Beta User</h2>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                      <div>
                        <label className="postcraft-label mb-2 block">Name *</label>
                        <input
                          type="text"
                          required
                          value={formData.name}
                      ...
                      <div>
                        <label className="postcraft-label mb-2 block">Email *</label>
                        <input
                          type="email"
                          required
                    ...
                    {/* Role */}
                    <div className="mb-8">
                      <label className="postcraft-label mb-4 block">User Type *</label>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                          ...
                          <label key={role.value} className="cursor-pointer">
                            ...
                            />
                            <div
                              className={`px-4 py-3 rounded-xl border-3 border-black text-center font-bold transition-all ${
                    ...
                    <div className="mb-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {[
                          ...
                          <label
                            key={interest}
                            className="flex items-center gap-3 px-4 py-3 border-2 border-black rounded-xl bg-white cursor-pointer hover:bg-gray-50 transition-colors"
                          >
                            <input
                              type="checkbox"
                            ...
                            />
                            <span className="postcraft-text font-bold">{interest}</span>
                          </label>
                        ))}
                      </div>
                    </div>
                    ...
                    {/* Current Tools */}
                    <div className="mb-8">
                      <label className="postcraft-label mb-2 block">Current Tools</label>
                      <textarea
                        value={formData.currentTools}
                        onChange={e =>
                          setFormData(prev => ({ ...prev, currentTools: e.target.value }))
                        }
                    ...
                    {/* Goals */}
                    <div className="mb-8">
                      <label className="postcraft-label mb-2 block">Goals with Audio Intel</label>
                      <textarea
