/**
 * GET /api/meshos/contradictions
 * Returns contradiction graph snapshot
 */

import { NextRequest, NextResponse } from 'next/server';
import { getContradictionGraphSnapshot, type GetContradictionGraphResponse } from '@total-audio/meshos';
