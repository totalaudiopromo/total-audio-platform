...
async function generateReportData(reportId: string): Promise<ReportData | null> {
  ...
  const reportGenerators: { [key: string]: () => ReportData } = {
    ...
    'user-activity': () => ({
      ...
      users: [
        { id: 1, email: 'user1@example.com', lastActive: '2025-08-29', contactsEnriched: 150, emailsValidated: 300 },
        { id: 2, email: 'user2@example.com', lastActive: '2025-08-28', contactsEnriched: 89, emailsValidated: 200 },
        { id: 3, email: 'user3@example.com', lastActive: '2025-08-27', contactsEnriched: 45, emailsValidated: 120 },
        { id: 4, email: 'user4@example.com', lastActive: '2025-08-26', contactsEnriched: 0, emailsValidated: 50 }
      ],
      engagement: {
    ...
    'beta-feedback': () => ({
      ...
      feedback: [
        ...
        { user: 'user2@example.com', rating: 4, comment: 'Good tool, would like bulk processing features' },
