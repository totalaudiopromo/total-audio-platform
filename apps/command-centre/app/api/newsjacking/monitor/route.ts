...
const MUSIC_INDUSTRY_SOURCES: NewsSource[] = [
  // Music Industry Core Sources
  {
    ...
    priority: 1,
    keywords: ['independent', 'streaming', 'royalties', 'distribution', 'playlist', 'AI', 'technology', 'contacts', 'database']
  },
  {
    ...
    category: 'music-tech',
    priority: 1,
    keywords: ['startup', 'funding', 'platform', 'streaming', 'technology', 'innovation', 'AI', 'promotion', 'contact']
  },
  {
    ...
    category: 'podcast',
    priority: 1,
    keywords: ['music technology', 'innovation', 'streaming', 'AI', 'startup', 'platform', 'contact intelligence', 'data']
  },
  ...
  // Business & Marketing Strategy Sources
  {
    ...
    category: 'podcast',
    priority: 1,
    keywords: ['startup', 'business model', 'marketing', 'growth', 'SaaS', 'database', 'tools', 'platform']
  },
  {
    ...
    category: 'podcast', 
    priority: 1,
    keywords: ['marketing', 'growth', 'content', 'social media', 'strategy', 'audience', 'engagement', 'database']
  },
  {
  ...
  },
  {
    ...
    category: 'podcast',
    priority: 1,
    keywords: ['startup', 'idea', 'business model', 'SaaS', 'tools', 'platform', 'market opportunity']
  },
  ...
  // Music Industry Specific  
  {
    ...
    category: 'music-business',
    priority: 1,
    keywords: ['independent', 'DIY', 'promotion', 'marketing', 'streaming', 'royalties', 'contact', 'submission']
  },
  {
  ...
  },
  {
    ...
    category: 'music-tech',
    priority: 2,
    keywords: ['social media', 'TikTok', 'streaming', 'technology', 'platforms', 'AI', 'contact', 'curator']
  },
  ...
  },
  {
    ...
    category: 'podcast',
    priority: 2,
    keywords: ['music production', 'artist', 'recording', 'songwriting', 'creative process', 'industry']
  }
];
...
function calculateRelevanceScore(item: any, source: NewsSource): number {
  ...
  const directBusinessKeywords = [
    'contact database', 'playlist curator', 'music submission', 'email list', 'contact enrichment',
    'industry contacts', 'music contacts', 'curator contact', 'label contact', 'radio contact'
  ];
  ...
  const audioIntelKeywords = [
    'contact', 'database', 'list', 'email', 'promotion', 'submit', 'submission', 'playlist', 
    'curator', 'gatekeepers', 'industry professionals', 'music business', 'networking'
  ];
  ...
  const disruptionKeywords = [
    'platform launch', 'new service', 'industry change', 'disruption', 'streaming platform',
    'radio changes', 'playlist changes', 'algorithm update', 'new gatekeepers', 'industry shift'
  ];
  ...
  const saasKeywords = [
    'SaaS', 'database business', 'B2B tool', 'industry tool', 'music tech startup', 
    'contact management', 'CRM', 'lead generation', 'business intelligence'
  ];
  ...
  const indieKeywords = [
    'independent artist', 'indie music', 'unsigned', 'self-released', 'DIY music', 'bedroom producer'
  ];
  ...
  if (content.includes('breaking') || content.includes('announced') || content.includes('launches')) {
    score += 0.05;
  }
