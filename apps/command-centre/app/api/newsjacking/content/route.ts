      ...
      const mockContent: GeneratedContent[] = [
        {
          ...
          originalStory: {
            ...
            content:
              'Spotify has just announced a groundbreaking new AI-powered playlist creation tool specifically designed for independent artists. The new feature, called "Playlist AI Pro," allows artists to automatically generate targeted playlists based on their music style, audience demographics, and streaming data.',
          ...
          unsignedAngle: {
            ...
            keyInsight:
              'This democratizes playlist creation - no more paying thousands for playlist pitching services',
            actionableAdvice:
              'Sign up for the beta immediately and start building your playlists now',
            urgency: 'immediate',
          },
          newsletterSections: [
            {
              title: "This Week's Industry Intel",
              content:
                "Right, so whilst Spotify is making announcements, here's why that's actually brilliant news for independent artists...\n\nNow, here's your move: New platform features favor artists who can adapt quickly over those stuck in old systems.",
              type: 'industry_intel',
              priority: 1,
            },
            {
              ...
              content:
                'The reality is this: major labels have been using AI playlist tools for months. Now you can too...\n\nWhat this actually means for you: Level playing field.',
              type: 'trend_alert',
              priority: 2,
            },
          ],
          multiPlatformContent: {
            ...
            linkedin: {
              content: {
                ...
                article:
                  "Spotify's new AI playlist tool represents a fundamental shift in how independent artists can compete with major labels...",
              },
            ...
            instagram: {
              content: {
                ...
                caption:
                  'While major labels struggle with bureaucracy, indies move fast and win. Link in bio for the full breakdown 🔥',
              },
        ...
        },
        {
          ...
          originalStory: {
            ...
            content:
              'The BBC, Capital FM, and other major UK radio stations have jointly announced new streamlined submission guidelines that eliminate manual processes for independent artists.',
            source: 'Music Week',
          ...
          newsletterSections: [
            {
              ...
              content:
                "While everyone's talking about UK radio automation, here's what independent artists should actually be focusing on...\n\nHere's your move: The manual research that used to take 4 hours per station is now automated.",
              type: 'industry_intel',
              priority: 1,
            },
          ],
          multiPlatformContent: {
            ...
            instagram: {
              content: {
                ...
                caption:
                  'The biggest radio industry change in 20 years just happened. Indies, this is your moment 📻',
              },
