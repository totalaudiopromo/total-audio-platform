    ...
    <div className="space-y-6">
      ...
      <div className="intel-card">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Real-time agent status and cost tracking</p>
          </div>
          <div className={`px-4 py-2 rounded-lg border-2 ${getHealthColor(data.health)}`}>
            <div className="text-sm font-semibold">{data.health.toUpperCase()}</div>
          </div>
        </div>
      ...
      <div className="intel-card">
        ...
        <div className="mb-4">
          <div className="flex justify-between text-sm mb-2">
            <span>
              £{data.costs.month.total.toFixed(2)} / £{data.costs.month.budget}
            </span>
            <span
              className={
                data.costs.month.percentUsed > 90 ? 'text-red-600 font-semibold' : 'text-gray-600'
              }
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          ...
          <div className="bg-gray-50 rounded p-3">
            ...
            <div className="text-lg font-semibold">
              £{data.costs.month.projectedTotal.toFixed(2)}
            </div>
          </div>
      ...
      <div className="intel-card">
        ...
        <div className="space-y-2">
          {Object.entries(data.costs.services).map(
            ([service, serviceData]) =>
              serviceData.cost > 0 && (
                <div
                  key={service}
