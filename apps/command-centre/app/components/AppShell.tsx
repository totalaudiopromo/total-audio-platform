              ...
              <div className="max-w-lg w-full lg:max-w-xs">
                ...
                <div className="relative">
                  ...
                  <input
                    id="search"
                    name="search"
                    className="block w-full pl-10 pr-3 py-2 border-2 border-black rounded-lg font-medium bg-white placeholder-gray-500 focus:outline-none focus:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all sm:text-sm"
                    placeholder="Search..."
                    type="search"
                  />
                </div>
