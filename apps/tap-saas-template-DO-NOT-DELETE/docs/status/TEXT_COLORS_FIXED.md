...
- **Professional Plan**: £39/month with full feature list
- **Agency Plan**: £79/month with full feature list
- **Monthly/Annual toggle**: Working and visible
- **Checkout button**: Fully functional

### Generate Pitch Page (`/pitch/generate`)

- **Complete form**: All fields visible and functional
- **Contact dropdown**: Shows "Select a contact..." (will populate once you add contacts)
- **Artist details**: Name, track title, genre, release date fields
...
- **Pricing page**: Full plan details with prices
- **Generate pitch**: Populated contact dropdown with BBC Radio 1, Spotify, etc.
