...
import { Search, Music, Mic, Headphones, TrendingUp, BarChart3, Zap, Target, Globe, Users, Clock, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f8f9fa]">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <a href="#" className="brand-nav-link">Pricing</a>
              <a href="#" className="brand-nav-link">How It Works</a>
              <a href="#" className="brand-nav-link">FAQ</a>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <h1 className="brand-title mb-6">
              Stop Wasting <span className="brand-title-highlight">15 Hours a Week</span><br />
              Researching SEO Keywords
            </h1>
            <p className="brand-subtitle mb-12 max-w-3xl mx-auto">
              Get instant access to audio-specific SEO recommendations with AI-powered keyword analysis that gets 3x more organic traffic
            </p>
      ...
      <section className="max-w-6xl mx-auto px-4 mb-16">
        <div className="brand-card-primary p-12">
          ...
          <p className="brand-text text-center mb-8">Enter your domain to get audio-specific SEO recommendations</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="brand-card p-6 text-center">
              ...
              <p className="brand-text">Optimize for music promotion, distribution, and discovery</p>
            </div>
            <div className="brand-card p-6 text-center">
          ...
          <div className="brand-card-primary p-8 mb-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="brand-text">Domain: <strong>{analysis.domain}</strong></p>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              <div className="brand-card p-4 text-center">
                <div className="text-2xl font-black text-gray-900">{analysis.summary.totalKeywords}</div>
                <div className="brand-text text-sm">Keywords</div>
              </div>
              <div className="brand-card p-4 text-center">
                <div className="text-2xl font-black text-gray-900">{analysis.summary.totalQuestions}</div>
                <div className="brand-text text-sm">Questions</div>
              </div>
              <div className="brand-card p-4 text-center">
                <div className="text-2xl font-black text-gray-900">{analysis.summary.totalLongTail}</div>
                <div className="brand-text text-sm">Long-tail</div>
              </div>
              <div className="brand-card p-4 text-center">
                <div className="text-2xl font-black text-gray-900">{analysis.summary.totalSuggestions}</div>
