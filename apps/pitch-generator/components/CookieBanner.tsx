      ...
      <div className="mx-auto max-w-5xl px-3 sm:px-4 pb-3 sm:pb-4">
        <div className="bg-white rounded-lg border-3 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-3 sm:p-4">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 w-8 h-8 bg-amber-600 rounded-lg flex items-center justify-center border-2 border-black">
              <Cookie className="w-4 h-4 text-white" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-xs sm:text-sm font-bold text-gray-700 mb-3">
                We use essential cookies for authentication and analytics to understand usage. No
                tracking or data selling.{' '}
                <Link href="/privacy" className="text-amber-600 hover:underline whitespace-nowrap">
                  Learn more
                </Link>
              </p>
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="px-4 py-1.5 bg-amber-600 text-white rounded-lg font-black text-xs hover:bg-amber-700 transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 active:scale-95 border-2 border-black"
                >
                  Accept All
                </button>
                <button
