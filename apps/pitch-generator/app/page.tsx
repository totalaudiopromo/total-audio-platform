...
const features = [
  ...
  },
  {
    ...
    description: 'Generate 50 personalised pitches in 20 minutes instead of spending hours on each one.',
    color: 'brand-amber',
  },
];
      ...
      <section className="glass-panel overflow-hidden bg-gradient-to-br from-purple-50 to-indigo-50 px-6 py-12 sm:px-10">
        <div className="text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg text-gray-700">
            Five features built to make pitching faster and less painful. Each one solves a real problem
            from 5 years of running radio campaigns.
          </p>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="rounded-xl border-2 border-black bg-white p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
              ...
              <p className="mt-3 text-sm font-bold uppercase tracking-wider text-gray-900">Copy All</p>
              <p className="mt-2 text-xs text-gray-600">One click to copy all batch pitches ready for Gmail</p>
            </div>
            <div className="rounded-xl border-2 border-black bg-white p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
      ...
      <section className="glass-panel px-6 py-10 sm:px-10">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <p className="mt-2 max-w-xl text-sm text-gray-600">
            Start free with 10 pitches per month. Upgrade when you need more. No credit card required.
          </p>
          </div>
          <div className="flex flex-wrap items-center gap-3">
            <Link href="/auth/signin" className="cta-button">Start free trial →</Link>
