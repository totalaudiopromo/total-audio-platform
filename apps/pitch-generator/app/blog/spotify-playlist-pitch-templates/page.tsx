...
export const metadata: Metadata = {
  ...
  description: "Write Spotify playlist pitches that get placements. See proven templates (18-28% response by genre), curator benchmarks, and exactly what makes playlist curators respond.",
  keywords: "spotify playlist pitch, playlist pitch template, spotify curator pitch, playlist submission template, spotify pitch writing",
};
        ...
        <header className="mb-12">
          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 p-6 rounded-lg">
            <p className="text-lg text-gray-800 leading-relaxed">
              ...
              to write playlist pitches that actually get placements.
            </p>
          </div>
        </header>
        ...
        <div className="space-y-12 bg-white rounded-xl p-8 md:p-12">
          <section className="space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Right, so you've just sent the same pitch to 30 different playlist curators. You got 2 adds out of 30 submissions. Is that good?
              Terrible? Should you change your approach? Without understanding playlist benchmarks, you're just hoping.
            </p>
          ...
          <section className="space-y-6">
            <h2 className="text-3xl font-black text-gray-900">Spotify Playlist Pitch Benchmarks (2025)</h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              These are real response rates from playlist pitches. Genre fit and playlist size massively impact your results.
            </p>

            <div className="space-y-4">
              <div className="flex justify-between items-center p-4 bg-red-50 rounded-lg border border-red-200">
                <span className="font-bold">Major Playlists (1M+ followers)</span>
                <span className="text-red-600 font-black">2-4% response (editorial gatekeepers)</span>
              </div>
          ...
          <section className="space-y-6">
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 space-y-4">
              ...
              <p className="text-gray-700">
                2-3 sentences. Genre positioning, why it fits THIS playlist specifically, reference points. Don't oversell.
              </p>
              <div className="bg-white p-4 rounded border border-green-200">
                <p className="text-gray-800 italic">
                  "[Artist Name]'s '[Track Name]' is downtempo electronica with live instrumentation - guitar and Rhodes over subtle 808s.
                  Perfect for late-night study sessions. Sits between Alfa Mist and Jordan Rakei's more electronic moments."
                </p>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-6 space-y-4">
              ...
              <p className="text-gray-700">
                Only mention streaming numbers if they're actually impressive for independent artists (20K+ streams in first month, growing Save Rate, etc.).
              </p>
              <div className="bg-white p-4 rounded border border-yellow-200">
                <p className="text-gray-800 italic">
                  "Track's at 28K streams in 3 weeks with 18% save rate - seems to be resonating with the late-night chill crowd. Getting organic
                  playlist adds on similar vibe lists."
                </p>
              </div>
            </div>
          ...
          <section className="space-y-6">
            <h2 className="text-3xl font-black text-gray-900">Mistakes Killing Your Playlist Response Rate</h2>

            <div className="space-y-4">
              <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                <h3 className="font-bold text-red-900 mb-2">❌ Mass submitting to playlists you've never heard</h3>
                <p className="text-gray-700">Curators can tell. 3% response rate. Spend 2 minutes listening to the playlist first.</p>
              </div>

              <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                <h3 className="font-bold text-red-900 mb-2">❌ Subject line: "Playlist Submission"</h3>
                <p className="text-gray-700">They get 50+ of these daily. Use: "Perfect for [Playlist Name]: [Artist] - [Track]"</p>
              </div>

              <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                <h3 className="font-bold text-red-900 mb-2">❌ Wrong genre targeting</h3>
                <p className="text-gray-700">Your indie rock track doesn't fit on a lo-fi playlist. Perfect genre fit = 5x better response rate.</p>
              </div>

              <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                <h3 className="font-bold text-red-900 mb-2">❌ "My song has 1.2M streams please add"</h3>
                <p className="text-gray-700">If you have 1M+ streams, you don't need small playlists. Focus on fit, not flex.</p>
              </div>

              <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                <h3 className="font-bold text-red-900 mb-2">❌ Pitching too early</h3>
                <p className="text-gray-700">Pitch 2-4 weeks before release with pre-save link. Curators need time to listen and schedule adds.</p>
              </div>
            </div>
          </section>
