...
export const metadata: Metadata = {
  ...
  description:
    'Industry guides on pitch writing, radio promotion templates, and music PR strategies. Written by working radio promoters with 5+ years BBC Radio 1 experience.',
  keywords:
    'pitch writing blog, music PR guides, radio pitch templates, playlist pitch tips, BBC Radio 1 pitches',
  alternates: {
...
const blogPosts = [
  {
    ...
    excerpt:
      'Write BBC Radio 1 pitches that actually get responses. Get industry benchmarks (11-18% specialist shows), proven templates, and AI-powered insights from real Radio 1 campaigns.',
  ...
  },
  {
    ...
    excerpt:
      'Stop guessing what works for Spotify playlists. See proven templates (18-28% response rate by genre), curator benchmarks, and exactly what makes playlists respond.',
    author: 'Chris Schofield',
    date: '2025-10-06',
    readTime: '8 min read',
  ...
  },
  {
    ...
    excerpt:
      'Write blog pitches that get coverage. Learn what response rates to expect (8-16% by blog tier), proven templates, and which approaches actually work for music blogs.',
    author: 'Chris Schofield',
    date: '2025-10-06',
    readTime: '9 min read',
  ...
  },
  {
    ...
    excerpt:
      'Know what to expect from radio pitches. Get benchmarks for BBC (11-18%), commercial (6-12%), community (18-24%), and exactly what drives response rates.',
    author: 'Chris Schofield',
    date: '2025-10-06',
    readTime: '9 min read',
    category: 'Radio Pitching',
  ...
  },
  {
    ...
    excerpt:
      'Write pitches for BBC 6 Music that get results. See real benchmarks (8-14% specialist shows), optimal timing, and proven templates for alternative/indie music.',
    author: 'Chris Schofield',
    date: '2025-10-06',
    readTime: '9 min read',
    category: 'Radio Pitching',
  ...
  },
  {
    ...
    excerpt:
      'Pitch Apple Music playlists effectively. Get editorial benchmarks (6-12% success), algorithmic insights (40-60% reach), and templates that work.',
    author: 'Chris Schofield',
    date: '2025-10-06',
    readTime: '8 min read',
    category: 'Playlist Pitching',
  ...
  },
  {
    ...
    excerpt:
      'Pitch BBC Introducing effectively. See real success rates (8-12% regional), optimal timing, and proven templates for unsigned artist radio promotion.',
    author: 'Chris Schofield',
    date: '2025-10-06',
    readTime: '8 min read',
    category: 'Radio Pitching',
  ...
  },
  {
    ...
    excerpt:
      'Write community radio pitches that get airplay. See real success rates (18-24% local radio), proven templates, and optimal timing for local promotion.',
    author: 'Chris Schofield',
    date: '2025-10-06',
    readTime: '7 min read',
    category: 'Radio Pitching',
  ...
  },
  {
    ...
    excerpt:
      'Pitch commercial radio effectively. Get industry benchmarks (6-12% by station type), proven templates, and strategies for commercial radio success.',
    author: 'Chris Schofield',
    date: '2025-10-06',
    readTime: '9 min read',
    category: 'Radio Pitching',
  ...
  },
  {
    ...
    excerpt:
      'Write PR pitches that get responses. Learn expected response rates, proven templates, and which approaches work for music PR campaigns.',
    author: 'Chris Schofield',
    date: '2025-10-06',
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Industry guides on pitch writing, benchmarks, and PR strategies. Written by working
            radio promoters with real BBC Radio 1 experience.
          </p>
        </div>
