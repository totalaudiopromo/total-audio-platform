    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
      <header className="glass-panel px-6 py-10 sm:px-10">
        ...
        <h1 className="mt-6 text-3xl font-semibold">
          Stop spending hours on pitches. Start at £0.
        </h1>
        <p className="mt-4 max-w-2xl text-sm text-gray-600">
          Choose a plan based on your campaign volume. All plans include AI-powered pitch
          generation, Audio Intel integration, and proven templates from real music PR campaigns.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-2 max-w-5xl mx-auto">
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              ChatGPT doesn't know your contacts or industry benchmarks. Pitch Generator pulls from
              your contact database (via Audio Intel) and uses proven templates with real success
              rates from BBC Radio 1, Spotify, and blog campaigns. It's like ChatGPT but trained on
              5 years of actual pitch data.
            </p>
          </div>

          <div className="space-y-3">
            <h3 className="text-lg font-bold text-gray-900">
              How is this different from hiring a radio plugger?
            </h3>
            <p className="text-sm text-gray-600">
              Radio pluggers charge £400-£1,500 per campaign and still write pitches manually. Pitch
              Generator gives you the same personalised pitch quality for £14/month. You still need
              to send them yourself, but you save 15 hours and hundreds of pounds per campaign.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              ...
              fees. Your subscription ends at the end of your billing period and you keep access
              until then.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="text-lg font-bold text-gray-900">
              What if the pitches don't sound good?
            </h3>
            <p className="text-sm text-gray-600">
              Try the free tier first (5 pitches/month). Generate a few pitches and see the quality
              before paying. Every pitch includes 3 subject line variations and you can regenerate
              unlimited times until it sounds right. If you're not happy after trying PRO, we'll
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              No. You can add contacts directly in Pitch Generator. Audio Intel just makes it faster
              by auto-enriching contact details (outlet type, preferred tone, last contact date).
              But you can absolutely use Pitch Generator standalone.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              BBC Radio 1 specialist shows: 14-18% (vs 2% for generic pitches). Spotify playlists:
              18-28% with good genre fit. Music blogs: 12-18% with story angle. These are real
              benchmarks from 500+ pitches over 5 years. Your results depend on your music quality
              and targeting.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              Yes - the free tier gives you 5 pitches per month forever. No credit card required.
              Test the quality, try different contacts, and upgrade to PRO when you need more
              volume.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              Yes. If you're not happy with PRO or Agency within your first month, email us and
              we'll refund you. No hassle, no questions. We'd rather you try it risk-free than not
              try it at all.
            </p>
          </div>
        </div>
