...
export const metadata: Metadata = {
  ...
  description:
    'Terms of Service for Pitch Generator by Total Audio Promo. UK-compliant service agreement.',
      ...
      <div className="glass-panel px-8 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              By accessing or using Pitch Generator ("the Service"), you agree to be bound by these
              Terms of Service ("Terms"). If you disagree with any part of these terms, you may not
              use the Service.
            </p>
            <p className="text-gray-600 leading-relaxed mt-4">
              <strong>Service Provider:</strong> Total Audio Promo
              <br />
              <strong>Service:</strong> pitch.totalaudiopromo.com
              <br />
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Pitch Generator is an AI-powered tool that helps music industry professionals create
              personalised music PR pitches for radio stations, blogs, playlists, and media outlets.
            </p>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              You must be at least 16 years old to use the Service. By registering, you represent
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mt-4">
              <li>
                <strong>Spam:</strong> Generate pitches for unsolicited mass email campaigns
              </li>
              <li>
                <strong>Scrape:</strong> Use automated tools to extract data from the Service
              </li>
              <li>
                <strong>Resell:</strong> Sell or redistribute generated pitches as a commercial
                service
              </li>
              <li>
                <strong>Abuse:</strong> Attempt to overload, hack, or compromise the Service
              </li>
              <li>
                <strong>Violate Laws:</strong> Use the Service for illegal purposes or to violate
                GDPR/UK laws
              </li>
              <li>
                <strong>Impersonate:</strong> Pretend to be another person or entity
              </li>
              <li>
                <strong>Defame:</strong> Generate content that is defamatory, offensive, or
                harassing
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              <li>
                <strong>Free:</strong> 5 pitches per month (no credit card required)
              </li>
              <li>
                <strong>PRO:</strong> £12/month or £120/year (unlimited pitches)
              </li>
              <li>
                <strong>Agency:</strong> £79/month or £790/year (unlimited + team features)
              </li>
              <li>
                <strong>Bundle:</strong> £19/month or £190/year (Intel + Pitch Generator + Tracker)
              </li>
            </ul>
            ...
            <p className="text-gray-600 leading-relaxed">
              We offer a 30-day money-back guarantee for first-time PRO and Agency subscribers. To
              request a refund, email{' '}
              <a
                href="mailto:billing@totalaudiopromo.com"
                className="text-amber-600 hover:underline"
              >
                billing@totalaudiopromo.com
              </a>{' '}
            ...
            <p className="text-gray-600 leading-relaxed">
              You may cancel your subscription anytime from your account settings. Your access
              continues until the end of your billing period. No partial refunds for unused time.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              You retain all rights to the content you input (track details, contact info, etc.) and
              the pitches you generate. We do not claim ownership of your pitches or data.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">6.2 Our Service</h3>
            <p className="text-gray-600 leading-relaxed">
              The Service itself (code, design, AI models, algorithms) is owned by Total Audio
              Promo. You may not copy, modify, or reverse-engineer the Service.
            </p>
            ...
            <p className="text-gray-600 leading-relaxed">
              By using the Service, you grant us a limited license to process your content solely
              for the purpose of providing the Service. We do not use your pitches or data to train
              AI models or share with third parties.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              You are responsible for reviewing and editing all generated content before sending.
              You must ensure pitches comply with:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mt-4">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mt-4">
              <strong>Nothing in these Terms excludes liability for:</strong> Death or personal
              injury caused by negligence, fraud, or misrepresentation, or any other liability that
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              You may delete your account anytime from account settings. All your data will be
              permanently deleted within 30 days.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">11.2 By Us</h3>
            <p className="text-gray-600 leading-relaxed">We may terminate your account if you:</p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mt-4">
            ...
            <p className="text-gray-600 leading-relaxed mt-4">
              We will provide 14 days' notice unless immediate termination is required for legal or
              security reasons.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              email 30 days before they take effect. Continued use of the Service after changes
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mt-4">
              ...
              <a href="mailto:legal@totalaudiopromo.com" className="text-amber-600 hover:underline">
                legal@totalaudiopromo.com
              </a>{' '}
        ...
        <div className="mt-12 rounded-xl border-2 border-amber-500 bg-amber-50 p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            By signing up, you agree to these Terms of Service and our Privacy Policy. Try 5 free
            pitches, no credit card required.
          </p>
