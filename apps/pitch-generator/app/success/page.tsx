  ...
  return (
    <div className="mx-auto w-full max-w-3xl">
      <div className="glass-panel px-6 py-12 sm:px-10">
        <span className="inline-flex items-center rounded-full bg-green-100 px-3 py-1 text-xs font-medium text-green-800">Checkout complete</span>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/profile" className="cta-button">Head to your dashboard</Link>
