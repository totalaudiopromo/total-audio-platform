...
export const metadata: Metadata = {
  ...
  description: 'Privacy policy for Pitch Generator by Total Audio Promo. GDPR-compliant data handling for UK users.',
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Welcome to Pitch Generator ("we", "our", or "us"). We are committed to protecting your personal data and respecting your privacy.
              This Privacy Policy explains how we collect, use, share, and protect your information when you use pitch.totalaudiopromo.com (the "Service").
            </p>
            <p className="text-gray-600 leading-relaxed mt-4">
              <strong>Data Controller:</strong> Total Audio Promo<br />
              <strong>Contact:</strong> info@totalaudiopromo.com<br />
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">2.2 Content You Create</h3>
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">2.4 Payment Information</h3>
            <p className="text-gray-600 leading-relaxed">
              We use Stripe for payment processing. We <strong>do not store</strong> your credit card details.
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mt-4">
              <li><strong>Provide the Service:</strong> Generate AI-powered music pitches based on your inputs</li>
              <li><strong>Account Management:</strong> Create and maintain your user account</li>
              <li><strong>Communication:</strong> Send service updates, support responses, and marketing emails (with consent)</li>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">Under GDPR, we process your data based on:</p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mt-4">
              <li><strong>Contract Performance:</strong> To provide the Service you signed up for</li>
              <li><strong>Legitimate Interests:</strong> To improve the Service and ensure security</li>
              <li><strong>Consent:</strong> For marketing communications (you can opt out anytime)</li>
              <li><strong>Legal Obligation:</strong> To comply with UK/EU laws</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              ...
              <li><strong>Anthropic (Claude AI):</strong> AI-powered pitch generation (your data is not used for training)</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              ...
              <li><strong>Legal Requirements:</strong> Some data may be retained longer to comply with UK tax/legal obligations</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">As a UK/EU data subject, you have the right to:</p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mt-4">
              <li><strong>Access:</strong> Request a copy of your data (export feature in dashboard)</li>
              <li><strong>Rectification:</strong> Correct inaccurate data (edit in dashboard)</li>
              <li><strong>Erasure ("Right to be Forgotten"):</strong> Delete your account and all data</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2 mt-4">
              <li><strong>Essential Cookies:</strong> Authentication session (NextAuth)</li>
              <li><strong>Analytics:</strong> Plausible (no personal data, no tracking across sites)</li>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              If you believe a child has provided data to us, contact us immediately.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Your data is primarily stored in the EU (Supabase). When we use US-based services (Anthropic, Vercel),
