 ...
 * Component: SharedSiteHeader
 * Source: apps/pitch-generator/components/SharedSiteHeader.tsx
 * Issues found: SMALL_SPACING, SMALL_SPACING
 */

const { test, expect } = require('@playwright/test');
const { validateAllTouchTargets, validateTouchTargetSize } = require('@total-audio/testing');

test.describe('SharedSiteHeader - Touch Targets', () => {
