    ...
    const dailyWorkflowPage = await notion.pages.create({
      ...
      children: [
        ...
        },
        {
          ...
          paragraph: {
            rich_text: [
              { text: { content: 'Add these pages to your Notion favorites for instant access:' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '🎯 TOTAL AUDIO MASTER STRUCTURE - Your main navigation hub' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '🚀 MASTER TO-DO LIST - SEPTEMBER 2025 - Daily priorities' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '🎯 Audio Intel Master Reference - Product development' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '💰 REVENUE & BUSINESS OPERATIONS - Business strategy' } },
            ],
          },
        },
        {
        ...
        },
        {
          ...
          paragraph: {
            rich_text: [
              {
                text: {
                  content: 'For mobile productivity, bookmark these pages in your phone browser:',
                },
              },
            ],
          },
        ...
        },
        {
          ...
          paragraph: {
            rich_text: [
              { text: { content: 'Use these templates for quick idea capture on the go:' } },
            ],
          },
        },
        {
        ...
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '💻 Development Session Template - Claude Code work' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '🤝 Partnership Outreach Template - Follow-up tracking' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '📝 Content Planning Template - 94% automation messaging' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '💬 Customer Feedback Template - Product impact assessment' } },
            ],
          },
        },
        {
        ...
        },
        {
          ...
          paragraph: {
            rich_text: [
              { text: { content: 'Simple rules to prevent re-scatter (5 minutes weekly):' } },
            ],
          },
        },
        {
        ...
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '✅ Always update the master, never create new versions' } },
            ],
          },
        },
        {
        ...
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: "🌅 Morning: Check Master To-Do List for today's 3 priorities" } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              {
                text: {
                  content: '💻 Development: Use Development Session Template for Claude Code work',
                },
              },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              {
                text: {
                  content: '📝 Content: Use Content Planning Template for social media/outreach',
                },
              },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              {
                text: {
                  content: '🤝 Partnerships: Use Partnership Outreach Template for follow-ups',
                },
              },
            ],
          },
        ...
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              {
                text: {
                  content: '📊 Use consolidated business strategy to focus on £500/month target',
                },
              },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              {
                text: {
                  content: '🎵 Leverage organized Audio Intel content for customer acquisition',
                },
              },
            ],
          },
        ...
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '🔧 Set up automation between Notion and development workflow' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '📋 Create templates for recurring business activities' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              {
                text: {
                  content: '📊 Consider database views vs static pages for different sections',
                },
              },
            ],
          },
        ...
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '☐ Consolidated master pages have all needed content' } },
            ],
          },
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '☐ Navigation flow from main workspace to key sections works' } },
            ],
          },
        },
        {
        ...
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '☐ Quick-capture templates ready for ideas on the go' } },
            ],
          },
        },
      ],
    ...
    const maintenancePage = await notion.pages.create({
      ...
      children: [
        ...
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [
              { text: { content: '☐ Review favorites - remove unused, add new essentials' } },
            ],
          },
        },
        {
