...
class BusinessHoursScheduler {
  ...
  async activateSystem() {
    ...
    await this.sendNotification('system_activated', 'Content monitoring activated for business hours');
  ...
  setupBusinessHoursSchedules() {
    ...
    const startSchedule = cron.schedule(`0 ${this.businessStart} * * 1-5`, async () => {
    ...
    const endSchedule = cron.schedule(`0 ${this.businessEnd} * * 1-5`, async () => {
    ...
    const weekendStartSchedule = cron.schedule(`0 ${this.businessEnd} * * 5`, async () => {
    ...
    const weekendEndSchedule = cron.schedule(`0 ${this.businessStart} * * 1`, async () => {
  ...
  setupEconomySchedules() {
    ...
    const resourceCheckSchedule = cron.schedule('0 * * * *', async () => {
    ...
    const budgetCheckSchedule = cron.schedule(`5 ${this.businessStart} * * 1-5`, async () => {
    ...
    const weeklyPlanningSchedule = cron.schedule(`0 8 * * 1`, async () => {
  ...
  startBusinessHoursMonitoring() {
    ...
    const rssSchedule = cron.schedule('*/30 * * * *', async () => {
    ...
    const opportunitySchedule = cron.schedule('15 * * * *', async () => {
      if (this.isSystemActive && this.isBusinessHours()) {
  ...
  async setupReducedWeekendMonitoring() {
    ...
    const weekendRSSSchedule = cron.schedule('0 */2 * * 0,6', async () => {
