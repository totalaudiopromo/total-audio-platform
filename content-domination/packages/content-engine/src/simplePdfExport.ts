...
export function downloadSimplePDF(contacts: SimpleContact[], filename: string = 'audio-intel-contacts.pdf') {
  try {
...
export function downloadCSV(contacts: SimpleContact[], filename: string = 'audio-intel-contacts.csv') {
  try {
    const headers = ['Email', 'Name', 'Company', 'Role', 'Location', 'Enrichment Score', 'Confidence', 'Valid Email'];
