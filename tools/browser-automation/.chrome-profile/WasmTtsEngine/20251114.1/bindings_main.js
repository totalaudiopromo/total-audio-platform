  ...
  return async function (moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      if (numericVersion < 160400) {
        throw new Error(
          'This emscripten-generated code requires node v16.04.4.0 (detected v' + nodeVersion + ')'
        );
      }
      var fs = require('fs');
    ...
    function assignWasmExports(wasmExports) {
      ...
      Module['_GoogleTtsInit'] = _GoogleTtsInit = createExportWrapper('GoogleTtsInit', 2);
      Module['_GoogleTtsShutdown'] = _GoogleTtsShutdown = createExportWrapper(
        'GoogleTtsShutdown',
        0
      );
      Module['_GoogleTtsInstallVoice'] = _GoogleTtsInstallVoice = createExportWrapper(
        'GoogleTtsInstallVoice',
        3
      );
      Module['_GoogleTtsInitBuffered'] = _GoogleTtsInitBuffered = createExportWrapper(
        'GoogleTtsInitBuffered',
        4
      );
      Module['_GoogleTtsReadBuffered'] = _GoogleTtsReadBuffered = createExportWrapper(
        'GoogleTtsReadBuffered',
        0
      );
      Module['_GoogleTtsFinalizeBuffered'] = _GoogleTtsFinalizeBuffered = createExportWrapper(
        'GoogleTtsFinalizeBuffered',
        0
      );
      Module['_GoogleTtsGetTimepointsCount'] = _GoogleTtsGetTimepointsCount = createExportWrapper(
        'GoogleTtsGetTimepointsCount',
        0
      );
      Module['_GoogleTtsGetTimepointsTimeInSecsAtIndex'] =
        _GoogleTtsGetTimepointsTimeInSecsAtIndex = createExportWrapper(
          'GoogleTtsGetTimepointsTimeInSecsAtIndex',
          1
        );
      Module['_GoogleTtsGetTimepointsCharIndexAtIndex'] = _GoogleTtsGetTimepointsCharIndexAtIndex =
        createExportWrapper('GoogleTtsGetTimepointsCharIndexAtIndex', 1);
      Module['_GoogleTtsGetTimepointsCharLengthAtIndex'] =
        _GoogleTtsGetTimepointsCharLengthAtIndex = createExportWrapper(
          'GoogleTtsGetTimepointsCharLengthAtIndex',
          1
        );
      Module['_GoogleTtsGetEventBufferPtr'] = _GoogleTtsGetEventBufferPtr = createExportWrapper(
        'GoogleTtsGetEventBufferPtr',
        0
      );
      Module['_GoogleTtsGetEventBufferLen'] = _GoogleTtsGetEventBufferLen = createExportWrapper(
      ...
      dynCall_vijii = createExportWrapper('dynCall_vijii', 6);
      ...
      dynCall_viiiji = createExportWrapper('dynCall_viiiji', 7);
      dynCall_viiji = createExportWrapper('dynCall_viiji', 6);
    ...
    var _kVersionStampBuildChangelistStr = (Module['_kVersionStampBuildChangelistStr'] = 1504080);
    var _kVersionStampCitcSnapshotStr = (Module['_kVersionStampCitcSnapshotStr'] = 1504112);
    var _kVersionStampCitcWorkspaceIdStr = (Module['_kVersionStampCitcWorkspaceIdStr'] = 1504144);
    var _kVersionStampSourceUriStr = (Module['_kVersionStampSourceUriStr'] = 1504656);
    var _kVersionStampBuildClientStr = (Module['_kVersionStampBuildClientStr'] = 1505168);
    var _kVersionStampBuildClientMintStatusStr = (Module['_kVersionStampBuildClientMintStatusStr'] =
      1505680);
    var _kVersionStampBuildCompilerStr = (Module['_kVersionStampBuildCompilerStr'] = 1505712);
    var _kVersionStampBuildDateTimePstStr = (Module['_kVersionStampBuildDateTimePstStr'] = 1506224);
    var _kVersionStampBuildDepotPathStr = (Module['_kVersionStampBuildDepotPathStr'] = 1506256);
    var _kVersionStampBuildIdStr = (Module['_kVersionStampBuildIdStr'] = 1506768);
    var _kVersionStampBuildInfoStr = (Module['_kVersionStampBuildInfoStr'] = 1507280);
    var _kVersionStampBuildLabelStr = (Module['_kVersionStampBuildLabelStr'] = 1507792);
    var _kVersionStampBuildTargetStr = (Module['_kVersionStampBuildTargetStr'] = 1508304);
    var _kVersionStampBuildTimestampStr = (Module['_kVersionStampBuildTimestampStr'] = 1508816);
    var _kVersionStampBuildToolStr = (Module['_kVersionStampBuildToolStr'] = 1508848);
    var _kVersionStampG3BuildTargetStr = (Module['_kVersionStampG3BuildTargetStr'] = 1509360);
    var _kVersionStampVerifiableStr = (Module['_kVersionStampVerifiableStr'] = 1509872);
    var _kVersionStampBuildFdoTypeStr = (Module['_kVersionStampBuildFdoTypeStr'] = 1509904);
    var _kVersionStampBuildBaselineChangelistStr = (Module[
      '_kVersionStampBuildBaselineChangelistStr'
    ] = 1509936);
    var _kVersionStampBuildLtoTypeStr = (Module['_kVersionStampBuildLtoTypeStr'] = 1509968);
    var _kVersionStampBuildPropellerTypeStr = (Module['_kVersionStampBuildPropellerTypeStr'] =
      151e4);
    var _kVersionStampBuildPghoTypeStr = (Module['_kVersionStampBuildPghoTypeStr'] = 1510032);
    var _kVersionStampBuildUsernameStr = (Module['_kVersionStampBuildUsernameStr'] = 1510064);
    var _kVersionStampBuildHostnameStr = (Module['_kVersionStampBuildHostnameStr'] = 1510576);
    var _kVersionStampBuildDirectoryStr = (Module['_kVersionStampBuildDirectoryStr'] = 1511088);
    var _kVersionStampBuildChangelistInt = (Module['_kVersionStampBuildChangelistInt'] = 1511600);
    var _kVersionStampCitcSnapshotInt = (Module['_kVersionStampCitcSnapshotInt'] = 1511608);
    var _kVersionStampBuildClientMintStatusInt = (Module['_kVersionStampBuildClientMintStatusInt'] =
      1511612);
    var _kVersionStampBuildTimestampInt = (Module['_kVersionStampBuildTimestampInt'] = 1511616);
    var _kVersionStampVerifiableInt = (Module['_kVersionStampVerifiableInt'] = 1511624);
