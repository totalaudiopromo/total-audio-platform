var loadWasmTtsBindings = (() => {
  ...
  return async function (moduleArg = {}) {
      ...
      if (value < minRange || value > maxRange) {
        throw new TypeError(
          `Passing a number "${embindRepr(
            value
          )}" from JS side to C/C++ side to an argument of type "${typeName}", which is outside the valid range [${minRange}, ${maxRange}]!`
        );
      }
    };
    ...
    var _kVersionStampBuildChangelistStr = (Module['_kVersionStampBuildChangelistStr'] = 1495200);
    var _kVersionStampCitcSnapshotStr = (Module['_kVersionStampCitcSnapshotStr'] = 1495232);
    ...
    var _kVersionStampBuildIdStr = (Module['_kVersionStampBuildIdStr'] = 1497888);
    var _kVersionStampBuildInfoStr = (Module['_kVersionStampBuildInfoStr'] = 1498400);
    var _kVersionStampBuildLabelStr = (Module['_kVersionStampBuildLabelStr'] = 1498912);
    var _kVersionStampBuildTargetStr = (Module['_kVersionStampBuildTargetStr'] = 1499424);
    var _kVersionStampBuildTimestampStr = (Module['_kVersionStampBuildTimestampStr'] = 1499936);
    var _kVersionStampBuildToolStr = (Module['_kVersionStampBuildToolStr'] = 1499968);
    var _kVersionStampG3BuildTargetStr = (Module['_kVersionStampG3BuildTargetStr'] = 1500480);
    var _kVersionStampVerifiableStr = (Module['_kVersionStampVerifiableStr'] = 1500992);
    var _kVersionStampBuildFdoTypeStr = (Module['_kVersionStampBuildFdoTypeStr'] = 1501024);
