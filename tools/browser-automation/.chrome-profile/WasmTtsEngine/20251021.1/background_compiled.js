...
function J(a) {
  this.next = function (b) {
    B(a.g);
    a.g.i ? (b = H(a, a.g.i.next, b, a.g.o)) : (a.g.o(b), (b = I(a)));
    return b;
  };
  this.throw = function (b) {
    B(a.g);
    a.g.i ? (b = H(a, a.g.i['throw'], b, a.g.o)) : (C(a.g, b), (b = I(a)));
    return b;
  };
...
z('Promise', function (a) {
  ...
  b.prototype.B = function (e) {
    ...
    typeof c == 'function' ? this.K(c, e) : this.m(e);
  };
...
function R(a, b, f) {
  ...
  else return { lang: '', C: !1 };
  return { lang: a, L: f, G: g, C: !0 };
}
function S(a) {
  L(function (b) {
    return b.return(T(a));
...
function ba(a) {
  return L(function (b) {
    return b.g == 1 ? D(b, a.g.offscreen.hasDocument(), 2) : b.return(b.h);
  });
}
function W(a) {
  var b, f;
...
function T(a) {
  ...
  return L(function (k) {
    ...
    f[a] = Date.now();
    g = {};
    return D(k, b.g.storage.local.set(((g.lastUsedTimestamps = f), g)), 0);
  });
}
function ca(a) {
  ...
  return L(function (l) {
    switch (l.g) {
      case 1:
        return D(l, Y(a), 2);
      case 2:
        return (b = l.h) ? D(l, X(a), 3) : l.return();
      case 3:
        f = l.h;
        g = ha(b, f);
  ...
  L(function (v) {
    switch (v.g) {
      ...
      case 2:
        ...
        r = h;
        p = { type: r, lang: l };
        return D(v, a.g.runtime.sendMessage(p), 5);
      case 5:
        t = v.h;
...
function ka(a, b) {
  ...
  return L(function (m) {
    ...
    k = {};
    return D(m, a.g.storage.local.set(((k.installedTimestamps = g), k)), 0);
  });
}
function Y(a) {
  var b;
  return L(function (f) {
    if (f.g == 1) return D(f, a.g.storage.local.get('installedTimestamps'), 2);
    b = f.h;
...
function X(a) {
  var b;
  return L(function (f) {
    if (f.g == 1) return D(f, a.g.storage.local.get('lastUsedTimestamps'), 2);
    b = f.h;
...
var V = new (function () {
    ...
    return L(function (d) {
      switch (d.g) {
        ...
        case 2:
          ...
          d.l = 3;
          return D(d, b.g.runtime.sendMessage(m), 5);
        case 5:
          d.g = 0;
          d.l = 0;
          break;
  ...
  this.A = function () {
    var f;
    return L(function (g) {
      if (g.g == 1) return D(g, U(b), 2);
      if (!g.h) return g.return();
      b.j = void 0;
      f = { type: 'stop' };
      return D(g, b.g.runtime.sendMessage(f), 0);
    });
  };
  this.o = function () {
    var f;
  ...
  this.B = function (f, g) {
    return L(function (k) {
      if (k.g == 1) return D(k, U(b), 2);
      if (!k.h || f.source !== b.i) return k.return();
      var m = b.h;
  ...
  this.g.ttsEngine.onSpeak.addListener(this.D);
