/******/ (() => {
  ...
  var browser_polyfill = __webpack_require__(2558); // CONCATENATED MODULE: ./src/info-injector/shared/info-injector.types.ts
  const getInfoCommand = 'getInjectionInfo'; // CONCATENATED MODULE: ./src/info-injector/content/info-injector.types.ts

  const nodeId = '__adblock-extension-info';
  const datasetKey = 'adblockExtensionInfo'; // CONCATENATED MODULE: ./src/info-injector/content/info-injector.ts
  ...
  start(); // CONCATENATED MODULE: ./src/info-injector/content/index.ts
