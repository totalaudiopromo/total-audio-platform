    ...
    <div id='hiding-wizard'>
      <div class='page' id='page_0'>
        <header class="center-and-right">
          ...
          <i class="material-icons md-18 close" role="img" aria-label="${translate(
            'close'
          )}">close</i>
        </header>
        <section>
      ...
      <div class='page' id='page_1' style='display:none;'>
        <header class="left-center-right">
          <i class="material-icons md-18 back" role="img" aria-label="${translate(
            'back'
          )}">chevron_left</i>
          <h1>${translate('blockanadtitle')}</h1>
          <i class="material-icons md-18 close" role="img" aria-label="${translate(
        ...
        <section>
          ...
          <div class="buttonRow" ><button class='primary looks-good adblock-default-button'>${translate(
            'buttonlooksgood'
          )}</button></div>
        </section>
      </div>
      <div class='page' id='page_2' style='display:none;'>
        ...
        <section>
          ...
          <p class="advanced-user-row" >
            ...
            <span id="editBtnSpan">
              <i id="editBtn" class="material-icons md-18" role="img" aria-label="${translate(
                'buttonedit'
              )}">mode_edit</i>
            </span>
          </p>
          <p class="filter-warning-row" >
            <span id="warningIconSpan"><i id="warningIcon" class="material-icons md-18 warning-icon" role="img" aria-label="${translate(
              'warning'
            )}">warning</i></span><span id='filter-warning-text' ></span>
          </p>
          <p class="advanced-user-row advanced-user-row-disarm boldText detail-header" id="add_info">${translate(
            'add_info'
          )}</p>
          <p class="advanced-user-row advanced-user-row-disarm detail-header" >${translate(
            'confirm_msg'
          )}</p>
