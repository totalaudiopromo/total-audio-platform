...
const premiumFiltersUIitems = [
  {
    ...
    disclaimer: `${translate('please_note')} ${translate('distraction_control_new')} ${translate(
      'your_participation'
    )} ${translate('dc_more_information')}`,
    urlToOpen:
  ...
  },
  {
    ...
    disclaimer: `${translate('cookie_consent_cutter_desclaimer_I')} ${translate(
