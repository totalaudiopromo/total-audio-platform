/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 1121: /***/ function (module) {
      ...
      (function (global, factory) {
        ...
        const { entries, setPrototypeOf, isFrozen, getPrototypeOf, getOwnPropertyDescriptor } =
          Object;
    ...
    /***/ 2558: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      'use strict';
  ...
  (() => {
    ...
    connect();
    /* harmony default export */ const js_api_api =
      /* unused pure expression or super */ null && api_api; // CONCATENATED MODULE: ./adblockplusui/js/api/index.ts

    /* harmony default export */ const js_api = /* unused pure expression or super */ null && api; // CONCATENATED MODULE: ./adblock-betafish/onpage-dialog/content/dialog.ts
    ...
    function loadResources(base) {
      ...
      document.fonts.add(
        new FontFace('Material Icons', `url("${MaterialIcons_Regular_woff2_namespaceObject}")`, {
          style: 'normal',
          weight: 'normal',
        })
      );
    ...
    const showDialog = async function (message) {
      ...
      const dialogElement = purify.sanitize(onpage_dialog_content_dialog_namespaceObject, {
