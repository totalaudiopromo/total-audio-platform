/******/ (() => {
  ...
  var browser_polyfill = __webpack_require__(2558); // CONCATENATED MODULE: ../../fragment/yt-wall-detection/dist/shared/messages.types.js
  ...
  const ytHavenIframeShown = 'yt-haven.iframe-shown'; // CONCATENATED MODULE: ../../fragment/yt-wall-detection/dist/shared/index.js
...
</svg>`; // CONCATENATED MODULE: ../../fragment/yt-wall-detection/dist/img/ab-logo.js
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M16.0441 28.4618C21.4899 28.4618 22.782 23.4473 22.782 23.4473L25.9076 14.4321C25.9076 14.4321 26.1898 13.4962 26.138 13.4858C23.2274 12.9399 22.6085 14.9988 22.6085 14.9988C22.6085 14.9988 21.4899 17.9154 21.3164 17.9154C21.1429 17.9154 21.1222 17.6997 21.1222 17.6997V7.22094C21.1222 7.22094 21.1765 5.86918 19.7937 5.86918C18.411 5.86918 18.4809 7.22354 18.4809 7.22354L18.4835 14.965C18.4835 14.965 18.5016 15.2769 18.2426 15.2769C18.0122 15.2769 18.0251 14.9754 18.0251 14.9754V5.64822C18.0251 5.64822 18.1106 4.12489 16.7122 4.12489C15.3139 4.12489 15.389 5.65862 15.389 5.65862L15.3761 14.861C15.3761 14.861 15.3942 15.1443 15.1637 15.1443C14.9488 15.1443 14.9566 14.8636 14.9566 14.8636V7.14816C14.9566 7.14816 15.0342 5.57804 13.61 5.57804C12.2117 5.57804 12.2868 7.17675 12.2868 7.17675L12.2738 15.3237C12.2738 15.3237 12.2997 15.5603 12.0796 15.5603C11.8466 15.5603 11.8517 15.3237 11.8517 15.3237L11.8414 10.3976C11.8414 10.3976 11.8543 9.03542 10.6787 9.03542C9.42797 9.03542 9.45128 10.3976 9.45128 10.3976V21.0297C9.45905 21.0271 9.13536 28.4618 16.0441 28.4618Z" fill="white"/>
</svg>`; // CONCATENATED MODULE: ../../fragment/yt-wall-detection/dist/content/shared.js
  ...
  function createIframePlayer(playerConfig) {
    ...
    iframe.onload = function () {
      setTimeout(() => {
        var _a;
        (_a = iframe === null || iframe === void 0 ? void 0 : iframe.contentWindow) === null ||
        _a === void 0
          ? void 0
          : _a.postMessage('{"event":"listening"}', '*');
      });
    };
    return iframe;
  }
  ...
  async function adWallSelectorFound(hasDismiss) {
    ...
    const currentPlaybackTime =
      (_a = videoPlayer === null || videoPlayer === void 0 ? void 0 : videoPlayer.currentTime) !==
        null && _a !== void 0
        ? _a
        : 0;
    ...
    for (const mutation of mutations) {
      for (const node of mutation.addedNodes) {
        ...
        const elements = [
          node,
          ...Array.from(
            node.querySelectorAll([adWallSelector, toastSelector, playerErrorSelector].join(','))
          ),
        ];
        for (const elem of elements) {
          ...
          } else if (elem.tagName === 'DIV' && elem.matches(playerErrorSelector)) {
...
</svg>`; // CONCATENATED MODULE: ../../fragment/yt-wall-detection/dist/img/check.js
...
</svg>`; // CONCATENATED MODULE: ../../fragment/yt-wall-detection/dist/img/cross.js
  ...
  <path d="M18 6L6 18M6 6l12 12"
        ...
        stroke-width="2"
        stroke-linecap="round"/>
</svg>`; // CONCATENATED MODULE: ../../fragment/yt-wall-detection/dist/content/embed-haven.js
  ...
  async function handleEmbeddedVideoEnding() {
    ...
    const nextVideoAnchor = document.querySelector(
      '#movie_player > div.ytp-chrome-bottom > div.ytp-chrome-controls > div.ytp-left-controls > a.ytp-next-button.ytp-button'
    );
    if (nextVideoAnchor && nextVideoAnchor instanceof HTMLAnchorElement && nextVideoAnchor.href) {
  ...
  const iFrameMessageListener = event => {
    ...
    if (
      ...
      const playerState =
        (_a = eventData === null || eventData === void 0 ? void 0 : eventData.info) === null ||
        _a === void 0
          ? void 0
          : _a.playerState;
  ...
  async function addEmbedVideoOnTop(targetElement) {
    ...
    if (playerElem && playerElem instanceof HTMLIFrameElement) {
      (_a = playerElem.contentWindow) === null || _a === void 0
        ? void 0
        : _a.postMessage(
            JSON.stringify({
              event: 'command',
  ...
  function createToggleSwitch(initialState = false, onToggle = async () => {}) {
    ...
    toggle.addEventListener('click', () => {
      ...
      if (newState !== isActive) {
        isActive = newState;
        toggle.style.backgroundColor = isActive ? colors.ENABLED : colors.DISABLED;
  ...
  const removeEmbedPlayer = () => {
    var _a;
    const playerElem = getIframePlayer();
    (_a = playerElem === null || playerElem === void 0 ? void 0 : playerElem.parentNode) === null ||
    _a === void 0
      ? void 0
      : _a.removeChild(playerElem);
  };
  const removeInfoBox = () => {
    var _a;
    const infoBoxElem = document.getElementById(infoBoxId);
    (_a = infoBoxElem === null || infoBoxElem === void 0 ? void 0 : infoBoxElem.parentNode) ===
      null || _a === void 0
      ? void 0
      : _a.removeChild(infoBoxElem);
  ...
  const addExperiments = async () => {
    ...
    await Promise.all([embed_haven_start(targetElement)]);
  };
  ...
  const navigationListener = async (event, toggleState = false) => {
    ...
    const endpoint =
      (_a = event === null || event === void 0 ? void 0 : event.detail) === null || _a === void 0
        ? void 0
        : _a.endpoint;
    const playerResponse =
      (_c =
        (_b = event === null || event === void 0 ? void 0 : event.detail) === null || _b === void 0
          ? void 0
    ...
    const pageData =
      (_e =
        (_d = event === null || event === void 0 ? void 0 : event.detail) === null || _d === void 0
          ? void 0
          : _d.response) === null || _e === void 0
        ? void 0
        : _e.response;
    const videoId =
      (_f = endpoint === null || endpoint === void 0 ? void 0 : endpoint.watchEndpoint) === null ||
      _f === void 0
        ? void 0
        : _f.videoId;
    ...
    const playlistId =
      (_g = endpoint === null || endpoint === void 0 ? void 0 : endpoint.watchEndpoint) === null ||
      _g === void 0
        ? void 0
        : _g.playlistId;
    const isEmbeddable =
      (_h =
        playerResponse === null || playerResponse === void 0
          ? void 0
          : playerResponse.playabilityStatus) === null || _h === void 0
        ? void 0
        : _h.playableInEmbed;
    const playabilityStatus =
      (_j =
        playerResponse === null || playerResponse === void 0
          ? void 0
          : playerResponse.playabilityStatus) === null || _j === void 0
        ? void 0
        : _j.status;
        ...
        (_q =
          (_p =
            (_o =
              (_m =
                (_l =
                  (_k = pageData === null || pageData === void 0 ? void 0 : pageData.contents) ===
                    null || _k === void 0
                    ? void 0
                    : _k.twoColumnWatchNextResults) === null || _l === void 0
                  ? void 0
                  : _l.autoplay) === null || _m === void 0
                ? void 0
                : _m.autoplay) === null || _o === void 0
              ? void 0
              : _o.sets[0]) === null || _p === void 0
            ? void 0
            : _p.autoplayVideo) === null || _q === void 0
          ? void 0
          : _q.watchEndpoint) === null || _r === void 0
        ? void 0
        : _r.videoId;
    const autoplayEnabled =
      (_w =
        (_v =
          (_u =
            (_t =
              (_s = pageData === null || pageData === void 0 ? void 0 : pageData.playerOverlays) ===
                null || _s === void 0
                ? void 0
                : _s.playerOverlayRenderer) === null || _t === void 0
              ? void 0
              : _t.autonavToggle) === null || _u === void 0
            ? void 0
            : _u.autoplaySwitchButtonRenderer) === null || _v === void 0
          ? void 0
          : _v.enabled) !== null && _w !== void 0
        ? _w
        : true;
    const startSeconds =
      (_x = endpoint === null || endpoint === void 0 ? void 0 : endpoint.watchEndpoint) === null ||
      _x === void 0
        ? void 0
        : _x.startTimeSeconds;
    ...
    if (
      ...
      const errorCode =
        (_b =
          ...
          _a === void 0
            ? void 0
            : _a.videoData) === null || _b === void 0
          ? void 0
          : _b.errorCode;
      if (
        (eventData === null || eventData === void 0 ? void 0 : eventData.event) ===
          'initialDelivery' &&
        errorCode
      ) {
        void browser_polyfill.runtime.sendMessage({
  ...
  main_start(); // CONCATENATED MODULE: ../../fragment/yt-wall-detection/dist/content/index.js
