        ...
        !(function (t, n) {
          ...
          ((E.fn = E.prototype =
            ...
            E.extend({
              ...
              makeArray: function (e, t) {
                ...
                return (
                  null != e &&
                    (k(Object(e)) ? E.merge(n, 'string' == typeof e ? [e] : e) : l.call(n, e)),
                  n
                );
              },
          ...
          !(function () {
            ...
            function Z(e, t, n, r) {
              ...
              if (!r && (ue(t), (t = t || u), f)) {
                ...
                if (!(C[e + ' '] || (p && p.test(e)))) {
                  if (((d = e), (h = t), 1 === m && (F.test(e) || _.test(e)))) {
                    for (
              ...
              function (e, t) {
                E.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 && (U[e] || E.uniqueSort(i), z.test(e) && i.reverse()),
                    this.pushStack(i)
                  );
                };
              }
                              ...
                              : function () {
                                  try {
                                    ...
                                    (E.Deferred.exceptionHook &&
                                      ...
                                      e + 1 >= o &&
                                        (n !== Q && ((s = void 0), (u = [r])), t.rejectWith(s, u)));
                                  }
                                };
                          e
                            ? c()
          ...
          var me = function (e, t) {
            return (
              ...
              ('' === e.style.display && ve(e) && 'none' === E.css(e, 'display'))
            );
          };
          function xe(e, t, n, r) {
            var i,
            ...
            special: {
              ...
              click: {
                ...
                _default: function (e) {
                  var t = e.target;
                  return (
                    (Ee.test(t.type) && t.click && j(t, 'input') && se.get(t, 'click')) || j(t, 'a')
                  );
                },
              },
              beforeunload: {
          ...
          function Xe(e, t, n, r) {
            ...
            if (
              ...
              for (s = (a = E.map(De(i, 'script'), $e)).length; f < p; f++)
                ((l = i),
                  f !== d && ((l = E.clone(l, !0, !0)), s && E.merge(a, De(l, 'script'))),
                  n.call(e[f], l, f));
              if (s)
          ...
          function bt(e, t, n) {
            ...
            for (
              ...
              if ((r = bt.prefilters[o].call(l, e, c, l.opts)))
                return (
                  y(r.stop) && (E._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)),
                  r
                );
            return (
              E.map(c, xt, l),
            ...
            trigger: function (e, t, n, i) {
              ...
              if (
                ...
                3 !== n.nodeType &&
                  ...
                  (l = g.indexOf(':') < 0 && 'on' + g),
                  ((e = e[E.expando] ? e : new E.Event(g, 'object' == typeof e && e)).isTrigger = i
                    ? 2
                    : 3),
                  (e.namespace = v.join('.')),
          ...
          function Wt(e, t, n, r) {
            ...
            if (Array.isArray(t))
              E.each(t, function (t, i) {
                n || Ot.test(e)
                  ? r(e, i)
                  : Wt(e + '[' + ('object' == typeof i && null != i ? t : '') + ']', i, n, r);
              });
  ...
  ((n.n = e => {
    ...
    (() => {
      ...
      var e = n(886),
        t = n.n(e);
      function r(e) {
        t()('#cloudHQ_synch_status').load(
          'https://www.cloudhq.net/main_gmail_bulk_forward/chrome_extension_status_popup',
          { email_or_login: e || '', switch_login: '1' },
          function () {
            1 * t()('#cloudHQ_synch_status #emails_pending_count').val() > 0 &&
      ...
      t()(document).ready(function () {
        chrome.tabs.query({ active: !0, currentWindow: !0 }, function (e) {
          var t = e[0];
          t && t.url && t.url.startsWith('https://mail.google.com/') && 'complete' == t.status
            ? chrome.tabs.sendMessage(t.id, { action: 'getUserEmailAddress' }, function (e) {
                r(e);
              })
            : r();
        });
