    ...
    class kt {
      ...
      _getLogFn(t, e, r = !1) {
        ...
        return function (...t) {
          ...
          n[0] = `%c[HubSpot Sales] ${kt.LEVELS_MAP[e].padEnd(6)} - %c${new Date()
            .toISOString()
            .slice(11, -1)}%c:`;
...
//# sourceMappingURL=//static.hsappstatic.net/SignalsExtension/static-2.32769/js/sig-ext.js.map
