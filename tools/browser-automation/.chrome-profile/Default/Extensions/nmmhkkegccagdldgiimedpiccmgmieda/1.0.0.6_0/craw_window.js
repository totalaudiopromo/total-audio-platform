...
k.IS_SYMBOL_NATIVE = 'function' === typeof Symbol && 'symbol' === typeof Symbol('x');
...
k.polyfillUnisolated = function (a, c) {
  ...
  e = d[a];
  c = c(e);
  c != e && null != c && k.defineProperty(d, a, { configurable: !0, writable: !0, value: c });
};
...
k.getConstructImplementation = function () {
  ...
  if (k.TRUST_ES6_POLYFILLS && 'undefined' != typeof Reflect && Reflect.construct) {
  ...
  function (a) {
    return a
      ...
      : function (c, d) {
          ...
          for (var f = c.length; 0 < f && 0 < d; ) if (e[--d] != c[--f]) return !1;
          return 0 >= f;
        };
  },
  'es6'
...
m.exportPath_ = function (a, c, d, e) {
  ...
  for (var f; a.length && (f = a.shift()); )
    if (a.length || void 0 === c) e = e[f] && e[f] !== Object.prototype[f] ? e[f] : (e[f] = {});
...
m.provide = function (a) {
  if (m.isInModuleLoader_()) throw Error('goog.provide cannot be used within a module.');
...
m.isInEs6ModuleLoader_ = function () {
  if (m.moduleLoaderState_ && m.moduleLoaderState_.type == m.ModuleType.ES6) return !0;
...
m.getObjectByName = function (a) {
  a = a.split('.');
  for (var c = m.global, d = 0; d < a.length; d++) if (((c = c[a[d]]), null == c)) return null;
  return c;
};
...
m.loadModule = function (a) {
  ...
  try {
    ...
    else if ('string' === typeof a) e = m.loadModuleFromSource_.call(void 0, e, a);
...
m.scope = function (a) {
  if (m.isInModuleLoader_()) throw Error('goog.scope is not supported within a module.');
  a.call(m.global);
};
...
m.asserts.subs_ = function (a, c) {
  a = a.split('%s');
  for (var d = '', e = a.length - 1, f = 0; f < e; f++) d += a[f] + (f < c.length ? c[f] : '%s');
  return d + a[e];
};
...
m.array.equals = function (a, c) {
  ...
  for (var d = a.length, e = wa, f = 0; f < d; f++) if (!e(a[f], c[f])) return !1;
  return !0;
};
...
m.string.internal.caseInsensitiveEndsWith = function (a, c) {
  return 0 == m.string.internal.caseInsensitiveCompare(c, a.substr(a.length - c.length, c.length));
};
...
m.string.internal.htmlEscape = function (a, c) {
  if (c)
    ...
    -1 != a.indexOf('"') && (a = a.replace(m.string.internal.QUOT_RE_, '&quot;'));
    -1 != a.indexOf("'") && (a = a.replace(m.string.internal.SINGLE_QUOTE_RE_, '&#39;'));
    -1 != a.indexOf('\x00') && (a = a.replace(m.string.internal.NULL_RE_, '&#0;'));
  }
  return a;
};
  ...
  for (var e = Math.max(a.length, c.length), f = 0; 0 == d && f < e; f++) {
    ...
    do {
      ...
      d =
        ...
        m.string.internal.compareElements_(0 == g[2].length, 0 == h[2].length) ||
...
m.object.create = function (a) {
  ...
  if (1 == c && Array.isArray(arguments[0])) return m.object.create.apply(null, arguments[0]);
...
m.object.createSet = function (a) {
  var c = arguments.length;
  if (1 == c && Array.isArray(arguments[0])) return m.object.createSet.apply(null, arguments[0]);
...
m.object.getAllPropertyNames = function (a, c, d) {
  if (!a) return [];
  if (!Object.getOwnPropertyNames || !Object.getPrototypeOf) return m.object.getKeys(a);
  for (var e = {}; a && (a !== Object.prototype || c) && (a !== Function.prototype || d); ) {
    for (var f = Object.getOwnPropertyNames(a), g = 0; g < f.length; g++) e[f[g]] = !0;
...
m.labs.userAgent.browser.getVersion = function () {
  ...
  if (m.labs.userAgent.browser.isIE()) return m.labs.userAgent.browser.getIEVersion_(c);
...
m.labs.userAgent.browser.isVersionOrHigher = function (a) {
  return 0 <= m.string.internal.compareVersions(m.labs.userAgent.browser.getVersion(), a);
};
...
m.fs.blob.getBlobWithProperties = function (a, c) {
  ...
  if (void 0 !== m.global.Blob) return ((d = {}), c && (d.type = c), new Blob(a, d));
...
m.i18n.bidi.IS_RTL =
  ...
  (('ar' == m.LOCALE.substring(0, 2).toLowerCase() ||
    ...
    (2 == m.LOCALE.length || '-' == m.LOCALE.substring(2, 3) || '_' == m.LOCALE.substring(2, 3))) ||
  (3 <= m.LOCALE.length &&
    'ckb' == m.LOCALE.substring(0, 3).toLowerCase() &&
    (3 == m.LOCALE.length || '-' == m.LOCALE.substring(3, 4) || '_' == m.LOCALE.substring(3, 4))) ||
  (7 <= m.LOCALE.length &&
...
m.html.SafeUrl.sanitizeAssertUnchanged = function (a, c) {
  ...
  a =
    'object' == typeof a && a.implementsGoogStringTypedString ? a.getTypedStringValue() : String(a);
  if (c && /^data:/i.test(a) && ((c = m.html.SafeUrl.fromDataUrl(a)), c.getTypedStringValue() == a))
    return c;
...
m.html.SafeHtml.verifyTagName = function (a) {
  if (!m.html.SafeHtml.VALID_NAMES_IN_TAG_.test(a))
    throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Invalid tag name <' + a + '>.' : '');
...
m.html.SafeHtml.createSandboxIframe = function (a, c, d, e) {
  if (!m.html.SafeHtml.canUseSandboxIframe())
    throw Error(
      m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'The browser does not support sandboxed iframes.' : ''
    );
  var f = {};
...
m.html.SafeHtml.getAttrNameAndValue_ = function (a, c, d) {
  if (d instanceof m.string.Const) d = m.string.Const.unwrap(d);
    ...
    if (m.html.SafeHtml.SUPPORT_STYLE_ATTRIBUTE) d = m.html.SafeHtml.getStyleValue_(d);
    else
      throw Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Attribute "style" not supported.' : '');
  else {
    if (/^on/i.test(c))
      throw Error(
        m.html.SafeHtml.ENABLE_ERROR_MESSAGES
    ...
    if (c.toLowerCase() in m.html.SafeHtml.URL_ATTRIBUTES_)
      if (d instanceof m.html.TrustedResourceUrl) d = m.html.TrustedResourceUrl.unwrap(d);
      else if (d instanceof m.html.SafeUrl) d = m.html.SafeUrl.unwrap(d);
      else if ('string' === typeof d) d = m.html.SafeUrl.sanitize(d).getTypedStringValue();
      else
        throw Error(
          m.html.SafeHtml.ENABLE_ERROR_MESSAGES
            ? 'Attribute "' +
...
m.dom.safe.unsafeSetInnerHtmlDoNotUseOrElse = function (a, c) {
  if (m.dom.safe.isInnerHtmlCleanupRecursive_()) for (; a.lastChild; ) a.removeChild(a.lastChild);
...
m.string.numberAwareCompare_ = function (a, c, d) {
  ...
  for (
    ...
    if (d != l)
      return (
        (a = parseInt(d, 10)),
        !isNaN(a) && ((c = parseInt(l, 10)), !isNaN(c) && a - c) ? a - c : d < l ? -1 : 1
      );
  }
...
m.string.unescapeEntitiesUsingDom_ = function (a, c) {
  ...
  return a.replace(m.string.HTML_ENTITY_PATTERN_, function (f, g) {
    ...
    if (h) return h;
    '#' == g.charAt(0) &&
      ((g = Number('0' + g.substr(1))), isNaN(g) || (h = String.fromCharCode(g)));
    h ||
      (m.dom.safe.setInnerHtml(
        e,
        m.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(
...
m.string.escapeString = function (a) {
  for (var c = [], d = 0; d < a.length; d++) c[d] = m.string.escapeChar(a.charAt(d));
  return c.join('');
};
...
m.labs.userAgent.engine.getVersion = function () {
  ...
  if (a) {
    ...
    if (c) return 'Gecko' == c[0] ? m.labs.userAgent.engine.getVersionForKey_(a) : c[1];
    a = a[0];
    var d;
...
m.labs.userAgent.platform.isVersionOrHigher = function (a) {
  return 0 <= m.string.compareVersions(m.labs.userAgent.platform.getVersion(), a);
};
m.reflect = {};
...
m.userAgent.determineVersion_ = function () {
  ...
  c && (a = c ? c[1] : '');
  return m.userAgent.IE && ((c = m.userAgent.getDocumentMode_()), null != c && c > parseFloat(a))
    ? String(c)
    : a;
};
  ...
  var d = [],
    ...
    g = function (h, l) {
      ...
      try {
        ...
        else if ('string' === typeof h) d.push('"' + h.replace(/\n/g, '\n' + l) + '"');
        else if ('function' === typeof h) d.push(String(h).replace(/\n/g, '\n' + l));
  ...
  if (!(!d && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
    ...
    if (null == d) {
      if (a.constructor && a.constructor instanceof Function) {
        var g = a.constructor.name ? a.constructor.name : m.debug.getFunctionName(a.constructor);
...
m.debug.entryPointRegistry.monitorAll = function (a) {
  ...
  for (var c = m.bind(a.wrap, a), d = 0; d < m.debug.entryPointRegistry.refList_.length; d++)
...
m.events.ListenerMap.prototype.remove = function (a, c, d, e) {
  ...
  return -1 < c
    ? (Ha(f[c]), A(f, c), 0 == f.length && (delete this.listeners[a], this.typeCount_--), !0)
    : !1;
};
var Ia = function (a, c) {
  var d = c.type;
...
m.events.ListenerMap.findListenerIndex_ = function (a, c, d, e) {
  for (var f = 0; f < a.length; ++f) {
    var g = a[f];
    if (!g.removed && g.listener == c && g.capture == !!d && g.handler == e) return f;
  }
  return -1;
};
...
m.events.listen_ = function (a, c, d, e, f, g) {
  ...
  if (a.addEventListener)
    ...
    (m.asserts.assert('change' === c, 'MediaQueryList only has a change event'), a.addListener(e));
...
m.events.unlistenByKey = function (a) {
  ...
  (d = m.events.getListenerMap_(c))
    ? (Ia(d, a), 0 == d.typeCount_ && ((d.src = null), (c[m.events.LISTENER_MAP_PROP_] = null)))
    : Ha(a);
  return !0;
};
...
m.events.EventHandler.prototype.listen_ = function (a, c, d, e, f) {
  ...
  for (var g = 0; g < c.length; g++) {
    var h = m.events.listen(a, c[g], d || this.handleEvent, e || !1, f || this.handler_ || this);
    if (!h) break;
    this.keys_[h.key] = h;
  }
  return this;
...
var Ja = function (a, c, d, e, f, g) {
  if (Array.isArray(d)) for (var h = 0; h < d.length; h++) Ja(a, c, d[h], e, f, g);
  else {
...
b.unlisten = function (a, c, d, e, f) {
  if (Array.isArray(c)) for (var g = 0; g < c.length; g++) this.unlisten(a, c[g], d, e, f);
  else if (
...
m.math.longestCommonSubsequence = function (a, c, d, e) {
  ...
  for (var f = a.length, g = c.length, h = [], l = 0; l < f + 1; l++) ((h[l] = []), (h[l][0] = 0));
...
b.addAll = function (a) {
  if (a instanceof m.structs.Map)
    for (var c = a.getKeys(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
...
b.__iterator__ = function (a) {
  ...
  f.next = function () {
    if (d != e.version_) throw Error('The map has changed since the iterator was created');
...
b.forEach = function (a, c) {
  for (var d = this.head_.next; d != this.head_; d = d.next) a.call(c, d.value, d.key, this);
};
b.map = function (a, c) {
...
m.structs.filter = function (a, c, d) {
  ...
  } else for (h = [], l = 0; l < g; l++) c.call(d, f[l], void 0, a) && h.push(f[l]);
  return h;
};
...
m.uri.utils.split = function (a) {
  ...
  m.uri.utils.urlPackageSupportLoggingHandler_ &&
    0 <= ['http', 'https', 'ws', 'wss', 'ftp'].indexOf(c[m.uri.utils.ComponentIndex.SCHEME]) &&
    m.uri.utils.urlPackageSupportLoggingHandler_(a);
  return c;
};
...
m.uri.utils.appendKeyValuePairs_ = function (a, c, d) {
  ...
  if (Array.isArray(c)) {
    ...
    for (var e = 0; e < c.length; e++) m.uri.utils.appendKeyValuePairs_(a, String(c[e]), d);
...
m.uri.utils.buildQueryData = function (a, c) {
  ...
  var d = [];
  for (c = c || 0; c < a.length; c += 2) m.uri.utils.appendKeyValuePairs_(a[c], a[c + 1], d);
  return d.join('&');
};
...
m.uri.utils.hasParam = function (a, c) {
  return 0 <= m.uri.utils.findParam_(a, 0, c, a.search(m.uri.utils.hashOrEndRe_));
};
...
b.getValues = function (a) {
  Q(this);
  var c = [];
  if ('string' === typeof a) this.containsKey(a) && (c = B(c, this.keyMap_.get(R(this, a))));
  else {
...
m.dom.getElementsByTagNameAndClass_ = function (a, c, d, e) {
  ...
  if (m.dom.canUseQuerySelector_(a) && (c || d)) return a.querySelectorAll(c + (d ? '.' + d : ''));
  ...
  if (d) {
    e = {};
    for (g = f = 0; (h = a[g]); g++)
      ((c = h.className), 'function' == typeof c.split && y(c.split(/\s+/), d) && (e[f++] = h));
    e.length = f;
    return e;
  }
  return a;
...
m.dom.setProperties = function (a, c) {
  m.object.forEach(c, function (d, e) {
    d && 'object' == typeof d && d.implementsGoogStringTypedString && (d = d.getTypedStringValue());
    'style' == e
      ? (a.style.cssText = d)
      : 'class' == e
        ? (a.className = d)
...
m.dom.childrenToNode_ = function (a, c) {
  if (1 == c.childNodes.length) return c.removeChild(m.asserts.assert(c.firstChild));
...
m.dom.isCss1CompatMode_ = function (a) {
  return m.dom.COMPAT_MODE_KNOWN_ ? m.dom.ASSUME_STANDARDS_MODE : 'CSS1Compat' == a.compatMode;
};
...
m.dom.appendChild = function (a, c) {
  m.asserts.assert(null != a && null != c, 'goog.dom.appendChild expects non-null arguments');
  a.appendChild(c);
};
...
m.dom.insertChildAt = function (a, c, d) {
  m.asserts.assert(null != a, 'goog.dom.insertChildAt expects a non-null parent');
...
m.dom.replaceNode = function (a, c) {
  m.asserts.assert(null != a && null != c, 'goog.dom.replaceNode expects non-null arguments');
  var d = c.parentNode;
  d && d.replaceChild(a, c);
};
m.dom.copyContents = function (a, c) {
  m.asserts.assert(null != a && null != c, 'goog.dom.copyContents expects non-null arguments');
...
m.dom.getNextElementNode_ = function (a, c) {
  for (; a && a.nodeType != m.dom.NodeType.ELEMENT; ) a = c ? a.nextSibling : a.previousSibling;
  return a;
};
...
m.dom.contains = function (a, c) {
  if (!a || !c) return !1;
  if (a.contains && c.nodeType == m.dom.NodeType.ELEMENT) return a == c || a.contains(c);
...
m.dom.setTextContent = function (a, c) {
  m.asserts.assert(null != a, 'goog.dom.setTextContent expects a non-null value for node');
  if ('textContent' in a) a.textContent = c;
    ...
    for (; a.lastChild != a.firstChild; ) a.removeChild(m.asserts.assert(a.lastChild));
...
m.dom.getOuterHtml = function (a) {
  m.asserts.assert(null !== a, 'goog.dom.getOuterHtml expects a non-null value for element');
...
m.dom.hasNonZeroBoundingRect_ = function (a) {
  a =
    'function' !== typeof a.getBoundingClientRect || (m.userAgent.IE && null == a.parentElement)
...
m.dom.getTextContent_ = function (a, c, d) {
  if (!(a.nodeName in m.dom.TAGS_TO_IGNORE_))
    ...
    else for (a = a.firstChild; a; ) (m.dom.getTextContent_(a, c, d), (a = a.nextSibling));
};
...
m.dom.getNodeTextOffset = function (a, c) {
  ...
  for (var d = []; a && a != c; ) {
    for (var e = a; (e = e.previousSibling); ) d.unshift(m.dom.getTextContent(e));
    a = a.parentNode;
  }
...
m.dom.getNodeAtOffset = function (a, c, d) {
  ...
  for (var e = 0, f = null; 0 < a.length && e < c; )
    if (((f = a.pop()), !(f.nodeName in m.dom.TAGS_TO_IGNORE_)))
      ...
      else for (g = f.childNodes.length - 1; 0 <= g; g--) a.push(f.childNodes[g]);
  m.isObject(d) && ((d.remainder = f ? f.nodeValue.length + c - e - 1 : 0), (d.node = f));
  return f;
};
m.dom.isNodeList = function (a) {
  if (a && 'number' == typeof a.length) {
    if (m.isObject(a)) return 'function' == typeof a.item || 'string' == typeof a.item;
...
m.dom.getAncestorByTagNameAndClass = function (a, c, d, e) {
  ...
  return m.dom.getAncestor(
    ...
    function (g) {
      return (
        (!f || g.nodeName == f) &&
        (!d || ('string' === typeof g.className && y(g.className.split(/\s+/), d)))
      );
    },
    !0,
    e
...
T.prototype.pollOnlineStatus = function () {
  if (!window.iapParams_.oauthToken) return chrome.i18n.getMessage('please_sign_in');
  if (this.retrieveJwtFailed_) return chrome.i18n.getMessage('jwt_retrieve_failed');
};
...
window.addEventListener(
  ...
  function (a) {
    console.log('event', a);
    if ('type' in a.data) ((window.purchase_result = a.data.result), window.close());
...
m.async.nextTick = function (a, c, d) {
  ...
  'function' === typeof m.global.setImmediate && (d || m.async.nextTick.useSetImmediate_())
...
m.log.Level.getPredefinedLevelByValue = function (a) {
  m.log.Level.predefinedLevelsCache_ || m.log.Level.createPredefinedLevelsCache_();
  if (a in m.log.Level.predefinedLevelsCache_) return m.log.Level.predefinedLevelsCache_[a];
...
m.log.removeHandler = function (a, c) {
  return m.log.ENABLED &&
    a &&
    ((a = V(m.log.LogRegistry.getInstance(), a.getName())), (c = a.handlers.indexOf(c)), -1 !== c)
...
var mb = function (a) {
  if (m.net.XmlHttp.ASSUME_NATIVE_XHR || m.net.XmlHttpDefines.ASSUME_NATIVE_XHR) return '';
...
m.Promise = function (a, c) {
  ...
  0 < m.Promise.UNHANDLED_REJECTION_DELAY
    ...
    : 0 == m.Promise.UNHANDLED_REJECTION_DELAY && (this.hadUnhandledRejection_ = !1);
...
m.Promise.race = function (a) {
  return new m.Promise(function (c, d) {
    a.length || c(void 0);
    for (var e = 0, f; e < a.length; e++) ((f = a[e]), m.Promise.resolveThen_(f, c, d));
  });
};
...
m.Promise.prototype.then = function (a, c, d) {
  null != a && m.asserts.assertFunction(a, 'opt_onFulfilled should be a function.');
  null != c &&
  ...
  return ob(this, 'function' === typeof a ? a : null, 'function' === typeof c ? c : null, d);
};
...
m.Promise.maybeThen_ = function (a, c, d, e) {
  if (a instanceof m.Promise)
    return (
      null != c && m.asserts.assertFunction(c, 'opt_onFulfilled should be a function.'),
      null != d &&
        m.asserts.assertFunction(
          d,
          'opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?'
...
m.net.XhrIo.prototype.getResponseHeader = function (a) {
  if (this.xhr_ && Db(this)) return ((a = this.xhr_.getResponseHeader(a)), null === a ? void 0 : a);
};
...
b.showOfflineWarning = function () {
  m.dom.getElement('app_unavailable').innerText = this.delegate_.getAppUnavailableMessage();
...
b.pollOnlineStatus_ = function () {
  if ((this.customStatus_ = this.delegate_.pollOnlineStatus())) this.setOnlineStatus_(!1);
  else {
