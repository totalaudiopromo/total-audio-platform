  ...
  var d = function (g, h) {
      ...
      if (m && t(g.da, l))
        for (g = 0; g < m.length; g++) {
          var F = m[g];
          if ((h !== h && F.key !== F.key) || h === F.key)
            return { id: l, list: m, index: g, entry: F };
        }
...
var u = this || self,
  ...
  sa = function (a, b) {
    ...
    a.prototype.constructor = a;
    a.Sb = function (d, e, f) {
      for (var k = Array(arguments.length - 2), g = 2; g < arguments.length; g++)
        k[g - 2] = arguments[g];
...
var x = function (a, b, c) {
  ...
  y = function (a, b, c) {
    'number' !== typeof a &&
      va('Expected number but got %s: %s.', [v(a), a], b, Array.prototype.slice.call(arguments, 2));
    return a;
  },
  ya = function (a, b, c) {
    'function' !== typeof a &&
  ...
  J = function (a, b, c, d) {
    ...
    if (e) {
      ...
      if (0 < f.ka) {
        ...
        f.Ka = k;
        f.Oa
          ? ((f = f.Ha[k]), f.reset(b, c, a), (a = f))
          : ((f.Oa = k == f.ka - 1), (a = f.Ha[k] = new Oa(b, c, a)));
      } else a = new Oa(b, c, a);
      a.la = d;
      e.publish(a);
    }
...
var eb,
  ...
  ib = function (a, b) {
    eb || hb();
    fb || (eb(), (fb = !0));
    'createTask' in console &&
      !a.consoleTask &&
      (a.consoleTask = console.createTask(a.name || 'anonymous'));
    gb.add(a, b);
  },
  hb = function () {
...
var sb = function (a, b) {
    if (0 == a.A)
      if (a.V) {
        ...
        if (c.I) {
          for (
            var d = 0, e = null, f = null, k = c.I;
            k && (k.ja || (d++, k.O == a && (e = k), !(e && 1 < d)));
            k = k.next
          )
            e || (f = k);
          e &&
...
var Eb = function (a) {
    return a.B
      ...
      : ob(
          new A('DownloadItem.getProgress()', 'UNEXPECTED_ERROR', 'No pending download in progress')
        );
  },
  Fb = function (a) {
    return a.B
          ...
          return 1 != b.length
            ? ob(
                new A(
                  ...
                  'UNEXPECTED_ERROR',
                  'Multiple items returned for download id: ' + a
                )
              )
            : b[0];
        });
    ...
    ? P(this.B).then(function (b) {
        if ('complete' != b.state)
          throw new A(
            ...
            'UNEXPECTED_ERROR',
            'Cannot open ' + b.filename + ' before the download is completed.'
          );
        if (!b.exists)
          throw new A('chrome.downloads.show', 'DOWNLOAD_ITEM_DELETED', 'filename: ' + b.filename);
      ...
      switch (a.state.current) {
        ...
        default:
          Gb && J(Gb, E, 'Unexpected downloadItem state: ' + a.state.current),
            this.K.reject(
              new A('chrome.downloads.download', 'UNEXPECTED_ERROR', 'state: ' + a.state.current)
            );
      }
    else
      a.paused &&
        a.paused.current &&
        this.K.reject(new A('chrome.downloads.download', 'USER_CANCELED', this.Fa));
};
...
var Hb = function (a) {
  ...
  Jb = function (a, b, c) {
    if (a.forEach && 'function' == typeof a.forEach) a.forEach(b, c);
      ...
      for (var d = Ib(a), e = Hb(a), f = e.length, k = 0; k < f; k++) b.call(c, e[k], d && d[k], a);
  };
var Kb = RegExp(
    '^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$'
  ),
...
Q.prototype.toString = function () {
  ...
  if ((c = this.H))
    this.D && '/' != c.charAt(0) && a.push('/'), a.push(Rb(c, '/' == c.charAt(0) ? Tb : Ub, !0));
...
var Qb = function (a, b) {
  ...
  Rb = function (a, b, c) {
    return 'string' === typeof a
      ? ((a = encodeURI(a).replace(b, Xb)), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, '%$1')), a)
      : null;
  },
  Xb = function (a) {
    a = a.charCodeAt(0);
...
S.prototype.remove = function (a) {
  ...
  a = U(this, a);
  return this.h.has(a)
    ? ((this.o = null), (this.l = y(this.l) - this.h.get(a).length), this.h.delete(a))
    : !1;
};
...
V.prototype.sb = function (a, b, c) {
  try {
    var d = Aa(a).type;
    if ('hello' == d)
      return c({ type: 'hello', version: chrome.runtime.getManifest().version }), !1;
    var e = this.Aa.get(d);
    return e
      ? e.onMessage(a, b, c)
      : ((a = W) && J(a, Ja, 'No handler is registered for type: ' + d), !1);
  } catch (f) {
...
var Zb = function (a, b) {
    var c = b.Sa;
    a.Ca.has(c)
      ? W && J(W, E, 'A service with name: ' + c + ' is already registered.')
      : (a.Ca.set(c, b), Ha(a, ra(Ga, b)));
  },
  ac = function (a) {
    ...
    if (null == b) c.push('null');
      ...
      if ('object' == typeof b) {
        if (Array.isArray(b)) {
          ...
          c.push('[');
          for (var e = '', f = 0; f < b; f++)
            c.push(e), (e = d[f]), cc(a, a.ua ? a.ua.call(d, String(f), e) : e, c), (e = ',');
          c.push(']');
          return;
        }
  ...
  X = {
    s: function (a, b, c) {
      return isNaN(c) || '' == c || a.length >= Number(c)
        ...
        : (a =
            -1 < b.indexOf('-', 0)
              ? a + K(' ', Number(c) - a.length)
              : K(' ', Number(c) - a.length) + a);
    },
  ...
  for (b = 0; b < a.length; b++) {
    ...
    d instanceof Xa &&
      (d instanceof Xa && d.constructor === Xa
        ? (d = d.bb)
        : (xa("expected object of type SafeHtml, got '" + d + "' of type " + v(d)),
          (d = 'type_error:SafeHtml')),
      (d = d.toString()));
    c += d;
  }
  return c;
...
lc.prototype.sa = function (a) {
  ...
  try {
    switch (b.type) {
      ...
      default:
        c(
          new A('DownloadSession.onMessage', 'INVALID_ARGS', 'Unknown message type: ' + b.type).j()
        );
    }
  } catch (f) {
...
var sc = function (a, b) {
    return a.L
      ? !0
      : (b(new A('checkInitialized', 'INVALID_ARGS', 'this.downloadItem_ == null').j()), !1);
  },
  ...
  try {
    switch (a.type) {
      ...
      default:
        return wc(
          c,
          new A('TabsMessageHandler.onMessage', 'INVALID_ARGS', 'Unknown message type: ' + a.type)
        );
    }
  } catch (d) {
    return wc(
      c,
      new A('TabsMessageHandler.onMessage', 'UNEXPECTED_ERROR', 'Unexpected error: ' + d.message)
    );
  }
};
var vc = function (a, b) {
