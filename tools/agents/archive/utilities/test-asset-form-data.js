...
async function testAssetFormData() {
  ...
  try {
    ...
    campaigns.forEach((campaign, index) => {
      ...
      console.log(`   Press Bio: ${data.pressBio ? data.pressBio.substring(0, 100) + '...' : '❌ Not found'}`);
      console.log(`   Track Description: ${data.trackDescription ? data.trackDescription.substring(0, 100) + '...' : '❌ Not found'}`);
