...
async function extractSeniorDunceData() {
  ...
  try {
    ...
    const seniorDunceResponses = [
      {
        formId: 'pwWZ30RH',
        token: '1ji7bnq1gdkqec8yw1ji7b1ykvckg4q1',
        formTitle: 'Asset Form NEW',
      },
      {
        formId: 'n7oJpRGA',
        token: 'n24ddnp25a21708lfxzgn24diido2d1y',
        formTitle: 'Playlisting questionairre',
      },
      {
        formId: 'C7z5cD',
        token: 'wm1e19y2ve9wvc9kwm1e1u5o0snlspe1',
        formTitle: 'Personality Questions for Press',
      },
    ];
        ...
        if (response && response.answers) {
          ...
          response.answers.forEach(answer => {
            if (answer.field && answer.field.title) {
              ...
              if (
                fieldTitle.toLowerCase().includes('artist') ||
