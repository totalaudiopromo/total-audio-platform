...
async function testEnhancedMonday() {
  ...
  try {
    ...
    console.log(
      '   • mondayApi.createLibertyCampaign(campaignData, warmAPI) - Create campaign with Drive integration'
    );
    console.log(
      '   • mondayApi.createCampaignDriveFolder(campaignData) - Create Google Drive folders'
    );
    console.log(
      '   • mondayApi.updateCampaignWithWarmData(campaignId, warmData) - Update with play data'
    );
