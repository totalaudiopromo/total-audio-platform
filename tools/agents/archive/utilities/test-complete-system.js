...
async function testCompleteSystem() {
  ...
  try {
    ...
    const followupSequence = await followupAgent.startFollowupSequence(campaignData, contacts, {
      strategy: 'moderate',
    });
    ...
    const integrationScore =
      Object.values(completeWorkflow).filter(Boolean).length / Object.keys(completeWorkflow).length;
