# Chris Schofield - Verified Background for AI Content Generation
...
- Built Audio Intel (contact enrichment SaaS for independent artists)
...
- Proper British capitalisation (not forced lowercase)
- Natural conversational style (like messaging a friend in a band)
...
- Personal anecdotes beyond verified background
- Commercial music references
...
## Example Opening Styles (Based on Real Voice):

- "Right, so [news event] happened this week, and here's why that's actually good news for independent artists..."
- "This week [industry development] went down, and whilst everyone's panicking, here's the unsigned advantage..."
...
- Radio promotion realities
- Underground electronic music scene
- DIY music production and distribution
- Time-saving automation for artists
