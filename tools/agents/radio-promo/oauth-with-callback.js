...
/**
 * OAuth Setup with Local Callback Server
 * 
 * This creates a local server to handle the OAuth callback
 */
...
async function setupOAuthWithCallback() {
  console.log('🔑 OAuth Setup with Local Callback Server...\n');
  ...
  try {
    ...
    console.log('📧 OAuth Setup with Callback Server');
    console.log('===================================');
    console.log('');
    console.log('1. Make sure you\'ve added this redirect URI to your OAuth client:');
    ...
    console.log('');
    console.log('4. The callback server will automatically handle the response');
    console.log('');
