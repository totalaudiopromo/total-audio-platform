...
class SocialIntelligence {
  ...
  initializeMonitoringTargets() {
    ...
    // Playlist curators
    this.monitoringTargets.set('curators', ['SpotifyUK', 'AppleMusicUK', 'DeezerUK', 'TidalUK']);
  ...
  getOpportunityAnalytics() {
    ...
    const averageConfidence =
      opportunities.reduce((sum, opp) => sum + opp.analysis.confidence, 0) / totalOpportunities;
