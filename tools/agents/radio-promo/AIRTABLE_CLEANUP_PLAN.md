...
**Relationship & Status**:
8. Status (synced from Mailchimp)
9. Opt-in Source
10. Last Email Date
11. Last Engagement
12. Reply Status
...
**Campaign Management**:
14. Campaigns (linked records)
15. Genres (multipleSelects)

**Enrichment Data**:
16. Enrichment Quality (High/Medium/Low)
17. Enrichment Notes (AI intelligence)
18. Last Enriched (date)

**Notes & Tags**:
19. Notes (consolidated from Reply Notes + Description)
20. MC TAGS (Mailchimp tags for segmentation)

**System Fields**:
21. Created At (auto)
22. Interactions (linked records)
