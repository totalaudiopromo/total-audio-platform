      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              query: {
                type: 'string',
                description: 'Gmail search query (e.g., "from:artist@example.com subject:campaign")'
              },
              maxResults: {
                type: 'number',
        ...
        },
        {
          ...
          description: 'Read messages from Google Chat spaces (READ-ONLY for intelligence gathering)',
          inputSchema: {
            type: 'object',
            properties: {
              spaceName: {
  ...
  async gatherChatIntelligence(args) {
    try {
      ...
      return {
        success: true,
        intelligence,
        recommendation: 'Use this intelligence to improve campaign targeting and relationship building'
      };
    } catch (error) {
      return {
        success: false,
