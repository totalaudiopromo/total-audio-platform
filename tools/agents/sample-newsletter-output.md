...
3. **"WMG is 'like Marvel for music' and 4 other things we learned from Robert Kyncl's Bloomberg interview"**
   - Source: Music Business Worldwide
   - Relevance Score: 0.22
   - Why relevant: Major label, music industry (medium relevance keywords)
...
This week BandLab's viral hit on Spotify happened, and here's the unsigned advantage...

But here's where it gets interesting for indies... New platform features favor artists who can adapt quickly over those stuck in old systems.

After 5+ years in radio promotion, this kind of shift happens every few years, and indies who spot it early always come out ahead.

The opportunity here is simple: early adoption advantage.
...
- **With $23.21 API credit**: 773 newsletters = 193+ months
...
1. Fix Music Week RSS or replace with alternative UK source
2. Lower relevance threshold from 0.6 → 0.5
3. Run first real newsletter generation manually
