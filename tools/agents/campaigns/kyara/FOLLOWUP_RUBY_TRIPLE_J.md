...
- Triple J credibility (Home & Hosed history with "Yearn")

The production quality is commercial-ready despite being bedroom-produced. Sultry electro-pop with crossover appeal - same emotional depth as "Yearn" but more confident.
...
1. Log in tracker as "Follow-up sent to Ruby - Triple J"
2. If no response by Tuesday: Send Monday release blast (different template)
3. If she responds positively: Prioritise for next release campaign
4. If she adds it: Get testimonial for future pitches
