...
- Copy/paste the campaign data from that file
...
- Memorize key numbers:
  - £3,900/month savings for Liberty
  - 49:1 ROI (£3,900 saved vs £79/month cost)
...
- Schedule send time: Sunday 10pm GMT / Monday 7am AEST
...
4. **[`KYARA_CAMPAIGN_SHOWCASE_FOR_DAN_DEMO.md`](./KYARA_CAMPAIGN_SHOWCASE_FOR_DAN_DEMO.md)**
   ...
   - Killer demo moments
   - Objection handling
   - What to show Dan step-by-step

5. **[`MANUAL_CAMPAIGN_SETUP.md`](./MANUAL_CAMPAIGN_SETUP.md)**
...
8. **[`KYARA_BLOODSHOT_NEW_CONTACTS.md`](./KYARA_BLOODSHOT_NEW_CONTACTS.md)**
   - 30 UK & Australian specialist contacts
   - Priority order
...
- Revenue opportunity (£79/month → potentially more)
...
- [ ] Demo prep file reviewed
- [ ] Business case numbers memorized
...
- [ ] Ask for pilot
- [ ] Get commitment or follow-up date
