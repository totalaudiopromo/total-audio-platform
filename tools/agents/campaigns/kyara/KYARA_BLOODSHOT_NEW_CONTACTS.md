...
5. **2SER Music Director**
   ...
   - Genre: Electronic/alternative specialty

6. **Bondi Beach Radio**
   - Email: info@bondibeachradio.com
   - Station: Bondi Beach Radio (Sydney)
   - Angle: Sydney eastern suburbs, beach vibes fit "Bloodshot" aesthetic
   - Genre: Electronic/indie crossover
...
8. **PBS FM Music Director**
   ...
   - Genre: Electronic/experimental focus

9. **3RRR Digital Music**
   - Email: digital@rrr.org.au
   - Station: Triple R Digital
   - Angle: Bedroom production aesthetic
   - Genre: Electronic/synth specialist
...
11. **RTR FM Music Team**
    - Email: music@rtrfm.com.au
    - Station: RTR FM Perth
    - Angle: West Australian alternative support
    - Genre: Electronic/indie crossover
...
14. **Australian Music Radio Airplay Project (Amrap)**
    ...
    - Genre: All genres, strong electronic support

15. **Double J Music Team**
    - Email: doublej@abc.net.au
    - Station: Double J (ABC)
    - Angle: Triple J alumni, mature electronic audience
    - Genre: Alternative/electronic crossover
...
19. **Sian Anderson**- BBC Radio 1Xtra
    ...
    - Genre: Electronic/urban crossover
...
22. **Elizabeth Alker**- BBC 6 Music
    ...
    - Genre: Indie/electronic crossover

### Priority 3: Amazing Radio (Already Supporting)

23. **Amazing Radio Music Team**
    - Email: music@amazingradio.com
    - Station: Amazing Radio
    - Angle: FOLLOW UP - already supporting, thank them
    - Genre: Independent artist champion
...
27. **Soho Radio Music**
    ...
    - Genre: Eclectic/electronic crossover

28. **Netil Radio**
    - Email: music@netilradio.com
    - Station: Netil Radio London
    - Angle: Underground electronic, bedroom production aesthetic
    - Genre: Electronic/experimental community
...
30. **BBC Radio Wales - Bethan Elfyn**
    - Email: bethan.elfyn@bbc.co.uk
    - Show: BBC Radio Wales
    - Angle: International artist showcase
    - Genre: Alternative/electronic focus
...
**Wednesday-Friday:**
17-20. UK community/digital (Rinse FM, NTS, Soho Radio, Netil)
21-24. Remaining Australian contacts
25-30. Regional BBC + remaining UK contacts
