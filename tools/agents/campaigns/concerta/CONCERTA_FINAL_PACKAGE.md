# CONCERTA "CONSUMPTION" - COMPLETE CAMPAIGN PACKAGE

**For Weekend Review | Send Monday 11 November 2025**

Based on Google Meet discussion 7 November 2025
...
**Note**: Need to research additional contacts for this region
...
4. Radio Fandango - Multi-genre including Electronic
5. Kingdom FM - Pop, Rock, Dance
6. Somethinelse - Alternative, Electronic, Jazz/Funk
...
- [ ] Confirm Apple Music link
- [ ] Confirm Instagram handle
- [ ] Approve email template above
...
- [x] Verify all campaign assets
- [ ] Await Concerta's materials
- [ ] Create Mailchimp campaign draft
...
**Guaranteed**: 100+ plays over 6-week campaign
**Conservative Estimates**: 7-13 confirmed airplay stations
...
- [ ] MP3 file of "Consumption" track
- [ ] WAV file of "Consumption" track
...
- Eastern European dance market affinity (mentioned by Concerta)
...
- Liberty forwards all relevant conversations
...
- Identify stations for future releases
- Plan potential second wave if needed
...
- Open to Concerta's input and feedback
...
- [x] Google Meet discussion notes documented
- [ ] Mailchimp campaign created (pending Concerta materials)
- [ ] WARM API tracking configured
...
4. Launch campaign at 9:00 AM GMT
...
4. `CONCERTA_CAMPAIGN_SUMMARY.md` - Technical campaign details
...
- "Large interest in dance music in Eastern Europe - definitely focus there"
...
- Use Mailchimp for professional, deliverable campaigns
- Track everything via WARM Music for transparency
...
Campaign Manager: Chris Schofield, Liberty Music PR

**Deadline for materials**: Sunday, 10 November 2025 (evening)
**Campaign launch**: Monday, 11 November 2025 (9:00 AM GMT)

---

**This is your first radio campaign. Let's make it count! 🎵**

Liberty Music PR | 6-Week Campaign | 100+ Plays Guaranteed | Weekly Reports
