...
async function targetBestialStations() {
  ...
  try {
    ...
    stationsData.stations.forEach(station => {
      ...
      if (
        name.includes('bbc radio 1') ||
        name.includes('bbc radio 2') ||
        name.includes('capital fm') ||
        name.includes('heart') ||
        name.includes('kiss fm') ||
        name.includes('magic')
      ) {
      ...
      // Online - Digital first
        ...
        name.includes('boom') ||
        name.includes('union jack') ||
        name.includes('planet radio')
      ) {
    ...
    // Summary
    const totalTargets = Object.values(categorizedStations).reduce(
