...
async function manualSeniorDunceTimeline() {
  ...
  try {
    ...
    console.log(
      '   2. Playlisting questionairre (Response Token: n24ddnp25a21708lfxzgn24diido2d1y)'
    );
    console.log(
      '   3. Personality Questions for Press (Response Token: wm1e19y2ve9wvc9kwm1e1u5o0snlspe1)'
    );
    console.log('');
    ...
    console.log(
      '   - Personality Questions for Press (Response: wm1e19y2ve9wvc9kwm1e1u5o0snlspe1)'
    );
