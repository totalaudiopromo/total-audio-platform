...
This directory contains Claude Code skills for the Total Audio projects.
...
3. **Manual Installation:**
   ...
   - Unzip and place folder in `.claude/skills/`
   - Restart Claude Code
...
- Archive unused skills to reduce token usage
- Update skills when workflow patterns change
