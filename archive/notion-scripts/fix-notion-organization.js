...
async function fixNotionOrganization() {
  try {
    ...
    const newWorkspace = await notion.pages.create({
      ...
      children: [
        ...
        },
        {
          ...
          bulleted_list_item: {
            rich_text: [{ text: { content: '📊 COMMAND CENTRE - Daily dashboard with key metrics, priorities, tasks' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '🔧 PRODUCT ECOSYSTEM - Audio Intel (Blue), Playlist Pulse (Green), Master Platform (Purple)' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '💼 BUSINESS OPERATIONS - Partnerships, revenue streams, customer feedback' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '🚀 DEVELOPMENT HUB - Claude Code + Cursor workflows, technical documentation' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '📝 CONTENT & MARKETING - Newsletter system, content bank, social media strategies' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '🗂️ ADMIN & RESOURCES - Organisation rules, templates, archive, reference materials' } }]
          }
        },
        {
          object: 'block',
        ...
        },
        {
          ...
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: 'Status (Not Started, In Progress, Review, Complete)' } }]
          }
        },
        {
          object: 'block',
        ...
        },
        {
          ...
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: 'Tool (Audio Intel, Playlist Pulse, Master Platform, Business)' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: 'Business Impact (MVP Critical, Revenue Impact, Nice-to-Have)' } }]
          }
        },
        {
          object: 'block',
        ...
        },
        {
          ...
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '👥 Customer Pipeline (Beta users, prospects, partnerships)' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '🗺️ Feature Roadmap (Cross-tool development planning)' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '📅 Content Calendar (Newsletter, social, case studies)' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '💰 Revenue Tracking (MRR, deals, partnership income)' } }]
          }
        },
        {
          object: 'block',
        ...
        },
        {
          ...
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '💻 Development session template for Claude Code work' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '🤝 Partnership outreach template with follow-up tracking' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '📝 Content planning template with 94% automation messaging' } }]
          }
        },
        {
          object: 'block',
          type: 'bulleted_list_item',
          bulleted_list_item: {
            rich_text: [{ text: { content: '💬 Customer feedback template with product impact assessment' } }]
          }
        }
      ]
    });
    ...
    const templates = response.results.filter(item => 
      item.object === 'page' && 
