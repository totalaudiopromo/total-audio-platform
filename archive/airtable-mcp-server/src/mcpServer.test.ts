...
describe('AirtableMCPServer', () => {
  ...
  beforeEach(async () => {
    ...
    mockAirtableService = {
      ...
      updateRecords: vi
        .fn()
        .mockResolvedValue([{ id: 'rec1', fields: { name: 'Updated Record' } }]),
      deleteRecords: vi.fn().mockResolvedValue([{ id: 'rec1', deleted: true }]),
      ...
      searchRecords: vi.fn().mockResolvedValue([{ id: 'rec1', fields: { name: 'Test Result' } }]),
    };
