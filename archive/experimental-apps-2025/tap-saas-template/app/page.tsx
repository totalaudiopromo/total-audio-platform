...
const features = [
  ...
  },
  {
    ...
    description:
      'Pulls from your contact database to create genuinely personal pitches, not generic templates.',
    color: 'brand-magenta',
  },
  {
    icon: Clock,
    ...
    description:
      'Generate 50 personalized pitches in 20 minutes instead of spending hours on each one.',
    color: 'brand-amber',
  },
];
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-6">
            ...
            <h1 className="text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl">
              ...
              <span className="block text-blue-600">20 minutes</span>
            </h1>
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-3">
            ...
            <p className="text-sm text-gray-600">
              No learning curve. No complicated setup. Just pick a contact, add your track info, and
