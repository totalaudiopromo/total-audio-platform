...
DROP TABLE IF EXISTS pitch_performance CASCADE;
DROP TABLE IF EXISTS pitches CASCADE;
DROP TABLE IF EXISTS pitch_templates CASCADE;
DROP TABLE IF EXISTS user_pitch_settings CASCADE;
DROP TABLE IF EXISTS contacts CASCADE;

DROP INDEX IF EXISTS idx_pitches_user_id;
DROP INDEX IF EXISTS idx_pitches_contact_id;
DROP INDEX IF EXISTS idx_pitches_status;
DROP INDEX IF EXISTS idx_pitches_created_at;
DROP INDEX IF EXISTS idx_contacts_user_id;
DROP INDEX IF EXISTS idx_templates_genre;
...
CREATE TABLE user_pitch_settings (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
