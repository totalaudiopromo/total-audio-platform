  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex items-center gap-3">
        {getTypeIcon()}
        <div>
          <h3 className="text-lg font-semibold">{title || `Export ${getTypeLabel()}`}</h3>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>One-click export in your preferred format</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Advanced options with email delivery and white-labeling</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Customize branding for agency clients</p>
            </div>
            <Button
              variant="outline"
              size="sm"
          ...
          <div
            ...
            className="hidden space-y-4 p-4 border rounded-lg bg-muted/50"
          >
            <div className="grid grid-cols-2 gap-4">
              <div>
