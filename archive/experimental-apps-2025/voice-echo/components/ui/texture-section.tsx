...
export const TextureHeroSection: React.FC<
  Omit<TextureSectionProps, 'variant' | 'background' | 'padding'>
> = props => (
  <TextureSection
    variant="hero"
    background="gradient"
...
export const TextureContentSection: React.FC<
  Omit<TextureSectionProps, 'variant' | 'background'>
> = props => <TextureSection variant="content" background="white" {...props} />;

export const TexturePricingSection: React.FC<
  Omit<TextureSectionProps, 'variant' | 'background'>
> = props => (
  <TextureSection variant="pricing" background="gray" texture="grain" opacity="05" {...props} />
);

export const TextureFeaturesSection: React.FC<
  Omit<TextureSectionProps, 'variant' | 'background'>
> = props => (
  <TextureSection variant="features" background="white" texture="paper-2" opacity="03" {...props} />
);

export const TextureNavSection: React.FC<
  Omit<TextureSectionProps, 'variant' | 'background' | 'padding'>
> = props => (
  <TextureSection variant="nav" background="transparent" padding="sm" overlay={false} {...props} />
);

export const TextureFooterSection: React.FC<
  Omit<TextureSectionProps, 'variant' | 'background'>
> = props => (
  <TextureSection variant="footer" background="gray" texture="paper" opacity="03" {...props} />
);
