        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We're on a mission to democratize access to music industry intelligence, making
              powerful contact research and enrichment tools available to independent artists and
              small agencies.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-xl text-gray-700 mb-6">
                    ...
                    those connections have been expensive, complex, and out of reach for most
                    artists.
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  ...
                  artists succeed?" We're not building tools for labels - we're building tools for
                  the artists who are changing music.
                </p>
              </TextureCard>
              <TextureCard
                textureType="paper"
            ...
            <TextureCard textureType="paper" textureVariant={1} rotation={0} className="p-12">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-700">
                  Audio Intel is built by the team behind Total Audio Promo, a company with deep
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                  ...
                  <p className="text-lg text-gray-700 mb-6">
                    We started by building better radio promotion tools, but quickly realized that
                    the real problem was bigger - artists needed better intelligence about who to
                    contact and how to reach them effectively.
                  </p>
                  <div className="flex gap-4">
                    <Button
                      variant="outline"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="p-6 text-center hover:shadow-lg transition-all bg-gradient-to-br from-blue-50 to-blue-100">
                ...
                <p className="text-sm text-gray-600">
                  Advanced AI models analyze contact data and provide intelligent insights
                </p>
              </Card>
