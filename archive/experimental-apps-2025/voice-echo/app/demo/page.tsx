...
export default function DemoPage() {
  ...
  const generateDemoContent = async () => {
    ...
    setTimeout(() => {
      const mockContent = {
        twitter:
          '🔥 Just dropped my new single! Been working on this for months and finally ready to share it with you all. Link in bio 👆 #NewMusic #UKArtist',
        instagram:
          "Behind the scenes of my new single 🎵 This one's been brewing for months and I'm so excited to finally share it with you all! Link in bio for the full story 👆",
        threads:
          'Just dropped my new single! Been working on this for months and finally ready to share it with you all. Link in bio 👆',
    ...
    <div className="min-h-screen bg-[#f8f9fa]">
        ...
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Badge
                variant="secondary"
                className="bg-blue-100 text-blue-800 font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
              >
                Beta
              </Badge>
            </div>
      ...
      <section className="container px-4 py-24 mx-auto text-center">
        <div className="max-w-4xl mx-auto">
          <Badge
            variant="secondary"
            className="mb-6 bg-blue-100 text-blue-800 font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
          >
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed font-bold">
            Experience how Voice Echo learns your authentic voice and creates platform-perfect
            content for X, Instagram, Threads & TikTok.
          </p>
        </div>
      </section>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-700">
                        {' '}
                        Share 10-15 posts that represent your authentic voice
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-700">
                        {' '}
                        Our AI analyzes your writing style, tone, and personality
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-700">
                        {' '}
                        Create platform-perfect posts that sound exactly like you
                      </span>
                    </div>
                  </div>
                </CardContent>
      ...
      <section className="container px-4 py-24 mx-auto text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed font-bold">
            Start uploading your best social media posts and let Voice Echo learn your authentic
            voice.
          </p>
