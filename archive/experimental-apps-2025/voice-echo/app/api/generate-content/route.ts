...
function generateTwitterContent(context: string, type: string): string {
  ...
  if (
    baseContent.includes('release') ||
    baseContent.includes('drop') ||
    baseContent.includes('new')
  ) {
    ...
    baseContent.includes('show') ||
    baseContent.includes('gig') ||
    baseContent.includes('tour')
  ) {
