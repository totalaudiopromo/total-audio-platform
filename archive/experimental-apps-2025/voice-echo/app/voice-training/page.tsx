      ...
      <section className="container px-4 py-24 mx-auto text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed font-bold">
            Upload 10-15 of your best social media posts. Our AI will learn your unique voice, tone,
            style, and personality to create content that sounds exactly like you.
          </p>
        </div>
      </section>
                ...
                <CardContent className="space-y-6">
                  <Tabs defaultValue="file" className="w-full">
                    <TabsList className="grid w-full grid-cols-2">
                      ...
                      <TabsTrigger value="paste" className="font-bold">
                        Text Paste
                      </TabsTrigger>
                    </TabsList>
                    ...
                    <div className="space-y-4">
                      {uploadedPosts.map((post, index) => (
                        <div key={index} className="border-2 border-gray-200 rounded-lg p-4">
                          ...
                          <div className="text-gray-900 mb-3 font-mono">"{post}"</div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-700">
                        {' '}
                        Mix of different content types and tones
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-700">
                        {' '}
                        Helps AI understand platform-specific voice
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
            ...
            <Card className="border-4 border-green-500 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] bg-green-50">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-xl font-bold text-gray-700 mb-8">
                  Your authentic voice has been learned. You can now generate platform-perfect
