...
export const metadata: Metadata = {
  ...
  description:
    'Stop posting generic AI content. Voice Echo learns your authentic voice and creates platform-optimized social media posts for X, Instagram, Threads & TikTok that sound exactly like you.',
  openGraph: {
    title: 'Voice Echo – AI-Powered Content Creation for Musicians',
    description:
      'Your authentic voice, amplified across every platform. Generate platform-perfect social media posts that sound exactly like you.',
  ...
  twitter: {
    ...
    title: 'Voice Echo – AI-Powered Content Creation for Musicians',
    description:
      'Stop posting generic AI content. Voice Echo learns your authentic voice and creates platform-optimized social media posts for X, Instagram, Threads & TikTok.',
