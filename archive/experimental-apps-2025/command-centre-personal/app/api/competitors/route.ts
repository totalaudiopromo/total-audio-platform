...
export async function GET() {
  try {
    ...
    const competitors: CompetitorData[] = [
      {
        ...
        marketPosition: {
          strength: 8,
          weakness: ['High cost per submission', 'No bulk processing', 'Limited API access'],
      ...
      },
      {
        ...
        marketPosition: {
          strength: 7,
          weakness: ['Expensive for small artists', 'No contact enrichment', 'Complex interface'],
      ...
      },
      {
        ...
        marketPosition: {
          strength: 10,
          weakness: ['Still in development', 'Not yet launched'],
    ...
    return NextResponse.json({
      ...
      analysis: {
        marketGap:
          'No competitor offers comprehensive contact intelligence specifically for music industry',
