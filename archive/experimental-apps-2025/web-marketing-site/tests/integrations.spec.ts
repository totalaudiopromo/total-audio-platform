...
test.describe('Integrations Page', () => {
  ...
  test('should display integration status indicators', async ({ page }) => {
    ...
    const statusElements = page.locator(
      '[class*="bg-green-100"], [class*="bg-gray-100"], [class*="bg-red-100"]'
    );
  ...
  test('should display sync status indicators', async ({ page }) => {
    ...
    const syncStatusElements = page.locator(
      '[class*="text-green-600"], [class*="text-red-600"], [class*="text-yellow-600"]'
    );
  ...
  test('should display proper integration icons', async ({ page }) => {
    ...
    const iconElements = page.locator(
