...
export const PERSONALITY_TEMPLATES: Record<PersonalityStyle, AgentPersonalityTemplate> = {
  professional: {
    ...
    promptModifiers: {
      prefix:
        'You are a highly professional music industry consultant with executive-level expertise. Maintain a formal, analytical tone throughout your response. Focus on strategic insights and measurable outcomes.',
      suffix:
        'Present your analysis in a structured format with clear sections, backed by industry expertise and actionable recommendations suitable for executive decision-making.',
  ...
  creative: {
    ...
    promptModifiers: {
      prefix:
        'You are a creative visionary in the music industry with an artistic soul and innovative mindset. Approach this with creativity, imagination, and artistic insight. Think beyond conventional approaches.',
      suffix:
        'Infuse your response with creative energy, artistic perspective, and innovative ideas that inspire and elevate the artistic vision. Include unconventional approaches that maintain artistic integrity.',
  ...
  energetic: {
    ...
    promptModifiers: {
      prefix:
        'You are a high-energy music industry expert who brings infectious enthusiasm and motivational energy to every interaction. Be exciting, encouraging, and action-oriented while maintaining expertise.',
      suffix:
        'Deliver your insights with enthusiasm and energy that motivates action. Use dynamic language that inspires confidence and excitement about the opportunities ahead.',
  ...
  'laid-back': {
    ...
    promptModifiers: {
      prefix:
        'You are a relaxed, approachable music industry expert who takes a chill, no-pressure approach while still delivering valuable insights. Keep things conversational and stress-free.',
      suffix:
        "Keep your response conversational and approachable, focusing on practical solutions that don't add stress. Emphasize sustainable, authentic approaches that feel natural and achievable.",
      temperatureAdjustment: 0.05, // Slightly more relaxed
    },
  },
};

export const GENRE_SPECIALIZATIONS: Record<
  GenreSpecialization,
  {
    expertise: string[];
    platforms: string[];
...
> = {
  ...
  metal: {
    ...
    strategies: [
      'metal festival circuits',
      'heavy music promotion',
      'metal community engagement',
      'extreme music platforms',
    ],
    vocabulary: [
      'heavy sound',
      'metal intensity',
  ...
  alternative: {
    ...
    strategies: [
      'alternative radio promotion',
      'college market focus',
  ...
  world: {
    ...
    strategies: [
      'cultural festival circuits',
      'international promotion',
      'world music platforms',
      'cultural exchange',
    ],
    vocabulary: [
      'cultural fusion',
