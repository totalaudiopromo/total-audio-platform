    ...
    return [
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Compelling news headline under 80 characters',
      },
      {
        key: 'dateline',
        label: 'Dateline',
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Who, what, when, where, why in 2-3 sentences',
      },
      { key: 'artistName', label: 'Artist Name', type: 'text', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Compelling quote from the artist',
      },
      {
        key: 'artistBio',
        label: 'Artist Bio',
        type: 'textarea',
        required: true,
        placeholder: '50-100 word artist biography',
      },
      ...
      {
        key: 'labelInformation',
        label: 'Label/Management Info',
        type: 'textarea',
        required: false,
      },
      ...
      {
        key: 'streamingLinks',
        label: 'Streaming Platform Links',
        type: 'textarea',
        required: true,
      },
  ...
  private getInstagramReleaseVariables(): TemplateVariable[] {
    return [
      ...
      { key: 'trackTitle', label: 'Track Title', type: 'text', required: true },
      {
        ...
        type: 'select',
        required: true,
        options: ['SINGLE', 'EP', 'ALBUM', 'REMIX'],
      },
      {
        key: 'emotionalDescriptor',
        label: 'Emotional Descriptor',
        type: 'select',
        required: true,
        options: ['incredible', 'mesmerizing', 'powerful', 'beautiful', 'energetic', 'haunting'],
      },
      {
        key: 'hookDescription',
        ...
        type: 'textarea',
        required: true,
        placeholder: '1-2 sentences describing what makes this release special',
      },
      {
        key: 'callToAction',
        ...
        type: 'text',
        required: true,
        placeholder: 'What you want followers to do',
      },
      ...
      {
        key: 'artistNameHash',
        label: 'Artist Name (Hashtag)',
        type: 'text',
        required: true,
        placeholder: 'Artist name without spaces for hashtag',
      },
      ...
      { key: 'releaseMonth', label: 'Release Month', type: 'text', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Additional relevant hashtags',
      },
    ];
  }
  ...
  private getTwitterReleaseVariables(): TemplateVariable[] {
    return [
      ...
      { key: 'trackTitle', label: 'Track Title', type: 'text', required: true },
      {
        ...
        type: 'number',
        required: true,
        placeholder: '3-5 tweets recommended',
      },
      {
        key: 'thread1',
        label: 'Thread Tweet 1',
        type: 'textarea',
        required: true,
        placeholder: 'First tweet content (max 280 chars)',
      },
      {
        key: 'thread2',
        label: 'Thread Tweet 2',
        type: 'textarea',
        required: true,
        placeholder: 'Second tweet content (max 280 chars)',
      },
      {
        key: 'thread3',
        label: 'Thread Tweet 3',
        type: 'textarea',
        required: false,
        placeholder: 'Third tweet content (max 280 chars)',
      },
      { key: 'streamingLinks', label: 'Streaming Links', type: 'text', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Final engagement request',
      },
    ];
  }
  ...
  private getTikTokConceptVariables(): TemplateVariable[] {
    return [
      { key: 'conceptTitle', label: 'Video Concept Title', type: 'text', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Attention-grabbing opening (first 3 seconds)',
      },
      {
        key: 'videoLength',
        label: 'Video Length',
      ...
      { key: 'callToAction', label: 'Call to Action', type: 'text', required: true },
      {
        ...
        type: 'select',
        required: true,
        options: ['Original Track', 'Trending Sound', 'Remix/Mashup', 'Acapella Version'],
      },
...
{{brandGuidelines}}`;
  ...
  private getComprehensiveCampaignVariables(): TemplateVariable[] {
    return [
      ...
      {
        key: 'pressReleaseContent',
        label: 'Press Release Content',
        type: 'textarea',
        required: true,
      },
      {
        key: 'instagramContent',
      ...
      {
        key: 'twitterContent',
        label: 'Twitter Content Strategy',
        type: 'textarea',
        required: true,
      },
      ...
      {
        key: 'facebookContent',
        label: 'Facebook Content Strategy',
        type: 'textarea',
        required: false,
      },
