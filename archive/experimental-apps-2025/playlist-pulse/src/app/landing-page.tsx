  ...
  const handleContactSales = () => {
    try {
      ...
      window.location.href =
        'mailto:sales@totalaudiopromo.com?subject=Enterprise%20Inquiry%20-%20Playlist%20Pulse';
    } catch (error) {
    ...
    <div className="min-h-screen bg-[#f8f9fa]">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <a
              href="#pricing"
              className="text-sm font-bold text-gray-700 hover:text-yellow-600 transition-colors"
            >
              Pricing
            </a>
            <a
            ...
            <button
              className="border-2 border-gray-300 text-gray-700 hover:bg-gray-50 px-4 py-2 rounded-lg transition-colors font-bold"
              onClick={handleSignIn}
            >
              Sign In
            </button>
            <button
              className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold px-4 py-2 rounded-lg transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1"
      ...
      <section className="container px-4 py-24 mx-auto text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed font-bold">
            ...
            generation that gets {responseRate.toFixed(1)}x more responses
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <button
              className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold px-8 py-6 text-lg rounded-2xl transition-all shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 flex items-center gap-2"
            ...
            <button
              className="border-2 border-gray-300 text-gray-700 hover:bg-gray-50 px-8 py-6 text-lg rounded-2xl transition-colors font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1"
            ...
            <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-16 items-center">
              ...
              <div className="text-center">
                ...
                <div className="bg-gray-50 rounded-2xl p-10 border-4 border-gray-300 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                  <div className="text-gray-900 font-mono text-2xl font-black mb-4">
                    Generic Playlist Database
                  </div>
              ...
              <div className="flex flex-col items-center gap-4">
                <div
                  className="w-20 h-20 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-2xl flex items-center justify-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all cursor-pointer"
                  ...
                  <div className="bg-yellow-100 rounded-lg p-3 border-2 border-yellow-300">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-gray-900">
                        {dynamicMetrics[currentMetric].label}: {dynamicMetrics[currentMetric].value}
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-bold text-lg">
                        {responseRate.toFixed(1)}x Higher Response Rate
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-black text-gray-900">
                  Need contact enrichment? Try Audio Intel
                </h3>
                <p className="text-gray-700 font-bold">
                  Transform basic email lists into music industry intelligence with AI-powered
                  contact enrichment
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {playlistMetrics.map((metric, index) => (
              <div
                key={index}
                className="bg-white p-8 text-center rounded-2xl border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all group"
              >
                ...
                <div className="text-sm font-bold text-gray-600">{metric.subtext}</div>
              </div>
            ))}
          </div>
          {/* Platform logos */}
          <div className="flex flex-wrap gap-6 justify-center items-center mt-12 opacity-60">
            <div className="w-28 h-10 bg-yellow-100 rounded flex items-center justify-center text-yellow-800 font-bold text-sm">
              Spotify
            </div>
            <div className="w-28 h-10 bg-yellow-100 rounded flex items-center justify-center text-yellow-800 font-bold text-sm">
              Apple Music
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-700 font-bold">
                Drag and drop your audio file. Our AI analyzes genre, mood, tempo, and energy to
                understand your sound profile.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700 font-bold">
                Instantly see 50+ verified curators who love your genre, with contact info, playlist
                stats, and submission preferences.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700 font-bold">
                One-click sending of personalized pitches that mention specific playlist details and
                highlight why your track fits perfectly.
              </p>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <button
              className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold px-8 py-4 text-lg rounded-2xl transition-all shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 flex items-center gap-2 mx-auto"
              onClick={handleUploadTrackCTA}
            >
              <Upload className="h-6 w-6" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 border-4 border-gray-300 rounded-2xl p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all">
              <div className="text-center">
                ...
                <button
                  className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 rounded-lg transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1"
                  onClick={() => handlePricingTrial('solo')}
                >
                  Start Free Trial
                </button>
              </div>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-white border-4 border-yellow-400 rounded-2xl p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all relative transform scale-105">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <div className="bg-yellow-400 text-black font-bold px-4 py-1 rounded-full text-sm shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                  Most Popular
                </div>
              </div>
              <div className="text-center">
                ...
                <button
                  className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 rounded-lg transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1"
                  onClick={() => handlePricingTrial('agency')}
                >
                  Start Free Trial
                </button>
              </div>
            ...
            <div className="bg-gray-50 border-4 border-gray-300 rounded-2xl p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all">
              <div className="text-center">
                ...
                <button
                  className="w-full border-2 border-gray-300 text-gray-700 hover:bg-gray-50 py-3 rounded-lg transition-colors font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {faqs.map((faq, i) => (
              <div
                key={i}
                className="bg-white border-4 border-gray-300 rounded-2xl p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all"
              >
                <button
                ...
                {openFaq === i && (
                  <div className="pt-4 text-gray-700 font-bold text-base">{faq.a}</div>
                )}
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button
            className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold px-12 py-6 text-xl rounded-2xl transition-all shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 flex items-center gap-2 mx-auto mb-6"
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 font-bold">
                    Try Audio Intel - our sister tool for enriching music industry contacts with
                    AI-powered insights
                  </p>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-4 gap-12">
            <div>
              ...
              <p className="text-lg font-bold text-gray-300 mb-8">
                AI-powered playlist curator discovery and pitch generation. Get your music heard by
                the right people. Powered by Total Audio Promo.
              </p>
            </div>
