...
export const metadata: Metadata = {
  ...
  description:
    'Upload your track and get personalized pitches for playlist curators. Get instant access to 50,000+ verified playlist curators with AI-powered pitch generation.',
  openGraph: {
