          ...
          <div className="bg-white rounded-2xl p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] border-4 border-black mb-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 font-bold">
                Upload your audio file and we'll analyze it to find the perfect playlist curators
                for your music.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              {analysisComplete && !curatorMatches.length && (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 font-bold">
                    Analyzing your track and finding curators...
                  </p>
                </div>
              )}
            ...
            <div className="bg-white rounded-2xl p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] border-4 border-black">
              <div className="text-center mb-8">
                ...
                {detectedGenre && (
                  <p className="text-gray-600 font-bold mb-4">
                    Detected Genre:{' '}
                    <span className="text-yellow-600 font-black">{detectedGenre}</span>
                  </p>
                )}
                <p className="text-gray-600 font-bold">
                  We found {curatorMatches.length} curators who would love your music. Here are the
                  best matches:
                </p>
              </div>
              ...
              <div className="space-y-6">
                {curatorMatches.map(curator => (
                  <div
                    key={curator.id}
                    className="border-2 border-gray-200 rounded-lg p-6 hover:border-yellow-400 transition-colors"
                  >
