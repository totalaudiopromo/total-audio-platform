        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="text-right">
            ...
            <div className="text-white/60 text-xs">
              {getCompatibilityLabel(curator.compatibility)}
            </div>
          </div>
        </div>
          ...
          <div className="flex space-x-2">
            {curator.social.instagram && (
              <Button
                ...
                onClick={() =>
                  window.open(
                    `https://instagram.com/${curator.social.instagram?.replace('@', '')}`,
                    '_blank'
                  )
                }
              >
            ...
            {curator.social.twitter && (
              <Button
                ...
                onClick={() =>
                  window.open(
                    `https://twitter.com/${curator.social.twitter?.replace('@', '')}`,
                    '_blank'
                  )
                }
              >
            ...
            {curator.social.youtube && (
              <Button
                ...
                className="w-8 h-8 p-0 text-white/60 hover:text-white hover:bg-white/10 rounded-lg"
                onClick={() =>
                  window.open(`https://youtube.com/@${curator.social.youtube}`, '_blank')
                }
              >
