...
export const PLAYLIST_PULSE_AB_TESTS: ABTestConfig[] = [
    ...
    variants: [
      {
        ...
        config: {
          pricing: {
            ...
            currencySymbol: '£',
            valueProps: ['No long-term commitment', 'Start small and scale', 'Cancel anytime'],
          },
        },
      },
      {
        ...
        config: {
          copy: {
            headlines: {
              ...
              secondary:
                'Stop wasting time on playlist submissions that go nowhere. Access verified UK curators who actually listen.',
            },
            painPoints: [
              {
        ...
        config: {
          copy: {
            headlines: {
              ...
              secondary:
                'Automate your playlist submissions and get back to making music. Built for busy UK producers.',
            },
            painPoints: [
              {
            ...
            socialProof: [
              {
                testimonial:
                  'Went from 20 hours of admin to 2 hours. Now I actually have time to make music.',
        ...
        config: {
          copy: {
            headlines: {
              ...
              secondary:
                'From bedroom producer to industry professional. The platform that grows with your ambitions.',
            },
            painPoints: [
              {
            ...
            socialProof: [
              {
                testimonial:
                  'From 500 monthly listeners to 50K+ and my first label deal. This platform changed everything.',
            ...
            features: [
              {
                ...
                description:
                  'Monitor your growth from hobbyist to professional with detailed analytics',
                icon: 'chart',
              },
              {
...

  {
    ...
    description:
      'Test different ethical urgency messages to increase conversions without being pushy',
    variants: [
      {
        id: 'limited-beta',
...
export class ConversionOptimizer {
  ...
  private calculateFunnelMetrics(
    ...
    const conversionRates = {
      ...
      signupToPayment:
        metrics.signupStarts > 0 ? metrics.paymentCompletes / metrics.signupStarts : 0,
